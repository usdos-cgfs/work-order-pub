(()=>{var Aa=Object.defineProperty;var qs=(i,e)=>{for(var t in e)Aa(i,t,{get:e[t],enumerable:!0})};var Ca=String.raw,Fs=Ca`
<div>
  <style>
    .search-group {
      display: none;
...
`;var Qt={};qs(Qt,{ApprovalActions:()=>He,AssignModule:()=>ii,BaseComponent:()=>V,ClosedRequestsTableModule:()=>hs,ConstrainedEntityEditModule:()=>Ae,ConstrainedEntityViewModule:()=>qe,EmailRequestModule:()=>Ts,MyAssignmentsModule:()=>bs,NewAssignmentModule:()=>Cs,OpenOfficeRequestsTableModule:()=>ms,OpenRequestsTableModule:()=>ps,PendingRequestIngestsModule:()=>ds,PipelineModule:()=>ws,QuickInfoModule:()=>As,RequestHeaderEditModule:()=>vs,RequestHeaderViewModule:()=>ys,RequestsByServiceTypeModule:()=>fs,RequestsByServiceTypeTableModule:()=>gs,ResolverModule:()=>Qe,TaskToastModule:()=>Rs,html:()=>R});var Te=class{constructor(e,t,s){this.source=e,this.type=t,this.description=s}};var W=class i{constructor({Id:e,ID:t,Title:s,LoginName:o=null,Email:a=null,IsGroup:r=null,IsEnsured:p=!1}){this.ID=t??e,this.Title=s,this.LookupValue=s,this.LoginName=o!=""?o:null,this.Email=a,this.IsGroup=r,this.IsEnsured=p}ID=null;Title=null;LoginName=null;LookupValue=null;Email;getKey=()=>this.LoginName??this.Title;static Create=function(e){return!e||!e.ID&&!(e.Title||e.LookupValue)?null:new i({...e,Title:e.Title??e.LookupValue})}};var Yt={ActionOffice:"Action Office",RequestingOffice:"Requesting Office",Department:"Department",Budget:"Budget PMO"},ae=class i{constructor({ID:e,Title:t}){this.ID=e,this.Title=t,this.LookupValue=t}UserGroup;Everyone;FieldMap={UserGroup:{get:()=>this.UserGroup,set:e=>this.UserGroup=W.Create(e)}};static Create=function(e){return e?.ID?ge().find(t=>t.ID==e.ID):null};static FindInStore=function(e){return e?.ID?ge().find(t=>t.ID==e.ID):null};static Views={All:["ID","Title","UserGroup","ContactInfo","OrgType","BreakAccess","PreferredEmail","Everyone"]};static ListDef={name:"ConfigRequestOrgs",title:"ConfigRequestOrgs",fields:i.Views.All}},ge=ko.observableArray([]);var $e=class{constructor(e){e?.ID&&(this.ID=e.ID),e?.Title&&(this.Title=e.Title)}ObservableID=ko.observable();ObservableTitle=ko.observable();get ID(){return this.ObservableID()}set ID(e){this.ObservableID(e)}get Title(){return this.ObservableTitle()}set Title(e){this.ObservableTitle(e)}};var O={InProgress:"In Progress",Completed:"Completed",Approved:"Approved",Rejected:"Rejected",Cancelled:"Cancelled"},Me={ActionResolver:"Action Resolver",Approver:"Approver",Assigner:"Assigner",Viewer:"Viewer",Subscriber:"Subscriber"},Ta={"Action Resolver":"resolver-actions",Approver:"approver-actions",Assigner:"assigner-actions"},Rt={source:"current-stage-active-assignments",type:"current-stage",description:"Please complete all assignments"},pe=class i extends $e{constructor({ID:e,Title:t,Assignee:s,RequestOrg:o,PipelineStage:a,IsActive:r=!0,Role:p,CustomComponent:b=null}){super({ID:e,Title:t}),this.Assignee=s,this.RequestOrg=o,this.PipelineStage=a,this.IsActive=r,this.Role=p,this.CustomComponent=b}Role;Errors=ko.observableArray();getComponentName=()=>this.CustomComponent??Ta[this.Role];getComponent=({request:e})=>({request:e,assignment:this,addAssignment:e.Assignments.addNew,completeAssignment:e.Assignments.complete,errors:this.Errors,actionComponentName:this.getComponentName()});userIsDirectlyAssigned=e=>this.Assignee?.ID==e.ID||e.isInGroup(this.Assignee);userIsInRequestOrg=e=>e.isInRequestOrg(this.RequestOrg);isActionable=()=>[Me.ActionResolver,Me.Approver,Me.Assigner].includes(this.Role);isUserActionable=e=>(e||(e=window.WorkOrder.App.CurrentUser()),this.isActionable()?this.userIsDirectlyAssigned(e)||this.userIsInRequestOrg(e):!1);isExpanded=ko.observable(!0);toggleExpanded=()=>this.isExpanded(!this.isExpanded());static CreateFromObject=function(e){e.RequestOrg=ae.FindInStore(e.RequestOrg);let t=new i;return Object.assign(t,e),t};static Views={All:["ID","Title","Assignee","Role","Status","RequestOrg","IsActive","Comment","CompletionDate","ActionTaker","PipelineStage","CustomComponent","Request"],Dashboard:["Role","Assignee","Status","Request"]};static ListDef={name:"Assignments",title:"Assignments",fields:i.Views.All}};window.console=window.console||{log:function(){}};var E=window.sal||{};E.globalConfig=E.globalConfig||{};E.site=E.site||{};window.DEBUG=!0;function Ds(i){return{ID:i.get_id(),Title:i.get_title(),LoginName:i.get_loginName(),IsEnsured:!0,IsGroup:!0,oGroup:i}}function ti(){let i=E.globalConfig.defaultGroups,e={};return Object.keys(i).forEach(t=>{e[t]=Ds(i[t])}),e}var Zt={};async function Ps(i){if(Zt[i]?.Users?.constructor==Array)return Zt[i].Users;let e=`/web/sitegroups/GetByName('${i}')?$expand=Users`,s=(await X(e)).d;return s.Users=s.Users?.results,Zt[i]=s,s.Users}var Ns=_spPageContextInfo.webAbsoluteUrl=="/"?"":_spPageContextInfo.webAbsoluteUrl;async function Es(){E.globalConfig.siteGroups=[],console.log("we are initing sal"),E.globalConfig.siteUrl=_spPageContextInfo.webServerRelativeUrl=="/"?"":_spPageContextInfo.webServerRelativeUrl,E.globalConfig.listServices=E.globalConfig.siteUrl+"/_vti_bin/ListData.svc/";var i=SP.ClientContext.get_current(),e=i.get_web();E.globalConfig.defaultGroups={owners:e.get_associatedOwnerGroup(),members:e.get_associatedMemberGroup(),visitors:e.get_associatedVisitorGroup()},i.load(E.globalConfig.defaultGroups.owners),i.load(E.globalConfig.defaultGroups.members),i.load(E.globalConfig.defaultGroups.visitors);var t=e.get_currentUser();i.load(t);var s=e.get_siteGroups();i.load(s),E.globalConfig.roles=[];var o=i.get_web().get_roleDefinitions();return i.load(o),new Promise((a,r)=>{i.executeQueryAsync(function(){E.globalConfig.currentUser=t,E.globalConfig.siteGroups=xa(s);for(var p=o.getEnumerator();p.moveNext();){var b=p.get_current();E.globalConfig.roles.push(b.get_name())}E.config=new E.NewAppConfig,E.utilities=new E.NewUtilities,a()},function(p,b){alert("Error initializing SAL: "+b.get_message()),console.error("Error initializing SAL: "+b.get_message(),b),r()})})}E.NewAppConfig=function(){var i={};i.roles={FullControl:"Full Control",Design:"Design",Edit:"Edit",Contribute:"Contribute",RestrictedContribute:"Restricted Contribute",InitialCreate:"Initial Create",Read:"Read",RestrictedRead:"Restricted Read",LimitedAccess:"Limited Access"},i.fulfillsRole=function(s,o){let a=Object.values(i.roles);return!a.includes(s)||!a.includes(o)?!1:a.indexOf(s)<=a.indexOf(o)},i.validate=function(){Object.keys(i.roles).forEach(function(s){var o=i.roles[s];E.globalConfig.roles.includes(o)?console.log(o):console.error(o+" is not in the global roles list")})};var e={groups:{Owners:"workorder Owners",Members:"workorder Members",Visitors:"workorder Visitors",RestrictedReaders:"Restricted Readers"}},t={siteRoles:i,siteGroups:e};return t};async function Os(i=_spPageContextInfo.userId){let e="/sp.userprofiles.peoplemanager/getmyproperties",t=`/Web/GetUserById(${i})/?$expand=Groups`,s=(await X(t)).d,o=(await X(e))?.d.UserProfileProperties.results;function a(r,p){return r.find(b=>b.Key==p)?.Value}return{ID:i,Title:s.Title,LoginName:s.LoginName,WorkPhone:a(o,"WorkPhone"),EMail:a(o,"WorkEmail"),IsEnsured:!0,IsGroup:!1,Groups:s.Groups?.results?.map(r=>({...r,ID:r.Id,IsGroup:!0,IsEnsured:!0})),Department:a(o,"Department")}}E.NewUtilities=function(){function i(r,p,b){b=b===void 0?null:b;var x=new SP.ClientContext.get_current,N=x.get_web(),_=new SP.GroupCreationInformation;_.set_title(r),this.oGroup=oWebsite.get_siteGroups().add(_),oGroup.set_owner(oWebsite.get_associatedOwnerGroup()),oGroup.update();var K=SP.RoleDefinitionBindingCollection.newObject(clientContext);this.oRoleDefinitions=[],p.forEach(function(U){var ce=oWebsite.get_roleDefinitions().getByName(U);this.oRoleDefinitions.push(ce),K.add(ce)});var ye=oWebsite.get_roleAssignments();ye.add(oGroup,K);function te(){var U=oGroup.get_title()+" created and assigned to "+oRoleDefinitions.forEach(function(ce){ce+""});b&&b(oGroup.get_id()),console.log(U)}function de(U,ce){alert(groupnName+" - Create group failed. "+ce.get_message()+`
`+ce.get_stackTrace())}clientContext.load(oGroup,"Title");var he={groupName:r,oGroup,oRoleDefinition,callback:b};clientContext.executeQueryAsync(Function.createDelegate(he,te),Function.createDelegate(he,de))}function e(r,p){var b=new SP.ClientContext.get_current,x=b.get_web(),N=x.ensureUser(r),_=N.get_groups();function K(){for(var te=new Array,de=new String,he=_.getEnumerator();he.moveNext();){var U=he.get_current(),ce={};ce.ID=U.get_id(),ce.Title=U.get_title(),de+=`
Group ID: `+U.get_id()+", Title : "+U.get_title(),te.push(ce)}console.log(de.toString()),p(te)}function ye(te,de){console.error(" Everyone - Query Everyone group failed. "+de.get_message()+`
`+de.get_stackTrace())}b.load(N),b.load(_),data={everyone:N,oGroups:_,callback:p},b.executeQueryAsync(Function.createDelegate(data,K),Function.createDelegate(data,ye))}function t(r,p){var b=new SP.ClientContext.get_current,x=r.get_users();function N(){for(var ye=[],te=x.getEnumerator();te.moveNext();){var de={},he=te.get_current();de.title=he.get_title(),de.loginName=he.get_loginName(),ye.push(de)}p(ye)}function _(ye,te){}var K={oUsers:x,callback:p};b.load(x),b.executeQueryAsync(Function.createDelegate(K,N),Function.createDelegate(K,_))}function s(r,p,b,x){var N=new SP.ClientContext.get_current,_=N.get_web(),K=_.getFolderByServerRelativeUrl(r);N.load(K,"Files"),N.executeQueryAsync(function(){console.log("Got the source folder right here!");for(var ye=K.get_files(),te=ye.getEnumerator(),de=[];te.moveNext();){var he=te.get_current(),U=p+"/"+he.get_name();de.push(U),he.copyTo(U,!0)}console.log(de),N.executeQueryAsync(function(){console.log("Files moved successfully!"),b()},function(ce,ot){console.log("error: ")+ot.get_message()})},function(ye,te){console.log("Sorry, something messed up: "+te.get_message())})}function o(r,p){return new Promise((b,x)=>{s(r,p,b,x)})}var a={copyFiles:s,copyFilesAsync:o,createSiteGroup:i,getUserGroups:e,getUsersWithGroup:t};return a};async function je(i){return new Promise((e,t)=>{var s=E.globalConfig.siteGroups.find(function(x){return x.LoginName==i});if(s){e(s);return}var o=new SP.ClientContext.get_current,a=o.get_web().ensureUser(i);function r(x,N){let _={ID:a.get_id(),Title:a.get_title(),LoginName:a.get_loginName(),Email:a.get_email(),IsEnsured:!0,IsGroup:!1};e(_)}function p(x,N){console.error("Failed to ensure user :"+N.get_message()+`
`+N.get_stackTrace()),t(N)}let b={oUser:a,resolve:e,reject:t};o.load(a),o.executeQueryAsync(Function.createDelegate(b,r),Function.createDelegate(b,p))})}function xa(i){for(var e=new Array,t=i.getEnumerator();t.moveNext();){var s=t.get_current();e.push(Ds(s))}return e}E.getSPSiteGroupByName=function(i){var e=null;return this.globalConfig.siteGroups!=null&&(e=this.globalConfig.siteGroups.find(function(t){return t.Title==i})),e};function Ls(i,e){let t=`/web/getFileByServerRelativeUrl('${i}')/copyTo(strNewUrl='${e}',bOverWrite=true)`;return X(t,"POST")}function Vs(i){var e=this;e.config={def:i};async function t(){if(!e.config.fieldSchema){let n=`/web/lists/GetByTitle('${e.config.def.title}')/Fields`,l=await X(n);e.config.fieldSchema=l.d.results}}t();function s(n,l){return new Promise((c,u)=>{o(n,c,l)})}function o(n,l,c){c=c===void 0?!1:c;var u=new Array,f=new Array,A=new SP.ClientContext.get_current,g=A.get_web(),m=g.get_lists().getByTitle(e.config.def.title);n.forEach(function(C){var T=E.getSPSiteGroupByName(C[0]);T?f.push([T,C[1]]):u.push([A.get_web().ensureUser(C[0]),C[1]])});function q(){console.log("Successfully found item");var C=new SP.ClientContext.get_current,T=C.get_web();c?(m.resetRoleInheritance(),m.breakRoleInheritance(!1,!1),m.get_roleAssignments().getByPrincipal(E.globalConfig.currentUser).deleteObject()):m.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(G){var H=SP.RoleDefinitionBindingCollection.newObject(C);H.add(T.get_roleDefinitions().getByName(G[1])),m.get_roleAssignments().add(G[0],H)}),this.users.forEach(function(G){var H=SP.RoleDefinitionBindingCollection.newObject(C);H.add(T.get_roleDefinitions().getByName(G[1])),m.get_roleAssignments().add(G[0],H)});var S={oList:m,callback:l};function P(){console.log("Successfully set permissions"),l(m)}function L(G,H){console.error("Failed to update permissions on List: "+this.oList.get_title()+H.get_message()+`
`,H.get_stackTrace())}C.load(m),C.executeQueryAsync(Function.createDelegate(S,P),Function.createDelegate(S,L))}function v(C,T){console.error("Failed to find List: "+this.oList.get_title+T.get_message(),T.get_stackTrace())}var w={oList:m,users:u,resolvedGroups:f,callback:l};A.load(m),u.map(function(C){A.load(C[0])}),A.executeQueryAsync(Function.createDelegate(w,q),Function.createDelegate(w,v))}function a(n){return n&&(Array.isArray(n)?n.map(l=>r(l)).join(";#"):r(n))}function r(n){return n.ID?`${n.ID};#${n.LookupValue??""}`:n.LookupValue?n.LookupValue:n.constructor.getName()=="Date"?n.toISOString():n}function p(n,l=null){return new Promise((c,u)=>{let f=new SP.ClientContext.get_current,g=f.get_web().get_lists().getByTitle(e.config.def.title),m=new SP.ListItemCreationInformation;if(l){var q=E.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+l;m.set_folderUrl(q)}let v=g.addItem(m),w=["ID","Author","Created","Editor","Modified"];Object.keys(n).filter(P=>!w.includes(P)).forEach(P=>{v.set_item(P,a(n[P]))}),v.update();function C(){c(v.get_id())}function T(P,L){console.error("Create Item Failed - List: "+e.config.def.name),console.error("ValuePairs",n),console.error(P,L),u(P)}let S={entity:n,oListItem:v,resolve:c,reject:u};f.load(v),f.executeQueryAsync(Function.createDelegate(S,C),Function.createDelegate(S,T))})}function b(n){if(!n)return n;let l={};switch(n.constructor.getName()){case"SP.FieldUserValue":l.LoginName=n.get_email();case"SP.FieldLookupValue":l.ID=n.get_lookupId(),l.LookupValue=n.get_lookupValue(),l.Title=n.get_lookupValue();break;default:l=n}return l}function x(n,l,c){var u=new SP.CamlQuery.createAllItemsQuery;u.set_viewXml(n);var f=new SP.ClientContext.get_current,A=f.get_web(),g=A.get_lists().getByTitle(e.config.def.title),m=g.getItems(u);function q(){var C=this,T=C.collListItem.getEnumerator();let S=[];for(;T.moveNext();){var P=T.get_current(),L={};l.forEach(G=>{var H=P.get_item(G);L[G]=Array.isArray(H)?H.map(fe=>b(fe)):b(H)}),S.push(L)}c(S)}function v(C,T){console.log("unsuccessful read",C),alert("Request on list "+e.config.def.name+` failed, producing the following error: 
 `+T.get_message()+`
StackTrack: 
 `+T.get_stackTrace())}var w={collListItem:m,callback:c,fields:l,camlQuery:u};f.load(m,`Include(${l.join(", ")})`),f.executeQueryAsync(Function.createDelegate(w,q),Function.createDelegate(w,v))}function N({fields:n=null,caml:l=null}){if(!l)var l='<View Scope="RecursiveAll"><Query><Where><Eq><FieldRef Name="FSObjType"/><Value Type="int">0</Value></Eq></Where></Query></View>';return new Promise((c,u)=>{x(l,n,c)})}function _(n,l){return new Promise((c,u)=>{try{U(n,l,c)}catch(f){u(f)}})}async function K(n,l){let[c,u]=await te(l),f=`/web/lists/GetByTitle('${e.config.def.title}')/items(${n})?$Select=${c}&$expand=${u}`;return(await X(f)).d}async function ye(){if(!e.config.fieldSchema){let n=`/web/lists/GetByTitle('${e.config.def.title}')/Fields`,l=await X(n);e.config.fieldSchema=l.d.results}return e.config.fieldSchema}async function te(n){let l=[],c=[],u=await ye();return n.map(f=>{if(f.includes("/")){l.push(f),c.push(f.split("/")[0]);return}let A=u.find(g=>g.StaticName==f);if(!A){alert(`Field '${f}' not found on list ${e.config.def.name}`);return}switch(A.TypeAsString){case"UserMulti":case"User":case"LookupMulti":case"Lookup":let g=f+"/ID",m=f+"/Title";l.push(g),l.push(m),c.push(f);break;case"Choice":default:l.push(f)}}),[l,c]}async function de(n,{orderByColumn:l=null,sortAsc:c},{count:u=null},f,A){let[g,m]=await te(f),q=l?`$orderby=${l} ${c?"asc":"desc"}`:"",v=[];n.forEach(H=>v.push(`${H.column} ${H.op??"eq"} '${H.value}'`)),A||v.push("FSObjType eq '0'");let w="$filter=("+v.join(") and (")+")",C="$select="+g,T="$expand="+m,S=u?`$top=${u}`:"",P=`/web/lists/GetByTitle('${e.config.def.title}')/items?${C}&${T}&${q}&${w}&${S}`,L=await X(P);return{results:L?.d?.results,_next:L?.d?.__next}}async function he(n){let l=await X(n._next);return{results:l?.d?.results,_next:l?.d?.__next}}function U(n,l,c){var u=new SP.ClientContext.get_current,f=u.get_web(),A=f.get_lists().getByTitle(e.config.def.title),g=A.getItemById(n);function m(){let w={};l.forEach(C=>{var T=g.get_item(C);w[C]=Array.isArray(T)?T.map(S=>b(S)):b(T)}),c(w)}function q(w,C){console.error("SAL: findById - List: "+e.config.def.name),console.error("Fields",this),console.error(w,C)}var v={oListItem:g,callback:c,fields:l};u.load(g),u.executeQueryAsync(Function.createDelegate(v,m),Function.createDelegate(v,q))}function ce(n){return n?.ID?new Promise((l,c)=>{let u=new SP.ClientContext.get_current,g=u.get_web().get_lists().getByTitle(e.config.def.title).getItemById(n.ID),m=["ID","Author","Created","Editor","Modified"];Object.keys(n).filter(C=>!m.includes(C)).forEach(C=>{g.set_item(C,a(n[C]))}),g.update();function q(){console.log("Successfully updated "+this.oListItem.get_item("Title")),l()}function v(C,T){console.error("Update Failed - List: "+e.config.def.name),console.error("Item Id",this.oListItem.get_id()??"N/A"),console.error(n),console.error(C,T),c(T)}let w={oListItem:g,entity:n,resolve:l,reject:c};u.load(g),u.executeQueryAsync(Function.createDelegate(w,q),Function.createDelegate(w,v))}):!1}function ot(n,l){var c=new SP.ClientContext.get_current,u=c.get_web(),f=u.get_lists().getByTitle(e.config.def.title),A={callback:l};f.getItemById(n).deleteObject();function m(v,w){l()}function q(v,w){console.error("sal.SPList.deleteListItem: Request on list "+e.config.def.name+` failed, producing the following error: 
 `+w.get_message()+`
StackTrack: 
 `+w.get_stackTrace())}c.executeQueryAsync(Function.createDelegate(A,m),Function.createDelegate(A,q))}function Kt(n){return new Promise((l,c)=>ot(n,l))}function zo(n,l,c){return new Promise((u,f)=>{Jo(n,l,u,c)})}function Jo(n,l,c,u){u=u===void 0?!1:u;let f=[],A=[],g=new SP.ClientContext.get_current,v=g.get_web().get_lists().getByTitle(e.config.def.title).getItemById(n);l.forEach(function(S){let P=E.getSPSiteGroupByName(S[0]);P?.oGroup?A.push([P.oGroup,S[1]]):f.push([g.get_web().ensureUser(S[0]),S[1]])});function w(){console.log("Successfully found item");let S=new SP.ClientContext.get_current,P=S.get_web();u?(v.resetRoleInheritance(),v.breakRoleInheritance(!1,!1),v.get_roleAssignments().getByPrincipal(E.globalConfig.currentUser).deleteObject()):v.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(fe){let ue=SP.RoleDefinitionBindingCollection.newObject(S);ue.add(P.get_roleDefinitions().getByName(fe[1])),v.get_roleAssignments().add(fe[0],ue)}),this.users.forEach(function(fe){let ue=SP.RoleDefinitionBindingCollection.newObject(S);ue.add(P.get_roleDefinitions().getByName(fe[1])),v.get_roleAssignments().add(fe[0],ue)});var L={oListItem:v,callback:c};function G(){console.log("Successfully set permissions"),c(v)}function H(fe,ue){console.error("Failed to update permissions on item: "+this.oListItem.get_lookupValue()+ue.get_message()+`
`+ue.get_stackTrace(),!1)}S.load(v),S.executeQueryAsync(Function.createDelegate(L,G),Function.createDelegate(L,H))}function C(S,P){console.error("Failed to update permissions on item: "+this.title+P.get_message()+`
`+P.get_stackTrace(),!1)}var T={id:n,oListItem:v,users:f,resolvedGroups:A,callback:c};g.load(v),f.map(function(S){g.load(S[0])}),g.executeQueryAsync(Function.createDelegate(T,w),Function.createDelegate(T,C))}function Ko(n){return new Promise((l,c)=>{var u=new SP.ClientContext.get_current,f=u.get_web(),A=f.get_lists().getByTitle(e.config.def.title),g=A.getItemById(n),m=g.get_roleAssignments();function q(){for(var C=new SP.ClientContext.get_current,T=C.get_web(),S=[],P=this.roles.getEnumerator();P.moveNext();){var L=P.get_current(),G=L.get_member();C.load(G),S.push(G)}C.executeQueryAsync(function(H,fe){var ue=S.map(function(Re){return{ID:Re.get_id(),Title:Re.get_title(),LoginName:Re.get_loginName()}});l(ue)},function(H,fe){alert("Request failed. "+fe.get_message()+`
`+fe.get_stackTrace()),c(fe)})}function v(C,T){console.error("Failed to get permissions on item: "+T.get_message()+`
`+T.get_stackTrace(),!1),c(T)}let w={id:n,oListItem:g,roles:m,resolve:l,reject:c};u.load(g),u.load(m),u.executeQueryAsync(Function.createDelegate(w,q),Function.createDelegate(w,v))})}function Ce(n){let l=e.config.def.isLib?"/"+e.config.def.name+"/":"/Lists/"+e.config.def.name+"/",c=E.globalConfig.siteUrl+l;return n.startsWith(c)?n:c+n}function Xo(n){return e.config.def.isLib?new Promise((l,c)=>aa(n,l)):new Promise((l,c)=>sa(n,l))}async function Yo(n){try{let c=(await ta(n)).map(u=>[u.LoginName,E.config.siteRoles.roles.RestrictedRead]);await Xt(n,c,!0)}catch(l){console.warn(l)}}async function Zo(n,l){let c=Ce(n),u=E.globalConfig.siteUrl+`/_api/web/GetFolderByServerRelativeUrl('${c}')/ListItemAllFields/RoleAssignments?$expand=Member,Member/Users,RoleDefinitionBindings`,f=await fetch(u,{method:"GET",headers:{Accept:"application/json; odata=verbose"}});if(!f.ok){if(f.status==404)return;console.error(f)}let A=await f.json(),g=A?.d?.results;if(!g){console.warn("No results found",A);return}let m=l.filter(q=>{let v=q[0],w=q[1];return!g.find(T=>T.Member.LoginName!=v&&!T.Member.Users?.results.find(S=>S.LoginName==v)?!1:!!T.RoleDefinitionBindings.results?.find(S=>E.config.siteRoles.fulfillsRole(S.Name,w)))});console.log("Adding missing permissions",m),m.length&&await Xt(n,m,!1)}function ea(n,l){return new Promise((c,u)=>{let f=new SP.ClientContext.get_current,g=f.get_web().get_lists().getByTitle(e.config.def.title),m=Ce(n),q=SP.CamlQuery.createAllItemsQuery();q.set_folderServerRelativeUrl(m);let v=g.getItems(q);f.load(v,`Include(${l.join(", ")})`),f.executeQueryAsync(function(){let w=[];for(var C=v.getEnumerator();C.moveNext();){var T=C.get_current(),S={};l.forEach(P=>{var L=T.get_item(P);S[P]=Array.isArray(L)?L.map(G=>b(G)):b(L)}),S.oListItem=T,w.push(S)}c(w)},function(w,C){console.warn("Unable load list folder contents:"),console.error(w),console.error(C),u(C)})})}async function ta(n){return new Promise(async(l,c)=>{let u=await ia(n);if(!u){c("Folder item does not exist");return}let f=u.get_roleAssignments(),A=new SP.ClientContext.get_current;A.load(u),A.load(f),A.executeQueryAsync(function(){let g=new SP.ClientContext.get_current;console.log(u);let m=[],q=[],v=f.getEnumerator();for(;v.moveNext();){let w=v.get_current(),C=w.get_member(),T=w.get_roleDefinitionBindings();g.load(T),g.load(C),m.push({principal:C,bindings:T})}g.executeQueryAsync(function(w,C){let T=m.map(function({principal:S,bindings:P}){let L=[],G=P.getEnumerator();for(;G.moveNext();){let H=G.get_current();L.push(H.get_name())}return{ID:S.get_id(),Title:S.get_title(),LoginName:S.get_loginName(),Roles:L}});l(T)},function(w,C){console.warn("Unable load folder principals permissions:"),console.error(w),console.error(C),c(C)})},function(g,m){console.warn("Unable load folder permissions:"),console.error(g),console.error(m),c(m)})})}async function ia(n){return new Promise((l,c)=>{let u=new SP.ClientContext.get_current,A=u.get_web().get_lists().getByTitle(e.config.def.title),g=SP.CamlQuery.createAllItemsQuery();var q='<View Scope="RecursiveAll"><Query><Where><And><Eq><FieldRef Name="FSObjType"/><Value Type="int">1</Value></Eq><Eq><FieldRef Name="FileRef"/><Value Type="Text">'+Ce(n)+"</Value></Eq></And></Where></Query><RowLimit>1</RowLimit></View>";g.set_viewXml(q);let v=A.getItems(g);async function w(){let S=[];for(var P=v.getEnumerator();P.moveNext();){let G=P.get_current();S.push(G)}S||(console.warn("folder not found"),l(S)),S.length>1&&(console.warn("Multiple folders found!"),l(S));let L=S[0];l(L)}function C(S,P){console.warn("Unable load list folder contents:"),console.error(S),console.error(P),c(P)}let T={allFolders:v,resolve:l,reject:c};u.load(v),u.executeQueryAsync(Function.createDelegate(T,w),Function.createDelegate(T,C))})}function sa(n,l){var c=n.split("/"),u=0,f=function(A,g,m,q){var v=g[m];m++;var w=g.slice(0,m).join("/");oa(w,function(C){m>=g.length?q(C.get_id()):f(w,g,m,q)},function(){e.createListFolder(v,function(C){m>=g.length?q(C):f(w,g,m,q)},A)})};f("",c,u,l)}e.createListFolder=function(n,l,c){c=c===void 0?"":c;let u=new SP.ClientContext.get_current,A=u.get_web().get_lists().getByTitle(e.config.def.title),g="",m=new SP.ListItemCreationInformation;m.set_underlyingObjectType(SP.FileSystemObjectType.folder),m.set_leafName(n),c&&(g=E.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+c,m.set_folderUrl(g));let q=A.addItem(m);q.set_item("Title",n),q.update();function v(T,S){l(this.newItem.get_id())}function w(T,S){alert("Request on list "+e.config.def.name+` failed, producing the following error: 
`+S.get_message()+`
StackTrack: 
`+S.get_stackTrace())}let C={folderName:n,callback:l,newItem:q};u.load(q),u.executeQueryAsync(Function.createDelegate(C,v),Function.createDelegate(C,w))};function oa(n,l,c){var u=E.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+n,f=SP.ClientContext.get_current(),A=f.get_web().getFolderByServerRelativeUrl(u);A.get_listItemAllFields();var g={folder:A,path:n,onExists:l,onNonExists:c};f.load(A,"Exists","Name");function m(){if(A.get_exists()){let C=function(){l(w)},T=function(S,P){console.error("Failed to find folder at "+n,P)};console.log("Folder "+A.get_name()+" exists in "+e.config.def.name);var v=new SP.ClientContext.get_current,w=A.get_listItemAllFields();g={folderItem:w,path:n,onExists:l},v.load(w),v.executeQueryAsync(Function.createDelegate(g,C),Function.createDelegate(g,T))}else console.warn("Folder exists but is hidden (security-trimmed) for us.")}function q(v,w){w.get_errorTypeName()==="System.IO.FileNotFoundException"?(console.log("SAL.SPList.ensureListFolder:           Folder "+n+" does not exist in "+e.config.def.name),c()):console.error("Error: "+w.get_message())}f.executeQueryAsync(Function.createDelegate(g,m),Function.createDelegate(g,q))}function aa(n,l){let f=new SP.ClientContext.get_current().get_web().get_lists().getByTitle(e.config.def.title);var A=function(g,m,q){var v=g.get_context(),w=m.split("/"),C=w[0],T=g.get_folders().add(C);v.load(T),v.executeQueryAsync(function(){if(w.length>1){var S=w.slice(1,w.length).join("/");A(T,S,q)}else q(T)},function(S,P){console.error("error creating new folder"),console.error(S),console.error(error)})};A(f.get_rootFolder(),n,l)}function Xt(n,l,c){return new Promise((u,f)=>{na(n,l,u,c)})}function na(n,l,c,u){u=u===void 0?!1:u;var f=[],A=[];let g=Ce(n),m=new SP.ClientContext.get_current,v=m.get_web().getFolderByServerRelativeUrl(g);l.forEach(function(S){var P=E.getSPSiteGroupByName(S[0]);P?.oGroup?A.push([P.oGroup,S[1]]):f.push([m.get_web().ensureUser(S[0]),S[1]])});function w(){var S=new SP.ClientContext.get_current,P=S.get_web(),L=this.folder.get_listItemAllFields();u?(L.resetRoleInheritance(),L.breakRoleInheritance(!1,!1),L.get_roleAssignments().getByPrincipal(E.globalConfig.currentUser).deleteObject()):L.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(ue){var Re=SP.RoleDefinitionBindingCollection.newObject(S);Re.add(P.get_roleDefinitions().getByName(ue[1])),L.get_roleAssignments().add(ue[0],Re)}),this.users.forEach(function(ue){var Re=SP.RoleDefinitionBindingCollection.newObject(S);Re.add(P.get_roleDefinitions().getByName(ue[1])),L.get_roleAssignments().add(ue[0],Re)});var G={folderItem:L,callback:c};function H(){console.log("Successfully set permissions"),this.callback(L)}function fe(ue,Re){console.error("Failed to update permissions on item: "+Re.get_message(),Re)}S.load(L),S.executeQueryAsync(Function.createDelegate(G,H),Function.createDelegate(G,fe))}function C(S,P){console.error("Something went wrong setting perms on library folder",P)}var T={folder:v,users:f,callback:c,resolvedGroups:A,valuePairs:l,reset:u};f.map(function(S){m.load(S[0])}),m.load(v),m.executeQueryAsync(Function.createDelegate(T,w),Function.createDelegate(T,C))}function ra(n){let c=`/web/GetFolderByServerRelativeUrl('${Ce(n)}')`;return X(c,"POST",{"If-Match":"*","X-HTTP-Method":"DELETE"})}function la(n,l,c,u){var f="";c.id&&(f=c.id);let A=SP.UI.$create_DialogOptions();var g=e.config.def.isLib?"/"+e.config.def.name+"/":"/Lists/"+e.config.def.name+"/",m="";c.rootFolder&&(m=E.globalConfig.siteUrl+g+c.rootFolder);var q=e.config.def.isLib?"/"+e.config.def.name+"/Forms/":"/Lists/"+e.config.def.name+"/";Object.assign(A,{title:l,dialogReturnValueCallback:u,args:JSON.stringify(c),url:E.globalConfig.siteUrl+q+n+"?ID="+f+"&Source="+location.pathname+"&RootFolder="+m}),SP.UI.ModalDialog.showModalDialog(A)}function da(n,l,c){return new Promise((u,f)=>{let A=new SP.ClientContext.get_current,m=A.get_web().get_lists().getByTitle(e.config.def.title);A.load(m),A.executeQueryAsync(function(){var q=E.globalConfig.siteUrl=="/"?"":E.globalConfig.siteUrl;let v=SP.UI.$create_DialogOptions();Object.assign(v,{title:l,dialogReturnValueCallback:u,args:JSON.stringify(c),url:q+"/_layouts/Upload.aspx?List="+m.get_id().toString()+"&RootFolder="+q+"/"+e.config.def.name+"/"+encodeURI(n)+"&Source="+location.pathname+"&args="+encodeURI(JSON.stringify(c))}),SP.UI.ModalDialog.showModalDialog(v)},function(q,v){console.error("Error showing file modal: "),console.error(q),console.error(v)})})}let ks=10485760,un={start:"startupload",continue:"continueupload",finish:"finishupload"};async function ca(n,l,c,u){let f=n,A=ks,g=n.size,m=parseInt((g/A).toString(),10)+(g%A===0?1:0),q=l+"/"+c,v=ka(),w;u({currentBlock:0,totalBlocks:m}),w=await ua(v,n.slice(0,A),q,l);for(let T=2;T<m;T++)u({currentBlock:T,totalBlocks:m}),w=await pa(v,n.slice(w,w+A),w,q);u({currentBlock:m-1,totalBlocks:m});let C=await ma(v,n.slice(w),w,q);return u({currentBlock:m,totalBlocks:m}),C}async function ua(n,l,c,u){let f=`/web/getFolderByServerRelativeUrl(@folder)/files/getByUrlOrAddStub(@file)/StartUpload(guid'${n}')?&@folder='${u}'&@file='${c}'`,m=await X(f,"POST",{"Content-Type":"application/octet-stream"},{body:l});if(!m){console.error("Error starting upload!");return}return parseFloat(m.d.StartUpload)}async function pa(n,l,c,u){let f=`/web/getFileByServerRelativeUrl(@file)/ContinueUpload(uploadId=guid'${n}',fileOffset=${c})?&@file='${u}'`,m=await X(f,"POST",{"Content-Type":"application/octet-stream"},{body:l});if(!m){console.error("Error starting upload!");return}return parseFloat(m.d.ContinueUpload)}async function ma(n,l,c,u){let f=`/web/getFileByServerRelativeUrl(@file)/FinishUpload(uploadId=guid'${n}',fileOffset=${c})?&@file='${u}'`,m=await X(f,"POST",{"Content-Type":"application/octet-stream"},{body:l});if(!m){console.error("Error starting upload!");return}return m}async function ha(n,l,c){return await fetch(_spPageContextInfo.webServerRelativeUrl+`/_api/web/GetFolderByServerRelativeUrl('${l}')/Files/add(url='${c}',overwrite=true)`,{method:"POST",credentials:"same-origin",body:n,headers:{Accept:"application/json; odata=verbose","Content-Type":"application/json;odata=nometadata","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value}}).then(u=>{if(!u.ok){console.error("Error Uploading File",u);return}return u.json()})}async function fa(n,l,c,u,f=null){f||(f=()=>{});let A=Ce(c),g=null;if(n.size>ks){let v=()=>ca(n,A,l,f);g=await qa.addJob(v)}else f({currentBlock:0,totalBlocks:1}),g=await ha(n,A,l),f({currentBlock:1,totalBlocks:1});await ga(g.d,u),await Sa(A+"/"+l,"");let m=g.d.ListItemAllFields.__deferred.uri+"?$select=ID";return(await X(m)).d.ID}async function ga(n,l){var c=await fetch(n.ListItemAllFields.__deferred.uri,{method:"POST",credentials:"same-origin",body:JSON.stringify(l),headers:{Accept:"application/json; odata=nometadata","Content-Type":"application/json;odata=nometadata","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value,"X-HTTP-Method":"MERGE","If-Match":"*"}}).then(u=>{if(!u.ok){console.error("Error Updating File",u);return}return u});return c}function ba(n,l,c,u){let f=Ce(n),A=Ce(l);var g=new SP.ClientContext.get_current,m=g.get_web(),q=m.getFolderByServerRelativeUrl(f);g.load(q,"Files"),g.executeQueryAsync(function(){for(var v=q.get_files(),w=v.getEnumerator(),C=[];w.moveNext();){var T=w.get_current(),S=A+"/"+T.get_name();C.push(S),T.copyTo(S,!0)}console.log(C),g.executeQueryAsync(function(){console.log("Files moved successfully!"),c()},function(P,L){console.log("error: ",L.getMessage()),u(L)})},function(v,w){console.error("Unable to copy files: ",w.get_message()),console.error(v,w),u(w)})}function ya(n,l){return new Promise((c,u)=>{ba(n,l,c,u)})}function va(n,l){let c=Ce(l),u=`/web/getFileByServerRelativeUrl(@s)/copyTo(strNewUrl=@d,bOverWrite=true)?@s='${n}'&@d='${c}'`;return X(u,"POST")}async function wa(n,l,c=null){c||(c=n.split("/").pop());let u=Ce(`Attachments/${l.ID}/${c}`),f=Ce(`${l.ID}/${c}`),A=`/web/lists/getbytitle('${e.config.def.title}')/items(${l.ID})/AttachmentFiles/add(FileName='${c}')`,g=`/web/GetFileByServerRelativeUrl('${n}')/$value`,m=await X(g,"GET",null,null,"blob");if(!m)return;let q=await m.arrayBuffer(),v={"Content-Length":q.byteLength};return await X(A,"POST",v,{body:q})}async function pn(){let n=await X(`/web/lists/GetByTitle('${e.config.def.title}')`)}function Sa(n,l){let c=`/web/GetFileByServerRelativeUrl('${n}')/CheckIn(comment='${l}',checkintype=0)`;return X(c,"POST")}return{findByIdAsync:_,getById:K,findByColumnValueAsync:de,loadNextPage:he,getListItemsAsync:N,createListItemAsync:p,updateListItemAsync:ce,deleteListItemAsync:Kt,setItemPermissionsAsync:zo,getItemPermissionsAsync:Ko,getFolderContentsAsync:ea,upsertFolderPathAsync:Xo,deleteFolderByPathAsync:ra,getServerRelativeFolderPath:Ce,setFolderReadonlyAsync:Yo,setFolderPermissionsAsync:Xt,ensureFolderPermissionsAsync:Zo,uploadFileToFolderAndUpdateMetadata:fa,uploadNewDocumentAsync:da,copyFilesAsync:ya,copyFileAsync:va,copyAttachmentFromPath:wa,showModal:la}}async function X(i,e="GET",t={},s={},o="json"){let a=i.startsWith("http")?i:E.globalConfig.siteUrl+"/_api"+i,r=await fetch(a,{method:e,headers:{Accept:"application/json; odata=verbose","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value,...t},...s});if(!r.ok){if(r.status==404)return;console.error(r)}try{let p;switch(o){case"json":p=await r.json();break;case"blob":p=await r.blob();break;default:p=r}return p}catch{return r}}window.spFetch=X;function ka(){if(crypto.randomUUID)return crypto.randomUUID();let i=Date.now();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){let t=(i+Math.random()*16)%16|0;return i=Math.floor(i/16),(e==="x"?t:t&3|8).toString(16)})}var ei=class{constructor(e){this.maxConcurrency=e,this.runningJobs=0,this.queue=[]}addJob(e){return new Promise((t,s)=>{let o=async()=>{try{let a=await e();t(a)}catch(a){s(a)}finally{this.runningJobs--,this.processQueue()}};this.queue.push(o),this.processQueue()})}processQueue(){for(;this.runningJobs<this.maxConcurrency&&this.queue.length>0;){let e=this.queue.shift();this.runningJobs++,e()}}},qa=new ei(5);var Y={FullControl:"Full Control",Design:"Design",Edit:"Edit",Contribute:"Contribute",Read:"Read",LimitedAccess:"Limited Access",RestrictedRead:"Restricted Read",RestrictedContribute:"Restricted Contribute",InitialCreate:"Initial Create"},Fa={RestrictedReaders:new W({ID:null,Title:"Restricted Readers"})},Je={Admin:"Admin",ActionOffice:"ActionOffice"},Se={ActionResolver:{LookupValue:"Action Resolver",description:"Confirms completion of an action.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Assigner:{LookupValue:"Assigner",description:"Can create additional assignments.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Approver:{LookupValue:"Approver",description:"Approves or Rejects the request.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Viewer:{LookupValue:"Viewer",description:"Has view only access to the request.",isAssignable:!0,permissions:Y.RestrictedRead},Subscriber:{LookupValue:"Subscriber",description:"Has view only access to the request and recieves notifications",isAssignable:!0,permissions:Y.RestrictedRead}},xt={"Pending Assignment":Se.Assigner,"Pending Approval":Se.Approver,"Pending Action":Se.ActionResolver,"Pending Resolution":Se.ActionResolver,Notification:Se.Subscriber},F=ko.observable(),Tt=class i extends W{constructor({ID:e,Title:t,LoginName:s=null,LookupValue:o=null,WorkPhone:a=null,EMail:r=null,IsGroup:p=null,IsEnsured:b=!1,Groups:x=null,Department:N=null}){super({ID:e,Title:t,LookupValue:o,LoginName:s,IsGroup:p,IsEnsured:b}),this.WorkPhone=a,this.EMail=r,this.Email=r,this.OfficeSymbol=N??"CGFS/EX",this.Groups=x}OfficeSymbol;Groups=[];isInGroup(e){return e?.ID?this.getGroupIds().includes(e.ID):!1}getGroupIds(){return this.Groups.map(e=>e.ID)}isInRequestOrg=e=>this.RequestOrgs().find(t=>t.ID==e.ID);RequestOrgs=ko.pureComputed(()=>{let e=this.getGroupIds();return ge().filter(t=>t.Everyone||e.includes(t.UserGroup?.ID))});RequestingOffices=ko.pureComputed(()=>this.RequestOrgs().filter(e=>e.OrgType==Yt.RequestingOffice));ActionOffices=ko.pureComputed(()=>this.RequestOrgs().filter(e=>e.OrgType==Yt.ActionOffice));IsActionOffice=ko.pureComputed(()=>this.ActionOffices().length);IsSiteOwner=ko.pureComputed(()=>this.isInGroup(ti().owners));hasSystemRole=e=>{let t=this.IsSiteOwner();switch(e){case Je.Admin:return t;case Je.ActionOffice:return t||this.ActionOffices().length;default:}};static Create=async function(){let e=await Os();return new i(e)}};function Bs(i){let e=ti(),t=i.RequestorInfo.Requestor(),s=i.Author.Value(),o=i.RequestorInfo.Office(),a=[[new W(e.owners),Y.FullControl],[Fa.RestrictedReaders,Y.RestrictedRead],[t,Y.RestrictedContribute],[s,Y.RestrictedContribute]];return o&&!o.BreakAccess&&a.push([o.UserGroup,Y.RestrictedContribute]),i.Pipeline.Stages()?.forEach(r=>{let p=ae.FindInStore(r.RequestOrg);if(p&&a.push([p.UserGroup,Y.RestrictedContribute]),r.AssignmentFunction&&Ke[r.AssignmentFunction])try{Ke[r.AssignmentFunction](i,r).forEach(x=>{let N=x.Assignee;N&&N.Title&&a.push([N,Y.RestrictedContribute])})}catch{console.warn("Error creating stage assignments",r)}}),a}async function kt(i){let e=await Ps(i);return e?e.map(t=>new W(t)):[]}async function _s(i){let e=await je(i.LoginName??i.Title);return e?new W(e):null}var Ke={TestFunc:function(){return request.RequestorInfo.Requestor()},ch_overtimeGovManager:function(i,e){let t=i.RequestBodyBlob?.Value()?.GovManager.get();if(!t)throw new Error("Could not find stage Assignee");return[new pe({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.ActionResolver,CustomComponent:"GovManagerActions"})]},ch_overtimeAPM:function(i,e){let t=i.RequestBodyBlob?.Value()?.FieldMap.APM.get();if(!t)throw new Error("Could not find stage Assignee");return[new pe({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.ActionResolver,CustomComponent:"APMActions"})]},getGTM:function(i,e){let t=i.RequestBodyBlob?.Value()?.FieldMap.GTM.get();if(!t)throw new Error("Could not find stage Assignee");return[new pe({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.Approver})]},getCOR:function(i,e){let t=i.RequestBodyBlob?.Value()?.FieldMap.COR.get();if(!t)throw new Error("Could not find stage Assignee");return[new pe({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.Approver})]},getSupervisor:function(i,e){return[new pe({Assignee:Ms(i,"Supervisor"),RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.Approver})]},getWildcard:function(i,e,t){return[new pe({Assignee:Ms(i,t),RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Se.Approver,CustomComponent:e.ActionComponentName})]}};function Ms(i,e){let t=i.RequestBodyBlob?.Value()?.FieldMap[e]?.get();if(!t)throw new Error(`Could not find assignee field on current request: ${e}`);return t}var R=String.raw,V=class{constructor(){}static name="base-component";static template=R`<div>No Component Registered!</div>`};var Us=R`
...
`;var qt=class extends V{constructor({Entity:e}){super(),Object.assign(this,e)}},qe=class extends qt{constructor(e){super(e)}static name=_e.view;static template=Hs},Ae=class extends qt{constructor(e){super(e)}static name=_e.edit;static template=js};var xe={PendingAssignment:"Pending Assignment",PendingApproval:"Pending Approval",PendingAction:"Pending Action",PendingResolution:"Pending Resolution",Notification:"Notification",Closed:"Closed"},Fe=class i{constructor({ID:e,Title:t}){this.ID=e,this.Title=t,this.LookupValue=t}static Create=function({ID:e,LookupValue:t}){return new i({ID:e,Title:t})};static FindInStore=function(e){return!e||!e.ID?null:Xe().find(t=>t.ID==e.ID)};static GetCompletedStage=function(){return Xe().find(e=>e.ActionType==xe.Closed)};static Views={All:["ID","Title","ServiceType","Step","ActionType","ActionTargetStage","Assignee","WildCardAssignee","RequestOrg","AssignmentFunction","ActionComponentName"]};static ListDef={name:"ConfigPipelines",title:"ConfigPipelines",fields:i.Views.All}},Xe=ko.observableArray();var B={Paused:"Paused",Resumed:"Resumed",Assigned:"Assigned",Unassigned:"Unassigned",Created:"Created",Advanced:"Advanced",Approved:"Approved",Completed:"Completed",Rejected:"Rejected",Closed:"Closed"},Ye=class{constructor(){}PipelineStage;FieldMap={PipelineStage:{get:()=>this.PipelineStage,set:e=>{this.PipelineStage=Fe.FindInStore(e)}}};static Views={All:["ID","Title","PipelineStage","ActionType","Description","Author","Created"]};static ListDef={name:"Actions",title:"Actions",fields:this.Views.All}};var Ue=class{constructor(){}static Views={All:["ID","Title","IsActive","Request","FileLeafRef","FileRef","Author","Created"]};static ListDef={name:"Attachments",title:"Attachments",fields:this.Views.All,isLib:!0}};var Ze=class{constructor(){}static Views={All:["ID","Title","Comment","NotificationSent","Author","IsActive","Created"]};static ListDef={name:"Comments",title:"Comments",fields:this.Views.All}};var It=ko.observable(),Ft=class i{static Views={All:["ID","Title","Date","Repeating"]};static ListDef={name:"ConfigHolidays",title:"ConfigHolidays",fields:i.Views.All}};var ne=class{constructor({displayName:e,instructions:t=null,isRequired:s=!1,width:o,Visible:a=ko.pureComputed(()=>!0)}){this.displayName=e,this.instructions=t,this.isRequired=s,this.Visible=a,this.width=o?"col-md-"+o:"col-md-6",this.addFieldRequirement(Ia(this))}Value=ko.observable();get=()=>this.Value();set=e=>this.Value(e);toString=ko.pureComputed(()=>this.Value());toJSON=()=>this.Value();fromJSON=e=>this.Value(e);validate=(e=!0)=>(this.ShowErrors(e),this.Errors());_fieldValidationRequirements=ko.observableArray();Errors=ko.pureComputed(()=>this.Visible()?this._fieldValidationRequirements().filter(t=>t.requirement()).map(t=>t.error):[]);addFieldRequirement=e=>this._fieldValidationRequirements.push(e);IsValid=ko.pureComputed(()=>!this.Errors().length);ShowErrors=ko.observable(!1);ValidationClass=ko.pureComputed(()=>{if(this.ShowErrors())return this.Errors().length?"is-invalid":"is-valid"})};function Ia(i){return{requirement:ko.pureComputed(()=>{if(!ko.unwrap(i.isRequired))return!1;let t=ko.unwrap(i.Value);return t?.constructor==Array?!t.length:t==null}),error:new Te("text-field","required-field",`${ko.utils.unwrapObservable(i.displayName)} is required!`)}}var I={draft:"Draft",open:"Open",paused:"Paused",fulfilled:"Completed",cancelled:"Cancelled",rejected:"Rejected"},Ge={inProgress:"In Progress",waitingOnCustomer:"Waiting on Customer",researching:"Researching"};var Dt=class{constructor({addNew:e,refresh:t,list:s,AreLoading:o},a){a.subscribeAdded(this.activityQueueWatcher),this.addNew=e,this.refresh=t,this.Actions=s.All,this.AreLoading=o}activityQueueWatcher=e=>{e.map(({activity:t,data:s})=>{this.actionTypeFunctionMap[t]&&this.actionTypeFunctionMap[t](s)})};actionTypeFunctionMap={Assigned:this.assignmentAdded.bind(this),Unassigned:this.assignmentRemoved.bind(this),Created:this.requestCreated.bind(this),Advanced:this.requestAdvanced.bind(this),Approved:this.requestApproved.bind(this),Rejected:this.requestRejected.bind(this),Paused:this.requestPaused.bind(this),Resumed:this.requestResumed.bind(this),Closed:this.requestClosed.bind(this)};async requestCreated(e){this.addNew({ActionType:B.Created,Description:`The request was submitted with an effective submission date of ${e.Dates.Submitted.toLocaleDateString()}.`})}async requestAdvanced(e){this.addNew({ActionType:B.Advanced,Description:`The request was advanced to stage ${e.Step}: ${e.Title}.`})}requestPaused(e){this.addNew({ActionType:B.Paused,Description:e})}requestResumed(){this.addNew({ActionType:B.Resumed,Description:"Request clock has been resumed"})}async requestClosed(e){this.addNew({ActionType:B.Closed,Description:`The request was closed with a status of ${e.State.Status()}.`})}async assignmentCompleted(e){let t=`${e.ActionTaker.Title} has ${e.Status} an assignment.`;this.addNew({ActionType:e.Status,Description:t})}async requestApproved(e){let t=`${e.ActionTaker.Title} has ${e.Status} an assignment.`;this.addNew({ActionType:B.Approved,Description:t})}async requestRejected(e){let t=`${e.ActionTaker.Title} has rejected the request and provided the following reason:<br/>`+e.Comment;this.addNew({ActionType:B.Rejected,Description:t})}async assignmentAdded(e){let t=`The following ${e.Role.LookupValue}s have been assigned to this request:<br>`;e.Assignee?.Title&&(t+=`${e.Assignee.Title} - `),t+=e.RequestOrg?.Title,this.addNew({ActionType:B.Assigned,Description:t})}async assignmentRemoved(e){let t=`The following ${e.Role.LookupValue??e.Role}s have been removed from this request:<br>`;e.Assignee?.Title&&(t+=`${e.Assignee.Title} - `),t+=e.RequestOrg?.Title,this.addNew({ActionType:B.Unassigned,Description:t})}};var at=(i,e)=>i.Title>e.Title?1:i.Title<e.Title?-1:0,Qs=i=>(e,t)=>e[i]>t[i]?1:e[i]<t[i]?-1:0,Ws=()=>{let i=new Date;return i.format("yyMMdd")+"-"+i.getTime()%1e5};function Pt(i,e){for(var t=0,s=new Date(i),o=Math.abs(e),a=Math.sign(e);o>=0;)s.setTime(i.getTime()+a*t*864e5),Ks(s)&&!Js(s)&&--o,++t;return s}function zs(i,e){for(var t=0,s=new Date(i),o=Math.sign(e-i);s.format("yyyy-MM-dd")!=e.format("yyyy-MM-dd");)Ks(s)&&!Js(s)&&t++,s.setDate(s.getDate()+1*o);return t*o}function Js(i){var e=It().find(function(t){var s=t.Date.getUTCDate()==i.getUTCDate(),o=t.Date.getUTCMonth()==i.getUTCMonth(),a=t.Date.getUTCFullYear()==i.getUTCFullYear();return t.Repeating&&(a=!0),s&&o&&a});return e}function Ks(i){var e=i.getDay();if(e===0||e===6)return!1;let t=["12/31+5","1/1","1/2+1","1-3/1","2-3/1","5~1/1","7/3+5","7/4","7/5+1","9-1/1","10-2/1","11/10+5","11/11","11/12+1","11-4/4","12/24+5","12/25","12/26+1"];var s=i.getDate(),o=i.getMonth()+1,a=o+"/"+s;if(t.indexOf(a)>-1)return!1;var r=a+"+"+e;if(t.indexOf(r)>-1)return!1;var p=Math.floor((s-1)/7)+1,b=o+"-"+p+"/"+e;if(t.indexOf(b)>-1)return!1;var x=new Date(i);x.setMonth(x.getMonth()+1),x.setDate(0);var N=Math.floor((x.getDate()-s-1)/7)+1,_=o+"~"+N+"/"+e;return!(t.indexOf(_)>-1)}var Ys=Ns,Xs={};window.history.replaceState({},"",document.location.href);function et(i,e){if(Nt(i)==e)return;let t=window.location.search,s=new RegExp("([?;&])"+i+"[^&;]*[;&]?"),o=t.replace(s,"$1").replace(/&$/,""),a=(o.length>2?o+"&":"?")+(e?i+"="+e:"");Xs[i]=e,window.history.pushState(Xs,"",a.toString())}function Nt(i){let e=new RegExp("[?&]"+i+"=([^&#]*)").exec(window.location.href);return e==null?null:decodeURI(e[1])||0}var Et={pending:"Pending",aging:"Aging",completed:"Completed"},nt=class{constructor({msg:e,blocking:t}){this.msg=e,this.blocking=t,this.Status(Et.pending),this.timeout=this.setTimeout()}msg;blocking;Status=ko.observable();timeout;timeoutPeriod=5e3;setTimeout=()=>window.setTimeout(()=>{console.warn("this task is aging:",this),this.Status(Et.aging)},this.timeoutPeriod);resetTimeout=()=>{window.clearTimeout(this.timeout),this.timeout=this.setTimeout()};markComplete=()=>{window.clearTimeout(this.timeout),this.Status(Et.completed)};IsBlocking=ko.pureComputed(()=>this.blocking&&this.Status()!=Et.completed)},Ot=class extends nt{constructor({msg:e,blocking:t}){super({msg:e,blocking:t})}timeoutPeriod=8e3;updateProgress=({percentDone:e})=>{this.Status(`${parseInt(e*100)}%`)}};var rt=ko.observableArray(),eo=ko.pureComputed(()=>rt().filter(i=>i.IsBlocking())??[]),ie={init:{msg:"Initializing the Application",blocking:!0},save:{msg:"Saving Request",blocking:!0},cancelAction:{msg:"Cancelling Action",blocking:!0},view:{msg:"Viewing Request",blocking:!1},refresh:{msg:"Refreshing Request",blocking:!1},permissions:{msg:"Updating Request Item Permissions",blocking:!0},lock:{msg:"Locking Request",blocking:!0},closing:{msg:"Closing Request",blocking:!0},pipeline:{msg:"Progressing to Next Stage",blocking:!0},newComment:{msg:"Submitting Comment",blocking:!1},refreshComments:{msg:"Refreshing Comments",blocking:!1},notifyComment:{msg:"Sending Comment Email",blocking:!1},removeComment:{msg:"Removing Comment",blocking:!1},newAction:{msg:"Submitting Action",blocking:!1},refreshActions:{msg:"Refreshing Actions",blocking:!1},newAttachment:{msg:"Submitting Attachment",blocking:!1},uploadAttachment:i=>({msg:"Uploading Attachment: "+i,blocking:!0,type:Ot}),refreshAttachments:{msg:"Refreshing Attachments",blocking:!1},copyAttachment:i=>({msg:"Copying attachment: "+i,blocking:!0}),newNotification:{msg:"Submitting Notification",blocking:!0},approve:{msg:"Approving Request",blocking:!0}},se=i=>{let e=i.type?new i.type(i):new nt(i);return rt.push(e),e},Z=function(i){i&&(i.markComplete(),window.setTimeout(()=>Da(i),3e3))},Da=function(i){rt.remove(i)};var Ee={MyRequests:"my-requests-tab",NewRequest:"new-request-tab",RequestDetail:"request-detail-tab"},lt="/sites/CGFS/Style Library/apps/wo/src",to=_spPageContextInfo.webTitle;var Pa=String.raw,io={Created:Na,Advanced:Ea,Assigned:Oa,Closed:La};function so({request:i}){let e=new Ie,s=`<p>${[`Request ID: ${i.Title}`,`Submitted On: ${i.Dates.Submitted.toString()}`,"Requestor Info:",`${i.RequestorInfo.Requestor()?.Title}`,`${i.RequestorInfo.Phone()}`,`${i.RequestorInfo.Email()}`,`${i.RequestorInfo.OfficeSymbol.toString()}`].join("<br>")}</p>`,o=i.RequestBodyBlob?.Value()?.toHTML(),a=Pa`
    <p>
      ${ko.unwrap(i.RequestDescription.displayName)}:<br />
      ${i.RequestDescription.Value()}
    </p>
  `,r=F();return r?.Email&&e.CCString.Value(r.Email+";"),e.Body.Value([s,o,a].join("<br>")),e}async function oo(i,e){let t=[e.RequestorInfo.Requestor(),F()],s=[];e.Assignments.list.All().filter(a=>a.PipelineStage?.ID==e.Pipeline.Stage()?.ID).map(a=>{a.Assignee?.LoginName&&t.push(a.Assignee),s.push(a.RequestOrg)});let o=Ie.Create({To:await dt(t),CC:await dt(s),Request:e,Title:ct(e,"New Comment"),Body:`${F().Title} has left a new comment on ${e.getAppLinkElement()}:<br/><br/>`});await tt(o,e.getRelativeFolderPath())}function ao(i,e){window.DEBUG&&(console.log("Sending Notification: ",e),console.log("for request: ",i)),io[e.activity]&&io[e.activity](i,e)}async function Na(i){window.DEBUG&&console.log("Sending Request Created Notification for: ",i);let e=j(),t=[...new Set(i.Pipeline.RequestOrgs()?.map(N=>N.Title))],s="";t.forEach(N=>{s+=`<li>${N}</li>`});let o=[i.RequestorInfo.Requestor(),F()],a=await dt(o),r=Ie.Create({To:a,Title:ct(i,"New"),Body:`<p>Your ${i.RequestType.Title} request has been successfully submitted.</p><p>${i.getAppLinkElement()}</p><p>Estimated days to close this request type: `+i.RequestType.DaysToCloseBusiness+"</p><p>This request will be serviced by:</br><ul>"+s+"</ul></p><p>To view the request, please click the link above, or copy and paste the below URL into your browser:</br>"+i.getAppLink(),Request:i});await tt(r,i.getRelativeFolderPath());let p=i.Pipeline.RequestOrgs()?.map(N=>ae.FindInStore(N)),b=await dt(p),x=Ie.Create({To:b,Title:ct(i,"New"),Body:"<p>Greetings Colleagues,<br><br> A new service request has been opened requiring your attention:<br>"+i.getAppLinkElement()+"</p><p>Estimated days to close this request type: "+i.RequestType.DaysToCloseBusiness+"</p><p>This request will be serviced by:</br><ul>"+s+"</ul></p><p>To view the request, please click the link above, or copy and paste the below URL into your browser:</br>"+i.getAppLink(),Request:i});await tt(x,i.getRelativeFolderPath())}function Ea(i){window.DEBUG&&console.log("Sending Request Advanced Notification for: ",i)}async function Oa(i,e){window.DEBUG&&console.log("Sending Request Assigned Notification for: ",i),window.DEBUG&&console.log(e);let t=e.data?.Role?.LookupValue,s="";switch(t){case Me.Subscriber:case Me.Viewer:s="<p>This notification was generated for information purposes only. You have no pending actions on this request.</p>";break;default:}let o=Ie.Create({Title:ct(i,"Assigned"),Body:`<p>Greetings Colleagues,<br><br>You have been assigned the role of       <strong>${t}</strong> on the following       request:<br>`+i.getAppLinkElement()+"</p>"+s+"<p>To view the request, please click the link above,       or copy and paste the below URL into your browser: <br> "+i.getAppLink()+"</p>",Request:i}),a=new W(e.data?.Assignee),r=ae.FindInStore(e.data?.RequestOrg);if(a?.ID!=r?.UserGroup.ID){let b=await no(a);o.ToString.Value(b);let x=await si(r);o.CCString.Value(x)}else{let b=await si(r);o.ToString.Value(b)}await j().Notifications.AddEntity(o,i.getRelativeFolderPath())}async function La(i,e){window.DEBUG&&console.log("Sending Request Closed Notification for: ",i);let t=await dt([i.RequestorInfo.Requestor()]),s=Ie.Create({To:t,Title:ct(i,"Closed "+i.State.Status()),Body:`<p>Greetings Colleagues,<br><br>The following request has been ${i.State.Status()}:<br>`+i.getAppLinkElement()+"</p><p>This request cannot be re-opened.</p>",Request:i});await tt(s,i.getRelativeFolderPath())}async function tt(i,e,t=null){let s=j(),o=se(ie.newNotification);return await s.Notifications.AddEntity(i,e),t&&await Promise.all(t.map(async a=>{let r=se(ie.copyAttachment(a.FileLeafRef));await s.Notifications.CopyAttachmentFromPath(a.FileRef,i),Z(r)})),Z(o),!0}async function dt(i){return(await Promise.all(i.map(async t=>t.OrgType?si(t):no(t)))).filter(t=>t).join("; ")}async function si(i){if(i.PreferredEmail)return i.PreferredEmail;if(i.UserGroup){let e=i.FieldMap.UserGroup.get();return ro(e.Title)}}async function no(i){if(!(!i.IsEnsured&&(i=await _s(i),!i)))return i.IsGroup?ro(i.Title):i.Email}async function ro(i){return(await kt(i)).filter(t=>t.Email).map(t=>t.Email).join(";")}function ct(i,e){return`${to} -${e}- ${i.RequestType.Title} - ${i.Title}`}var Q=String.raw;function re(i){ko.components.register(i.edit,{template:i.editTemplate,viewModel:i}),ko.components.register(i.view,{template:i.viewTemplate,viewModel:i})}var ee=class{constructor(e){Object.assign(this,e)}_id;getUniqueId=()=>(this._id||(this._id="field-"+Math.floor(Math.random()*1e4)),this._id);Errors=ko.pureComputed(()=>this.ShowErrors()?this.isRequired?this.Value()?[]:[new ValidationError("text-field","required-field",this.displayName+" is required!")]:[]:[]);ShowErrors=ko.observable(!1);ValidationClass=ko.pureComputed(()=>{if(this.ShowErrors())return this.Errors().length?"is-invalid":"is-valid"});static viewTemplate=Q`
    <div class="fw-semibold" data-bind="text: displayName"></div>
    <div data-bind="text: toString()"></div>
  `;static editTemplate=Q`<div>Uh oh!</div>`};var Va=Q`
  <h5>
...
`,Ma=Q`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,ut=class extends ee{constructor(e){super(e)}static viewTemplate=Ma;static editTemplate=Va;static view="blob-view";static edit="blob-edit";static new="blob-edit"};re(ut);var Ba=Q`
...
`,pt=class extends ee{constructor(e){super(e)}static viewTemplate=_a;static editTemplate=Ba;static view="checkbox-view";static edit="checkbox-edit";static new="checkbox-edit"};re(pt);var Ua=Q`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,mt=class extends ee{constructor(e){super(e)}static editTemplate=Ua;static view="date-view";static edit="date-edit";static new="date-edit"};re(mt);var Ga=Q`
  <label class="fw-semibold"
    ><span data-bind="text: displayName"></span
    ><span data-bind="if: isRequired" class="fw-bold text-danger">*</span>:
    <!-- ko if: isSearch -->
  ...
  <!-- /ko -->
  <!-- /ko -->
`,ht=class extends ee{constructor(e){super(e)}static editTemplate=Ga;static view="lookup-view";static edit="lookup-edit";static new="lookup-edit"};re(ht);var $a=Q`
...
`,ja=Q`
  ...
  <!-- /ko -->
`,ft=class extends ee{constructor(e){super(e)}ValueFunc=ko.pureComputed({read:()=>this.Value()?ko.unwrap(this.userOpts).find(t=>t.ID==this.Value().ID):void 0,write:e=>{ko.unwrap(this.userOpts)&&this.Value(e)}});ShowUserSelect=ko.pureComputed(()=>this.spGroupName?ko.unwrap(this.userOpts).length:!1);static viewTemplate=ja;static editTemplate=$a;static view="people-view";static edit="people-edit";static new="people-edit"};re(ft);var Ha=Q`
  <label class="fw-semibold"
    ><span data-bind="text: displayName"></span
    ><span data-bind="if: isRequired" class="fw-bold text-danger">*</span>:
  </label>
...
`,oi=class extends ee{constructor(e){super(e),this.Options=e.Options,this.Value=e.Value,this.optionsText=e.optionsText??(t=>t),this.multiple=e.multiple,this.OptionsCaption=e.OptionsCaption??"Select..."}GetSelectedOptions=ko.pureComputed(()=>this.multiple?this.Value():this.Value()?[this.Value()]:[]);InputGroupFocused=ko.observable();setFocus=()=>this.InputGroupFocused(!0);FilterText=ko.observable();FilteredOptions=ko.pureComputed(()=>this.Options().filter(e=>this.GetSelectedOptions().indexOf(e)>=0?!1:this.FilterText()?this.optionsText(e).toLowerCase().includes(this.FilterText().toLowerCase()):!0));addSelection=(e,t)=>{console.log("selected",e),t.target.nextElementSibling&&t.target.nextElementSibling.focus(),this.multiple?this.Value.push(e):this.Value(e)};removeSelection=e=>this.multiple?this.Value.remove(e):this.Value(null);setInputGroupFocus=()=>{this.InputGroupFocused(!0),clearTimeout(this.focusOutTimeout)};removeInputGroupFocus=(e,t)=>{this.focusOutTimeout=window.setTimeout(()=>{this.InputGroupFocused(!1)},0)};static editTemplate=Ha;static view="search-select-view";static edit="search-select-edit";static new="search-select-new"};re(oi);var Qa=Q`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,gt=class extends ee{constructor(e){super(e)}static editTemplate=Qa;static view="select-view";static edit="select-edit";static new="select-edit"};re(gt);var Wa=Q`
...
`;var vo={..._e,edit:"svc-fiscal-irreg-edit",new:"svc-fiscal-irreg-edit"},Ji=class extends Ae{constructor(e){super(e)}static name=vo.edit;static template=yo};J(Ji);var Ki=class extends y{constructor(e){super(e)}CaseNumber=new d({displayName:"Case Number",isRequired:!1});PostLocation=new d({displayName:"Post Location",isRequired:!0});PointOfContact=new k({displayName:"Point(s) of Contact",isRequired:!0,multiple:!0});CableMRN=new d({displayName:"Cable MRN",isRequired:!1});CableDate=new D({displayName:"Cable Date",type:M.date,isRequired:!1});USDValue=new d({displayName:"US Dollar Value",isRequired:!0,attr:{type:"number",min:"0"}});FIType=new h({displayName:"Type of Irregularity",options:["Shortage","Overage"],isRequired:!0});ShowShortageDocs=ko.pureComputed(()=>this.USDValue.Value()&&this.FIType.Value()=="Shortage");FieldMap={...this.FieldMap,CaseNumber:this.CaseNumber,PostLocation:this.PostLocation,PointOfContact:this.PointOfContact,CableMRN:this.CableMRN,CableDate:this.CableDate,USDValue:this.USDValue,FIType:this.FIType};components=vo;static uid="fp_fiscal_irreg"};var Cp=R`
  <div>
...
`;var en=R`
  ...
  <!-- /ko -->
`,$t=class extends Qe{constructor(e){super(e),this.request=e.request,this.requestBody=e.request.RequestBodyBlob.Value()}createProcurement=async()=>{let e="<ul>";Object.values(this.requestBody.FieldMap).forEach(p=>{p&&(e+=`<li>${p.displayName}: ${p.toString()}</li>`)}),e+="</ul>";let t=me().find(p=>p.UID=="procurement"),s=oe.CreateByServiceType({ServiceType:t});s.FieldMap.RequestDescription.set(e),s.FieldMap.RequestingOffice.set(this.request.FieldMap.RequestingOffice.get()),s.FieldMap.Requestor.set(this.request.FieldMap.Requestor.get()),s.FieldMap.RequestorEmail(this.request.FieldMap.RequestorEmail()),s.FieldMap.RequestorPhone(this.request.FieldMap.RequestorPhone()),s.FieldMap.RequestorOfficeSymbol.set(this.request.FieldMap.RequestorOfficeSymbol.get());let o=this.request.getRelativeFolderPath(),a=await s.Attachments.createFolder(),r=j();try{await r.Attachments.CopyFolderContents(o,a),s.Attachments.refresh()}catch(p){console.error("Error copying files: ",p)}window.WorkOrder.App.NewRequest({request:s})};static name="create-procurement";static template=en};J($t);var Xi=class i extends y{constructor(e){super(e)}CostThreshold=ko.pureComputed(()=>parseInt(this.FieldMap.Cost.Value())>500);FieldMap={...this.FieldMap,Name:new d({displayName:"Software Name",isRequired:!0}),Quantity:new d({displayName:"Quantity",isRequired:!0}),POCName:new d({displayName:"POC",isRequired:!0}),Cost:new d({displayName:"Cost (USD)",isRequired:!0}),RequestType:new h({displayName:"Request Type",options:["New","Maintenance Renewal"],isRequired:!0}),PurchaseFrequency:new h({displayName:"Purchase Frequency",options:["One Time","Recurring"],isRequired:this.CostThreshold}),ApprovedPurchase:new h({displayName:"Approved Purchase",options:["Yes","No"],isRequired:this.CostThreshold}),FundingSource:new h({displayName:"Funding Source",options:["Project","Contract","Other"],isRequired:this.CostThreshold})};static Views={All:["ID","Title","Request"]};static ListDef={name:"st_it_software",title:"st_it_software",fields:i.Views.All};static uid="it_software"};var wo=R`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
...
`;var At=class extends V{constructor({activeRequestSet:e,filteredRequests:t=null,key:s="office"}){super(),this.key=s,this.ActiveSet=e,this.filter=this.ActiveSet.filter,this.FilteredRequests=t??this.ActiveSet.List,this.IsLoading=this.ActiveSet.IsLoading,this.HasLoaded=this.ActiveSet.HasLoaded,this.init()}hasInitialized=!1;requestDateBackground=e=>{if(new Date>e.Dates.EstClosed.Value())return"table-danger"};getTableElementId=()=>"tbl-requests-status-"+this.key+this.filter?.toLowerCase();refresh=async()=>{await this.ActiveSet.load()};tableBodyComplete=e=>{this.Table&&this.Table.clear().destroy(),this.Table=ze(this.getTableElementId())};init=async()=>{await this.ActiveSet.init(),this.hasInitialized=!0};dispose=()=>{}},ps=class extends At{constructor(e){super(e)}static name="open-requests-table";static template=No},ms=class extends At{constructor(e){super(e)}static name="open-office-requests-table";static template=Po},hs=class extends At{constructor(e){super(e)}static name="closed-requests-table";static template=Do};var Eo=R`
  <select
    class="form-select"
...
optionsText: 'Title'"
  ...
  ></div>
  <!-- /ko -->
`;var fs=class extends V{constructor(e){super(),this.key=e.key}ServiceTypes=ko.pureComputed(()=>me().filter(e=>e.userCanInitiate(F())));SelectedService=ko.observable();static name="requests-by-service-type";static template=Eo};var Oo=R`
...
`;var Ht=class extends V{constructor(e){super(),Object.assign(this,e)}AvailableRequestorOffices=ko.pureComputed(()=>F()?.RequestingOffices());AvailableServiceTypes=ko.pureComputed(()=>me().filter(e=>e.userCanInitiate(F())))},ys=class extends Ht{constructor(e){super(e)}static name="request-header-view";static template=Mo},vs=class extends Ht{constructor(e){super(e)}static name="request-header-edit";static template=Vo};var Bo=R`
...
`;var As=class extends V{constructor({ShowActionOfficeFeatures:e,ToggleActionOfficeFeatures:t}){super(),this.ShowActionOfficeFeatures=e,this.ToggleActionOfficeFeatures=t}ShowActionOfficeToggle=ko.pureComputed(()=>F()?.IsActionOffice()&&!1);MyOpenAssignments=ke.MyActiveAssignments;LateRequests=ko.pureComputed(()=>le.get(I.open)?.List()?.filter(e=>e.Dates.EstClosed.Value()<=new Date)??[]);toggleInfoContainer=(e,t)=>{t.target.closest(".status-info").classList.toggle("active")};static name="quick-info";static template=_o};var Uo=R`
...
`;var Rs=class extends V{constructor(e){Object.assign(this,e)}FormatMessage=ko.pureComputed(()=>`${this.msg}... ${this.Status()}`);static name="task-toast";static template=Go};var $o=R`
  <button
