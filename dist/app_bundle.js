(()=>{var pa=Object.defineProperty;var Ri=(s,e)=>{for(var t in e)pa(s,t,{get:e[t],enumerable:!0})};var ma=String.raw,Ti=ma`
<div>
  <style>
    .search-group {
      display: none;
...
`;var Ut={};Ri(Ut,{ApprovalActions:()=>$e,AssignModule:()=>Xt,BaseComponent:()=>M,ClosedRequestsTableModule:()=>ui,ConstrainedEntityEditModule:()=>Re,ConstrainedEntityViewModule:()=>Ce,MyAssignmentsModule:()=>hi,NewAssignmentModule:()=>wi,OpenOfficeRequestsTableModule:()=>ci,OpenRequestsTableModule:()=>di,PendingRequestIngestsModule:()=>ri,PipelineModule:()=>bi,QuickInfoModule:()=>vi,RequestHeaderEditModule:()=>gi,RequestHeaderViewModule:()=>fi,RequestsByServiceTypeModule:()=>pi,RequestsByServiceTypeTableModule:()=>mi,ResolverModule:()=>Yt,TaskToastModule:()=>Si,html:()=>T});var xe=class{constructor(e,t,i){this.source=e,this.type=t,this.description=i}};var X=class s{constructor({Id:e,ID:t,Title:i,LoginName:o=null,IsGroup:a=null,IsEnsured:d=!1}){this.ID=t??e,this.Title=i,this.LookupValue=i,this.LoginName=o!=""?o:null,this.IsGroup=a,this.IsEnsured=d}ID=null;Title=null;LoginName=null;LookupValue=null;getKey=()=>this.LoginName??this.Title;static Create=function(e){return!e||!e.ID&&!(e.Title||e.LookupValue)?null:new s({...e,Title:e.Title??e.LookupValue})}};var Wt={ActionOffice:"Action Office",RequestingOffice:"Requesting Office",Department:"Department",Budget:"Budget PMO"},ee=class s{constructor({ID:e,Title:t}){this.ID=e,this.Title=t,this.LookupValue=t}UserGroup;Everyone;FieldMap={UserGroup:{get:()=>this.UserGroup,set:e=>this.UserGroup=X.Create(e)}};static Create=function(e){return e?.ID?ne().find(t=>t.ID==e.ID):null};static FindInStore=function(e){return e?.ID?ne().find(t=>t.ID==e.ID):null};static Views={All:["ID","Title","UserGroup","ContactInfo","OrgType","BreakAccess","PreferredEmail","Everyone"]};static ListDef={name:"ConfigRequestOrgs",title:"ConfigRequestOrgs",fields:s.Views.All}},ne=ko.observableArray([]);var Ge=class{constructor(e){e?.ID&&(this.ID=e.ID),e?.Title&&(this.Title=e.Title)}ObservableID=ko.observable();ObservableTitle=ko.observable();get ID(){return this.ObservableID()}set ID(e){this.ObservableID(e)}get Title(){return this.ObservableTitle()}set Title(e){this.ObservableTitle(e)}};var O={InProgress:"In Progress",Completed:"Completed",Approved:"Approved",Rejected:"Rejected",Cancelled:"Cancelled"},Ve={ActionResolver:"Action Resolver",Approver:"Approver",Assigner:"Assigner",Viewer:"Viewer",Subscriber:"Subscriber"},fa={"Action Resolver":"resolver-actions",Approver:"approver-actions",Assigner:"assigner-actions"},St={source:"current-stage-active-assignments",type:"current-stage",description:"Please complete all assignments"},ce=class s extends Ge{constructor({ID:e,Title:t,Assignee:i,RequestOrg:o,PipelineStage:a,IsActive:d=!0,Role:m,CustomComponent:b=null}){super({ID:e,Title:t}),this.Assignee=i,this.RequestOrg=o,this.PipelineStage=a,this.IsActive=d,this.Role=m,this.CustomComponent=b}Role;Errors=ko.observableArray();getComponentName=()=>this.CustomComponent??fa[this.Role];getComponent=({request:e})=>({request:e,assignment:this,addAssignment:e.Assignments.addNew,completeAssignment:e.Assignments.complete,errors:this.Errors,actionComponentName:this.getComponentName()});userIsDirectlyAssigned=e=>this.Assignee?.ID==e.ID||e.isInGroup(this.Assignee);userIsInRequestOrg=e=>e.isInRequestOrg(this.RequestOrg);isActionable=()=>[Ve.ActionResolver,Ve.Approver,Ve.Assigner].includes(this.Role);isUserActionable=e=>(e||(e=window.WorkOrder.App.CurrentUser()),this.isActionable()?this.userIsDirectlyAssigned(e)||this.userIsInRequestOrg(e):!1);isExpanded=ko.observable(!0);toggleExpanded=()=>this.isExpanded(!this.isExpanded());static CreateFromObject=function(e){e.RequestOrg=ee.FindInStore(e.RequestOrg);let t=new s;return Object.assign(t,e),t};static Views={All:["ID","Title","Assignee","Role","Status","RequestOrg","IsActive","Comment","CompletionDate","ActionTaker","PipelineStage","CustomComponent","Request"],Dashboard:["Role","Assignee","Status","Request"]};static ListDef={name:"Assignments",title:"Assignments",fields:s.Views.All}};window.console=window.console||{log:function(){}};var N=window.sal||{};N.globalConfig=N.globalConfig||{};N.site=N.site||{};window.DEBUG=!0;function ki(s){return{ID:s.get_id(),Title:s.get_title(),LoginName:s.get_loginName(),IsEnsured:!0,IsGroup:!0,oGroup:s}}function Kt(){let s=N.globalConfig.defaultGroups,e={};return Object.keys(s).forEach(t=>{e[t]=ki(s[t])}),e}var zt={};async function qi(s){if(zt[s]?.Users?.constructor==Array)return zt[s].Users;let e=`/web/sitegroups/GetByName('${s}')?$expand=Users`,i=(await ue(e)).d;return i.Users=i.Users?.results,zt[s]=i,i.Users}var Ii=_spPageContextInfo.webAbsoluteUrl=="/"?"":_spPageContextInfo.webAbsoluteUrl;async function Fi(){N.globalConfig.siteGroups=[],console.log("we are initing sal"),N.globalConfig.siteUrl=_spPageContextInfo.webServerRelativeUrl=="/"?"":_spPageContextInfo.webServerRelativeUrl,N.globalConfig.listServices=N.globalConfig.siteUrl+"/_vti_bin/ListData.svc/";var s=SP.ClientContext.get_current(),e=s.get_web();N.globalConfig.defaultGroups={owners:e.get_associatedOwnerGroup(),members:e.get_associatedMemberGroup(),visitors:e.get_associatedVisitorGroup()},s.load(N.globalConfig.defaultGroups.owners),s.load(N.globalConfig.defaultGroups.members),s.load(N.globalConfig.defaultGroups.visitors);var t=e.get_currentUser();s.load(t);var i=e.get_siteGroups();s.load(i),N.globalConfig.roles=[];var o=s.get_web().get_roleDefinitions();return s.load(o),new Promise((a,d)=>{s.executeQueryAsync(function(){N.globalConfig.currentUser=t,N.globalConfig.siteGroups=ga(i);for(var m=o.getEnumerator();m.moveNext();){var b=m.get_current();N.globalConfig.roles.push(b.get_name())}N.config=new N.NewAppConfig,N.utilities=new N.NewUtilities,a()},function(m,b){alert("Error initializing SAL: "+b.get_message()),console.error("Error initializing SAL: "+b.get_message(),b),d()})})}N.NewAppConfig=function(){var s={};s.roles={FullControl:"Full Control",Design:"Design",Edit:"Edit",Contribute:"Contribute",RestrictedContribute:"Restricted Contribute",InitialCreate:"Initial Create",Read:"Read",RestrictedRead:"Restricted Read",LimitedAccess:"Limited Access"},s.fulfillsRole=function(i,o){let a=Object.values(s.roles);return!a.includes(i)||!a.includes(o)?!1:a.indexOf(i)<=a.indexOf(o)},s.validate=function(){Object.keys(s.roles).forEach(function(i){var o=s.roles[i];N.globalConfig.roles.includes(o)?console.log(o):console.error(o+" is not in the global roles list")})};var e={groups:{Owners:"workorder Owners",Members:"workorder Members",Visitors:"workorder Visitors",RestrictedReaders:"Restricted Readers"}},t={siteRoles:s,siteGroups:e};return t};async function Di(s=_spPageContextInfo.userId){let e="/sp.userprofiles.peoplemanager/getmyproperties",t=`/Web/GetUserById(${s})/?$expand=Groups`,i=(await ue(t)).d,o=(await ue(e))?.d.UserProfileProperties.results;function a(d,m){return d.find(b=>b.Key==m)?.Value}return{ID:s,Title:i.Title,LoginName:i.LoginName,WorkPhone:a(o,"WorkPhone"),EMail:a(o,"WorkEmail"),IsEnsured:!0,IsGroup:!1,Groups:i.Groups?.results?.map(d=>({...d,ID:d.Id,IsGroup:!0,IsEnsured:!0})),Department:a(o,"Department")}}N.NewUtilities=function(){function s(d,m,b){b=b===void 0?null:b;var x=new SP.ClientContext.get_current,L=x.get_web(),_=new SP.GroupCreationInformation;_.set_title(d),this.oGroup=oWebsite.get_siteGroups().add(_),oGroup.set_owner(oWebsite.get_associatedOwnerGroup()),oGroup.update();var z=SP.RoleDefinitionBindingCollection.newObject(clientContext);this.oRoleDefinitions=[],m.forEach(function(U){var ae=oWebsite.get_roleDefinitions().getByName(U);this.oRoleDefinitions.push(ae),z.add(ae)});var be=oWebsite.get_roleAssignments();be.add(oGroup,z);function K(){var U=oGroup.get_title()+" created and assigned to "+oRoleDefinitions.forEach(function(ae){ae+""});b&&b(oGroup.get_id()),console.log(U)}function oe(U,ae){alert(groupnName+" - Create group failed. "+ae.get_message()+`
`+ae.get_stackTrace())}clientContext.load(oGroup,"Title");var fe={groupName:d,oGroup,oRoleDefinition,callback:b};clientContext.executeQueryAsync(Function.createDelegate(fe,K),Function.createDelegate(fe,oe))}function e(d,m){var b=new SP.ClientContext.get_current,x=b.get_web(),L=x.ensureUser(d),_=L.get_groups();function z(){for(var K=new Array,oe=new String,fe=_.getEnumerator();fe.moveNext();){var U=fe.get_current(),ae={};ae.ID=U.get_id(),ae.Title=U.get_title(),oe+=`
Group ID: `+U.get_id()+", Title : "+U.get_title(),K.push(ae)}console.log(oe.toString()),m(K)}function be(K,oe){console.error(" Everyone - Query Everyone group failed. "+oe.get_message()+`
`+oe.get_stackTrace())}b.load(L),b.load(_),data={everyone:L,oGroups:_,callback:m},b.executeQueryAsync(Function.createDelegate(data,z),Function.createDelegate(data,be))}function t(d,m){var b=new SP.ClientContext.get_current,x=d.get_users();function L(){for(var be=[],K=x.getEnumerator();K.moveNext();){var oe={},fe=K.get_current();oe.title=fe.get_title(),oe.loginName=fe.get_loginName(),be.push(oe)}m(be)}function _(be,K){}var z={oUsers:x,callback:m};b.load(x),b.executeQueryAsync(Function.createDelegate(z,L),Function.createDelegate(z,_))}function i(d,m,b,x){var L=new SP.ClientContext.get_current,_=L.get_web(),z=_.getFolderByServerRelativeUrl(d);L.load(z,"Files"),L.executeQueryAsync(function(){console.log("Got the source folder right here!");for(var be=z.get_files(),K=be.getEnumerator(),oe=[];K.moveNext();){var fe=K.get_current(),U=m+"/"+fe.get_name();oe.push(U),fe.copyTo(U,!0)}console.log(oe),L.executeQueryAsync(function(){console.log("Files moved successfully!"),b()},function(ae,et){console.log("error: ")+et.get_message()})},function(be,K){console.log("Sorry, something messed up: "+K.get_message())})}function o(d,m){return new Promise((b,x)=>{i(d,m,b,x)})}var a={copyFiles:i,copyFilesAsync:o,createSiteGroup:s,getUserGroups:e,getUsersWithGroup:t};return a};async function tt(s){return new Promise((e,t)=>{var i=N.globalConfig.siteGroups.find(function(x){return x.LoginName==s});if(i){e(i);return}var o=new SP.ClientContext.get_current,a=o.get_web().ensureUser(s);function d(x,L){let _={ID:a.get_id(),Title:a.get_title(),LoginName:a.get_loginName(),IsEnsured:!0,IsGroup:!1};e(_)}function m(x,L){console.error("Failed to ensure user :"+L.get_message()+`
`+L.get_stackTrace()),t(L)}let b={oUser:a,resolve:e,reject:t};o.load(a),o.executeQueryAsync(Function.createDelegate(b,d),Function.createDelegate(b,m))})}function ga(s){for(var e=new Array,t=s.getEnumerator();t.moveNext();){var i=t.get_current();e.push(ki(i))}return e}N.getSPSiteGroupByName=function(s){var e=null;return this.globalConfig.siteGroups!=null&&(e=this.globalConfig.siteGroups.find(function(t){return t.Title==s})),e};function Pi(s){var e=this;e.config={def:s};async function t(){if(!e.config.fieldSchema){let r=`/web/lists/GetByTitle('${e.config.def.title}')/Fields`,n=await ue(r);e.config.fieldSchema=n.d.results}}t();function i(r,n){return new Promise((c,u)=>{o(r,c,n)})}function o(r,n,c){c=c===void 0?!1:c;var u=new Array,f=new Array,C=new SP.ClientContext.get_current,g=C.get_web(),p=g.get_lists().getByTitle(e.config.def.title);r.forEach(function(A){var R=N.getSPSiteGroupByName(A[0]);R?f.push([R,A[1]]):u.push([C.get_web().ensureUser(A[0]),A[1]])});function k(){console.log("Successfully found item");var A=new SP.ClientContext.get_current,R=A.get_web();c?(p.resetRoleInheritance(),p.breakRoleInheritance(!1,!1),p.get_roleAssignments().getByPrincipal(N.globalConfig.currentUser).deleteObject()):p.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(G){var j=SP.RoleDefinitionBindingCollection.newObject(A);j.add(R.get_roleDefinitions().getByName(G[1])),p.get_roleAssignments().add(G[0],j)}),this.users.forEach(function(G){var j=SP.RoleDefinitionBindingCollection.newObject(A);j.add(R.get_roleDefinitions().getByName(G[1])),p.get_roleAssignments().add(G[0],j)});var S={oList:p,callback:n};function D(){console.log("Successfully set permissions"),n(p)}function E(G,j){console.error("Failed to update permissions on List: "+this.oList.get_title()+j.get_message()+`
`,j.get_stackTrace())}A.load(p),A.executeQueryAsync(Function.createDelegate(S,D),Function.createDelegate(S,E))}function v(A,R){console.error("Failed to find List: "+this.oList.get_title+R.get_message(),R.get_stackTrace())}var w={oList:p,users:u,resolvedGroups:f,callback:n};C.load(p),u.map(function(A){C.load(A[0])}),C.executeQueryAsync(Function.createDelegate(w,k),Function.createDelegate(w,v))}function a(r){return r&&(Array.isArray(r)?r.map(n=>d(n)).join(";#"):d(r))}function d(r){return r.ID?`${r.ID};#${r.LookupValue??""}`:r.LookupValue?r.LookupValue:r.constructor.getName()=="Date"?r.toISOString():r}function m(r,n=null){return new Promise((c,u)=>{let f=new SP.ClientContext.get_current,g=f.get_web().get_lists().getByTitle(e.config.def.title),p=new SP.ListItemCreationInformation;if(n){var k=N.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+n;p.set_folderUrl(k)}let v=g.addItem(p),w=["ID","Author","Created","Editor","Modified"];Object.keys(r).filter(D=>!w.includes(D)).forEach(D=>{v.set_item(D,a(r[D]))}),v.update();function A(){c(v.get_id())}function R(D,E){console.error("Create Item Failed - List: "+e.config.def.name),console.error("ValuePairs",r),console.error(D,E),u(D)}let S={entity:r,oListItem:v,resolve:c,reject:u};f.load(v),f.executeQueryAsync(Function.createDelegate(S,A),Function.createDelegate(S,R))})}function b(r){if(!r)return r;let n={};switch(r.constructor.getName()){case"SP.FieldUserValue":n.LoginName=r.get_email();case"SP.FieldLookupValue":n.ID=r.get_lookupId(),n.LookupValue=r.get_lookupValue(),n.Title=r.get_lookupValue();break;default:n=r}return n}function x(r,n,c){var u=new SP.CamlQuery.createAllItemsQuery;u.set_viewXml(r);var f=new SP.ClientContext.get_current,C=f.get_web(),g=C.get_lists().getByTitle(e.config.def.title),p=g.getItems(u);function k(){var A=this,R=A.collListItem.getEnumerator();let S=[];for(;R.moveNext();){var D=R.get_current(),E={};n.forEach(G=>{var j=D.get_item(G);E[G]=Array.isArray(j)?j.map(ge=>b(ge)):b(j)}),S.push(E)}c(S)}function v(A,R){console.log("unsuccessful read",A),alert("Request on list "+e.config.def.name+` failed, producing the following error: 
 `+R.get_message()+`
StackTrack: 
 `+R.get_stackTrace())}var w={collListItem:p,callback:c,fields:n,camlQuery:u};f.load(p,`Include(${n.join(", ")})`),f.executeQueryAsync(Function.createDelegate(w,k),Function.createDelegate(w,v))}function L({fields:r=null,caml:n=null}){if(!n)var n='<View Scope="RecursiveAll"><Query><Where><Eq><FieldRef Name="FSObjType"/><Value Type="int">0</Value></Eq></Where></Query></View>';return new Promise((c,u)=>{x(n,r,c)})}function _(r,n){return new Promise((c,u)=>{try{U(r,n,c)}catch(f){u(f)}})}async function z(r,n){let[c,u]=await K(n),f=`/web/lists/GetByTitle('${e.config.def.title}')/items(${r})?$Select=${c}&$expand=${u}`;return(await ue(f)).d}async function be(){if(!e.config.fieldSchema){let r=`/web/lists/GetByTitle('${e.config.def.title}')/Fields`,n=await ue(r);e.config.fieldSchema=n.d.results}return e.config.fieldSchema}async function K(r){let n=[],c=[],u=await be();return r.map(f=>{if(f.includes("/")){n.push(f),c.push(f.split("/")[0]);return}let C=u.find(g=>g.StaticName==f);if(!C){alert(`Field '${f}' not found on list ${e.config.def.name}`);return}switch(C.TypeAsString){case"UserMulti":case"User":case"LookupMulti":case"Lookup":let g=f+"/ID",p=f+"/Title";n.push(g),n.push(p),c.push(f);break;case"Choice":default:n.push(f)}}),[n,c]}async function oe(r,{orderByColumn:n=null,sortAsc:c},{count:u=null},f,C){let[g,p]=await K(f),k=n?`$orderby=${n} ${c?"asc":"desc"}`:"",v=[];r.forEach(j=>v.push(`${j.column} ${j.op??"eq"} '${j.value}'`)),C||v.push("FSObjType eq '0'");let w="$filter=("+v.join(") and (")+")",A="$select="+g,R="$expand="+p,S=u?`$top=${u}`:"",D=`/web/lists/GetByTitle('${e.config.def.title}')/items?${A}&${R}&${k}&${w}&${S}`,E=await ue(D);return{results:E?.d?.results,_next:E?.d?.__next}}async function fe(r){let n=await ue(r._next);return{results:n?.d?.results,_next:n?.d?.__next}}function U(r,n,c){var u=new SP.ClientContext.get_current,f=u.get_web(),C=f.get_lists().getByTitle(e.config.def.title),g=C.getItemById(r);function p(){let w={};n.forEach(A=>{var R=g.get_item(A);w[A]=Array.isArray(R)?R.map(S=>b(S)):b(R)}),c(w)}function k(w,A){console.error("SAL: findById - List: "+e.config.def.name),console.error("Fields",this),console.error(w,A)}var v={oListItem:g,callback:c,fields:n};u.load(g),u.executeQueryAsync(Function.createDelegate(v,p),Function.createDelegate(v,k))}function ae(r){return r?.ID?new Promise((n,c)=>{let u=new SP.ClientContext.get_current,g=u.get_web().get_lists().getByTitle(e.config.def.title).getItemById(r.ID),p=["ID","Author","Created","Editor","Modified"];Object.keys(r).filter(A=>!p.includes(A)).forEach(A=>{g.set_item(A,a(r[A]))}),g.update();function k(){console.log("Successfully updated "+this.oListItem.get_item("Title")),n()}function v(A,R){console.error("Update Failed - List: "+e.config.def.name),console.error("Item Id",this.oListItem.get_id()??"N/A"),console.error(r),console.error(A,R),c(R)}let w={oListItem:g,entity:r,resolve:n,reject:c};u.load(g),u.executeQueryAsync(Function.createDelegate(w,k),Function.createDelegate(w,v))}):!1}function et(r,n){var c=new SP.ClientContext.get_current,u=c.get_web(),f=u.get_lists().getByTitle(e.config.def.title),C={callback:n};f.getItemById(r).deleteObject();function p(v,w){n()}function k(v,w){console.error("sal.SPList.deleteListItem: Request on list "+e.config.def.name+` failed, producing the following error: 
 `+w.get_message()+`
StackTrack: 
 `+w.get_stackTrace())}c.executeQueryAsync(Function.createDelegate(C,p),Function.createDelegate(C,k))}function Ht(r){return new Promise((n,c)=>et(r,n))}function Bo(r,n,c){return new Promise((u,f)=>{Uo(r,n,u,c)})}function Uo(r,n,c,u){u=u===void 0?!1:u;let f=[],C=[],g=new SP.ClientContext.get_current,v=g.get_web().get_lists().getByTitle(e.config.def.title).getItemById(r);n.forEach(function(S){let D=N.getSPSiteGroupByName(S[0]);D?.oGroup?C.push([D.oGroup,S[1]]):f.push([g.get_web().ensureUser(S[0]),S[1]])});function w(){console.log("Successfully found item");let S=new SP.ClientContext.get_current,D=S.get_web();u?(v.resetRoleInheritance(),v.breakRoleInheritance(!1,!1),v.get_roleAssignments().getByPrincipal(N.globalConfig.currentUser).deleteObject()):v.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(ge){let re=SP.RoleDefinitionBindingCollection.newObject(S);re.add(D.get_roleDefinitions().getByName(ge[1])),v.get_roleAssignments().add(ge[0],re)}),this.users.forEach(function(ge){let re=SP.RoleDefinitionBindingCollection.newObject(S);re.add(D.get_roleDefinitions().getByName(ge[1])),v.get_roleAssignments().add(ge[0],re)});var E={oListItem:v,callback:c};function G(){console.log("Successfully set permissions"),c(v)}function j(ge,re){console.error("Failed to update permissions on item: "+this.oListItem.get_lookupValue()+re.get_message()+`
...
`+D.get_stackTrace(),!1)}var R={id:r,oListItem:v,users:f,resolvedGroups:C,callback:c};g.load(v),f.map(function(S){g.load(S[0])}),g.executeQueryAsync(Function.createDelegate(R,w),Function.createDelegate(R,A))}function Go(r){return new Promise((n,c)=>{var u=new SP.ClientContext.get_current,f=u.get_web(),C=f.get_lists().getByTitle(e.config.def.title),g=C.getItemById(r),p=g.get_roleAssignments();function k(){for(var A=new SP.ClientContext.get_current,R=A.get_web(),S=[],D=this.roles.getEnumerator();D.moveNext();){var E=D.get_current(),G=E.get_member();A.load(G),S.push(G)}A.executeQueryAsync(function(j,ge){var re=S.map(function(Te){return{ID:Te.get_id(),Title:Te.get_title(),LoginName:Te.get_loginName()}});n(re)},function(j,ge){alert("Request failed. "+ge.get_message()+`
`+ge.get_stackTrace()),c(ge)})}function v(A,R){console.error("Failed to get permissions on item: "+R.get_message()+`
`+R.get_stackTrace(),!1),c(R)}let w={id:r,oListItem:g,roles:p,resolve:n,reject:c};u.load(g),u.load(p),u.executeQueryAsync(Function.createDelegate(w,k),Function.createDelegate(w,v))})}function Le(r){let n=e.config.def.isLib?"/"+e.config.def.name+"/":"/Lists/"+e.config.def.name+"/";return N.globalConfig.siteUrl+n+r}function $o(r){return e.config.def.isLib?new Promise((n,c)=>Xo(r,n)):new Promise((n,c)=>Jo(r,n))}async function jo(r){try{let c=(await Wo(r)).map(u=>[u.LoginName,N.config.siteRoles.roles.RestrictedRead]);await Qt(r,c,!0)}catch(n){console.warn(n)}}async function Ho(r,n){let c=Le(r),u=N.globalConfig.siteUrl+`/_api/web/GetFolderByServerRelativeUrl('${c}')/ListItemAllFields/RoleAssignments?$expand=Member,Member/Users,RoleDefinitionBindings`,f=await fetch(u,{method:"GET",headers:{Accept:"application/json; odata=verbose"}});if(!f.ok){if(f.status==404)return;console.error(f)}let C=await f.json(),g=C?.d?.results;if(!g){console.warn("No results found",C);return}let p=n.filter(k=>{let v=k[0],w=k[1];return!g.find(R=>R.Member.LoginName!=v&&!R.Member.Users?.results.find(S=>S.LoginName==v)?!1:!!R.RoleDefinitionBindings.results?.find(S=>N.config.siteRoles.fulfillsRole(S.Name,w)))});console.log("Adding missing permissions",p),p.length&&await Qt(r,p,!1)}function Qo(r,n){return new Promise((c,u)=>{let f=new SP.ClientContext.get_current,g=f.get_web().get_lists().getByTitle(e.config.def.title),p=Le(r),k=SP.CamlQuery.createAllItemsQuery();k.set_folderServerRelativeUrl(p);let v=g.getItems(k);f.load(v,`Include(${n.join(", ")})`),f.executeQueryAsync(function(){let w=[];for(var A=v.getEnumerator();A.moveNext();){var R=A.get_current(),S={};n.forEach(D=>{var E=R.get_item(D);S[D]=Array.isArray(E)?E.map(G=>b(G)):b(E)}),S.oListItem=R,w.push(S)}c(w)},function(w,A){console.warn("Unable load list folder contents:"),console.error(w),console.error(A),u(A)})})}async function Wo(r){return new Promise(async(n,c)=>{let u=await zo(r);if(!u){c("Folder item does not exist");return}let f=u.get_roleAssignments(),C=new SP.ClientContext.get_current;C.load(u),C.load(f),C.executeQueryAsync(function(){let g=new SP.ClientContext.get_current;console.log(u);let p=[],k=[],v=f.getEnumerator();for(;v.moveNext();){let w=v.get_current(),A=w.get_member(),R=w.get_roleDefinitionBindings();g.load(R),g.load(A),p.push({principal:A,bindings:R})}g.executeQueryAsync(function(w,A){let R=p.map(function({principal:S,bindings:D}){let E=[],G=D.getEnumerator();for(;G.moveNext();){let j=G.get_current();E.push(j.get_name())}return{ID:S.get_id(),Title:S.get_title(),LoginName:S.get_loginName(),Roles:E}});n(R)},function(w,A){console.warn("Unable load folder principals permissions:"),console.error(w),console.error(A),c(A)})},function(g,p){console.warn("Unable load folder permissions:"),console.error(g),console.error(p),c(p)})})}async function zo(r){return new Promise((n,c)=>{let u=new SP.ClientContext.get_current,C=u.get_web().get_lists().getByTitle(e.config.def.title),g=SP.CamlQuery.createAllItemsQuery();var k='<View Scope="RecursiveAll"><Query><Where><And><Eq><FieldRef Name="FSObjType"/><Value Type="int">1</Value></Eq><Eq><FieldRef Name="FileRef"/><Value Type="Text">'+Le(r)+"</Value></Eq></And></Where></Query><RowLimit>1</RowLimit></View>";g.set_viewXml(k);let v=C.getItems(g);async function w(){let S=[];for(var D=v.getEnumerator();D.moveNext();){let G=D.get_current();S.push(G)}S||(console.warn("folder not found"),n(S)),S.length>1&&(console.warn("Multiple folders found!"),n(S));let E=S[0];n(E)}function A(S,D){console.warn("Unable load list folder contents:"),console.error(S),console.error(D),c(D)}let R={allFolders:v,resolve:n,reject:c};u.load(v),u.executeQueryAsync(Function.createDelegate(R,w),Function.createDelegate(R,A))})}function Jo(r,n){var c=r.split("/"),u=0,f=function(C,g,p,k){var v=g[p];p++;var w=g.slice(0,p).join("/");Ko(w,function(A){p>=g.length?k(A.get_id()):f(w,g,p,k)},function(){e.createListFolder(v,function(A){p>=g.length?k(A):f(w,g,p,k)},C)})};f("",c,u,n)}e.createListFolder=function(r,n,c){c=c===void 0?"":c;let u=new SP.ClientContext.get_current,C=u.get_web().get_lists().getByTitle(e.config.def.title),g="",p=new SP.ListItemCreationInformation;p.set_underlyingObjectType(SP.FileSystemObjectType.folder),p.set_leafName(r),c&&(g=N.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+c,p.set_folderUrl(g));let k=C.addItem(p);k.set_item("Title",r),k.update();function v(R,S){n(this.newItem.get_id())}function w(R,S){alert("Request on list "+e.config.def.name+` failed, producing the following error: 
`+S.get_message()+`
StackTrack: 
`+S.get_stackTrace())}let A={folderName:r,callback:n,newItem:k};u.load(k),u.executeQueryAsync(Function.createDelegate(A,v),Function.createDelegate(A,w))};function Ko(r,n,c){var u=N.globalConfig.siteUrl+"/Lists/"+e.config.def.name+"/"+r,f=SP.ClientContext.get_current(),C=f.get_web().getFolderByServerRelativeUrl(u);C.get_listItemAllFields();var g={folder:C,path:r,onExists:n,onNonExists:c};f.load(C,"Exists","Name");function p(){if(C.get_exists()){let A=function(){n(w)},R=function(S,D){console.error("Failed to find folder at "+r,D)};console.log("Folder "+C.get_name()+" exists in "+e.config.def.name);var v=new SP.ClientContext.get_current,w=C.get_listItemAllFields();g={folderItem:w,path:r,onExists:n},v.load(w),v.executeQueryAsync(Function.createDelegate(g,A),Function.createDelegate(g,R))}else console.warn("Folder exists but is hidden (security-trimmed) for us.")}function k(v,w){w.get_errorTypeName()==="System.IO.FileNotFoundException"?(console.log("SAL.SPList.ensureListFolder:           Folder "+r+" does not exist in "+e.config.def.name),c()):console.error("Error: "+w.get_message())}f.executeQueryAsync(Function.createDelegate(g,p),Function.createDelegate(g,k))}function Xo(r,n){let f=new SP.ClientContext.get_current().get_web().get_lists().getByTitle(e.config.def.title);var C=function(g,p,k){var v=g.get_context(),w=p.split("/"),A=w[0],R=g.get_folders().add(A);v.load(R),v.executeQueryAsync(function(){if(w.length>1){var S=w.slice(1,w.length).join("/");C(R,S,k)}else k(R)},function(S,D){console.error("error creating new folder"),console.error(S),console.error(error)})};C(f.get_rootFolder(),r,n)}function Qt(r,n,c){return new Promise((u,f)=>{Yo(r,n,u,c)})}function Yo(r,n,c,u){u=u===void 0?!1:u;var f=[],C=[];let g=Le(r),p=new SP.ClientContext.get_current,v=p.get_web().getFolderByServerRelativeUrl(g);n.forEach(function(S){var D=N.getSPSiteGroupByName(S[0]);D?.oGroup?C.push([D.oGroup,S[1]]):f.push([p.get_web().ensureUser(S[0]),S[1]])});function w(){var S=new SP.ClientContext.get_current,D=S.get_web(),E=this.folder.get_listItemAllFields();u?(E.resetRoleInheritance(),E.breakRoleInheritance(!1,!1),E.get_roleAssignments().getByPrincipal(N.globalConfig.currentUser).deleteObject()):E.breakRoleInheritance(!1,!1),this.resolvedGroups.forEach(function(re){var Te=SP.RoleDefinitionBindingCollection.newObject(S);Te.add(D.get_roleDefinitions().getByName(re[1])),E.get_roleAssignments().add(re[0],Te)}),this.users.forEach(function(re){var Te=SP.RoleDefinitionBindingCollection.newObject(S);Te.add(D.get_roleDefinitions().getByName(re[1])),E.get_roleAssignments().add(re[0],Te)});var G={folderItem:E,callback:c};function j(){console.log("Successfully set permissions"),this.callback(E)}function ge(re,Te){console.error("Failed to update permissions on item: "+Te.get_message(),Te)}S.load(E),S.executeQueryAsync(Function.createDelegate(G,j),Function.createDelegate(G,ge))}function A(S,D){console.error("Something went wrong setting perms on library folder",D)}var R={folder:v,users:f,callback:c,resolvedGroups:C,valuePairs:n,reset:u};f.map(function(S){p.load(S[0])}),p.load(v),p.executeQueryAsync(Function.createDelegate(R,w),Function.createDelegate(R,A))}function Zo(r){let c=`/web/GetFolderByServerRelativeUrl('${Le(r)}')`;return ue(c,"POST",{"If-Match":"*","X-HTTP-Method":"DELETE"})}function ea(r,n,c,u){var f="";c.id&&(f=c.id);let C=SP.UI.$create_DialogOptions();var g=e.config.def.isLib?"/"+e.config.def.name+"/":"/Lists/"+e.config.def.name+"/",p="";c.rootFolder&&(p=N.globalConfig.siteUrl+g+c.rootFolder);var k=e.config.def.isLib?"/"+e.config.def.name+"/Forms/":"/Lists/"+e.config.def.name+"/";Object.assign(C,{title:n,dialogReturnValueCallback:u,args:JSON.stringify(c),url:N.globalConfig.siteUrl+k+r+"?ID="+f+"&Source="+location.pathname+"&RootFolder="+p}),SP.UI.ModalDialog.showModalDialog(C)}function ta(r,n,c){return new Promise((u,f)=>{let C=new SP.ClientContext.get_current,p=C.get_web().get_lists().getByTitle(e.config.def.title);C.load(p),C.executeQueryAsync(function(){var k=N.globalConfig.siteUrl=="/"?"":N.globalConfig.siteUrl;let v=SP.UI.$create_DialogOptions();Object.assign(v,{title:n,dialogReturnValueCallback:u,args:JSON.stringify(c),url:k+"/_layouts/Upload.aspx?List="+p.get_id().toString()+"&RootFolder="+k+"/"+e.config.def.name+"/"+encodeURI(r)+"&Source="+location.pathname+"&args="+encodeURI(JSON.stringify(c))}),SP.UI.ModalDialog.showModalDialog(v)},function(k,v){console.error("Error showing file modal: "),console.error(k),console.error(v)})})}let Ci=10485760,Xa={start:"startupload",continue:"continueupload",finish:"finishupload"};async function sa(r,n,c,u){let f=r,C=Ci,g=r.size,p=parseInt((g/C).toString(),10)+(g%C===0?1:0),k=n+"/"+c,v=ba(),w;u({currentBlock:0,totalBlocks:p}),w=await ia(v,r.slice(0,C),k,n);for(let R=2;R<p;R++)u({currentBlock:R,totalBlocks:p}),w=await oa(v,r.slice(w,w+C),w,k);u({currentBlock:p-1,totalBlocks:p});let A=await aa(v,r.slice(w),w,k);return u({currentBlock:p,totalBlocks:p}),A}async function ia(r,n,c,u){let f=`/web/getFolderByServerRelativeUrl(@folder)/files/getByUrlOrAddStub(@file)/StartUpload(guid'${r}')?&@folder='${u}'&@file='${c}'`,p=await ue(f,"POST",{"Content-Type":"application/octet-stream"},{body:n});if(!p){console.error("Error starting upload!");return}return parseFloat(p.d.StartUpload)}async function oa(r,n,c,u){let f=`/web/getFileByServerRelativeUrl(@file)/ContinueUpload(uploadId=guid'${r}',fileOffset=${c})?&@file='${u}'`,p=await ue(f,"POST",{"Content-Type":"application/octet-stream"},{body:n});if(!p){console.error("Error starting upload!");return}return parseFloat(p.d.ContinueUpload)}async function aa(r,n,c,u){let f=`/web/getFileByServerRelativeUrl(@file)/FinishUpload(uploadId=guid'${r}',fileOffset=${c})?&@file='${u}'`,p=await ue(f,"POST",{"Content-Type":"application/octet-stream"},{body:n});if(!p){console.error("Error starting upload!");return}return p}async function ra(r,n,c){return await fetch(_spPageContextInfo.webServerRelativeUrl+`/_api/web/GetFolderByServerRelativeUrl('${n}')/Files/add(url='${c}',overwrite=true)`,{method:"POST",credentials:"same-origin",body:r,headers:{Accept:"application/json; odata=verbose","Content-Type":"application/json;odata=nometadata","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value}}).then(u=>{if(!u.ok){console.error("Error Uploading File",u);return}return u.json()})}async function na(r,n,c,u,f=null){f||(f=()=>{});let C=Le(c),g=null;if(r.size>Ci){let v=()=>sa(r,C,n,f);g=await ya.addJob(v)}else f({currentBlock:0,totalBlocks:1}),g=await ra(r,C,n),f({currentBlock:1,totalBlocks:1});await la(g.d,u),await ua(C+"/"+n,"");let p=g.d.ListItemAllFields.__deferred.uri+"?$select=ID";return(await ue(p)).d.ID}async function la(r,n){var c=await fetch(r.ListItemAllFields.__deferred.uri,{method:"POST",credentials:"same-origin",body:JSON.stringify(n),headers:{Accept:"application/json; odata=nometadata","Content-Type":"application/json;odata=nometadata","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value,"X-HTTP-Method":"MERGE","If-Match":"*"}}).then(u=>{if(!u.ok){console.error("Error Updating File",u);return}return u});return c}function da(r,n,c,u){let f=Le(r),C=Le(n);var g=new SP.ClientContext.get_current,p=g.get_web(),k=p.getFolderByServerRelativeUrl(f);g.load(k,"Files"),g.executeQueryAsync(function(){for(var v=k.get_files(),w=v.getEnumerator(),A=[];w.moveNext();){var R=w.get_current(),S=C+"/"+R.get_name();A.push(S),R.copyTo(S,!0)}console.log(A),g.executeQueryAsync(function(){console.log("Files moved successfully!"),c()},function(D,E){console.log("error: ")+E.get_message()})},function(v,w){console.error("Unable to copy files: ",w.get_message()),console.error(v),console.error(w),reject(w)})}function ca(r,n){return new Promise((c,u)=>{da(r,n,c,u)})}async function Ya(){let r=await ue(`/web/lists/GetByTitle('${e.config.def.title}')`)}function ua(r,n){let c=`/web/GetFileByServerRelativeUrl('${r}')/CheckIn(comment='${n}',checkintype=0)`;return ue(c,"POST")}return{findByIdAsync:_,getById:z,findByColumnValueAsync:oe,loadNextPage:fe,getListItemsAsync:L,createListItemAsync:m,updateListItemAsync:ae,deleteListItemAsync:Ht,setItemPermissionsAsync:Bo,getItemPermissionsAsync:Go,getFolderContentsAsync:Qo,upsertFolderPathAsync:$o,deleteFolderByPathAsync:Zo,getServerRelativeFolderPath:Le,setFolderReadonlyAsync:jo,setFolderPermissionsAsync:Qt,ensureFolderPermissionsAsync:Ho,uploadFileToFolderAndUpdateMetadata:na,uploadNewDocumentAsync:ta,copyFilesAsync:ca,showModal:ea}}async function ue(s,e="GET",t={},i={}){let o=s.startsWith("http")?s:N.globalConfig.siteUrl+"/_api"+s,a=await fetch(o,{method:e,headers:{Accept:"application/json; odata=verbose","X-RequestDigest":document.getElementById("__REQUESTDIGEST").value,...t},...i});if(!a.ok){if(a.status==404)return;console.error(a)}try{return await a.json()}catch{return}}window.spFetch=ue;function ba(){if(crypto.randomUUID)return crypto.randomUUID();let s=Date.now();return"xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx".replace(/[xy]/g,function(e){let t=(s+Math.random()*16)%16|0;return s=Math.floor(s/16),(e==="x"?t:t&3|8).toString(16)})}var Jt=class{constructor(e){this.maxConcurrency=e,this.runningJobs=0,this.queue=[]}addJob(e){return new Promise((t,i)=>{let o=async()=>{try{let a=await e();t(a)}catch(a){i(a)}finally{this.runningJobs--,this.processQueue()}};this.queue.push(o),this.processQueue()})}processQueue(){for(;this.runningJobs<this.maxConcurrency&&this.queue.length>0;){let e=this.queue.shift();this.runningJobs++,e()}}},ya=new Jt(5);var Y={FullControl:"Full Control",Design:"Design",Edit:"Edit",Contribute:"Contribute",Read:"Read",LimitedAccess:"Limited Access",RestrictedRead:"Restricted Read",RestrictedContribute:"Restricted Contribute",InitialCreate:"Initial Create"},va={RestrictedReaders:new X({ID:null,Title:"Restricted Readers"})},Qe={Admin:"Admin",ActionOffice:"ActionOffice"},Ae={ActionResolver:{LookupValue:"Action Resolver",description:"Confirms completion of an action.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Assigner:{LookupValue:"Assigner",description:"Can create additional assignments.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Approver:{LookupValue:"Approver",description:"Approves or Rejects the request.",isAssignable:!0,permissions:Y.RestrictedContribute,initialStatus:O.InProgress},Viewer:{LookupValue:"Viewer",description:"Has view only access to the request.",isAssignable:!0,permissions:Y.RestrictedRead},Subscriber:{LookupValue:"Subscriber",description:"Has view only access to the request and recieves notifications",isAssignable:!0,permissions:Y.RestrictedRead}},Ct={"Pending Assignment":Ae.Assigner,"Pending Approval":Ae.Approver,"Pending Action":Ae.ActionResolver,"Pending Resolution":Ae.ActionResolver,Notification:Ae.Subscriber},I=ko.observable(),At=class s extends X{constructor({ID:e,Title:t,LoginName:i=null,LookupValue:o=null,WorkPhone:a=null,EMail:d=null,IsGroup:m=null,IsEnsured:b=!1,Groups:x=null,Department:L=null}){super({ID:e,Title:t,LookupValue:o,LoginName:i,IsGroup:m,IsEnsured:b}),this.WorkPhone=a,this.EMail=d,this.OfficeSymbol=L??"CGFS/EX",this.Groups=x}OfficeSymbol;Groups=[];isInGroup(e){return e?.ID?this.getGroupIds().includes(e.ID):!1}getGroupIds(){return this.Groups.map(e=>e.ID)}isInRequestOrg=e=>this.RequestOrgs().find(t=>t.ID==e.ID);RequestOrgs=ko.pureComputed(()=>{let e=this.getGroupIds();return ne().filter(t=>t.Everyone||e.includes(t.UserGroup?.ID))});RequestingOffices=ko.pureComputed(()=>this.RequestOrgs().filter(e=>e.OrgType==Wt.RequestingOffice));ActionOffices=ko.pureComputed(()=>this.RequestOrgs().filter(e=>e.OrgType==Wt.ActionOffice));IsActionOffice=ko.pureComputed(()=>this.ActionOffices().length);IsSiteOwner=ko.pureComputed(()=>this.isInGroup(Kt().owners));hasSystemRole=e=>{let t=this.IsSiteOwner();switch(e){case Qe.Admin:return t;case Qe.ActionOffice:return t||this.ActionOffices().length;default:}};static Create=async function(){let e=await Di();return new s(e)}};function Oi(s){let e=Kt(),t=s.RequestorInfo.Requestor(),i=s.RequestorInfo.Office(),o=[[new X(e.owners),Y.FullControl],[va.RestrictedReaders,Y.RestrictedRead]];return o.push([t,Y.RestrictedContribute]),i&&!i.BreakAccess&&o.push([i.UserGroup,Y.RestrictedContribute]),s.Pipeline.Stages()?.forEach(a=>{let d=ee.FindInStore(a.RequestOrg);if(d&&o.push([d.UserGroup,Y.RestrictedContribute]),a.AssignmentFunction&&We[a.AssignmentFunction])try{We[a.AssignmentFunction](s,a).forEach(b=>{let x=b.Assignee;x&&x.Title&&o.push([x,Y.RestrictedContribute])})}catch{console.warn("Error creating stage assignments",a)}}),o}async function Ei(s){let e=await qi(s);return e?e.map(t=>new X(t)):[]}var We={TestFunc:function(){return request.RequestorInfo.Requestor()},ch_overtimeGovManager:function(s,e){let t=s.RequestBodyBlob?.Value()?.GovManager.get();if(!t)throw new Error("Could not find stage Assignee");return[new ce({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.ActionResolver,CustomComponent:"GovManagerActions"})]},ch_overtimeAPM:function(s,e){let t=s.RequestBodyBlob?.Value()?.FieldMap.APM.get();if(!t)throw new Error("Could not find stage Assignee");return[new ce({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.ActionResolver,CustomComponent:"APMActions"})]},getGTM:function(s,e){let t=s.RequestBodyBlob?.Value()?.FieldMap.GTM.get();if(!t)throw new Error("Could not find stage Assignee");return[new ce({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.Approver})]},getCOR:function(s,e){let t=s.RequestBodyBlob?.Value()?.FieldMap.COR.get();if(!t)throw new Error("Could not find stage Assignee");return[new ce({Assignee:t,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.Approver})]},getSupervisor:function(s,e){return[new ce({Assignee:Ni(s,"Supervisor"),RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.Approver})]},getWildcard:function(s,e,t){return[new ce({Assignee:Ni(s,t),RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ae.Approver,CustomComponent:e.ActionComponentName})]}};function Ni(s,e){let t=s.RequestBodyBlob?.Value()?.FieldMap[e]?.get();if(!t)throw new Error(`Could not find assignee field on current request: ${e}`);return t}var T=String.raw,M=class{constructor(){}static name="base-component";static template=T`<div>No Component Registered!</div>`};var Li=T`
...
`;var Rt=class extends M{constructor({Entity:e}){super(),Object.assign(this,e)}},Ce=class extends Rt{constructor(e){super(e)}static name=De.view;static template=Bi},Re=class extends Rt{constructor(e){super(e)}static name=De.edit;static template=_i};var ke={PendingAssignment:"Pending Assignment",PendingApproval:"Pending Approval",PendingAction:"Pending Action",PendingResolution:"Pending Resolution",Notification:"Notification",Closed:"Closed"},Ie=class s{constructor({ID:e,Title:t}){this.ID=e,this.Title=t,this.LookupValue=t}static Create=function({ID:e,LookupValue:t}){return new s({ID:e,Title:t})};static FindInStore=function(e){return!e||!e.ID?null:ze().find(t=>t.ID==e.ID)};static GetCompletedStage=function(){return ze().find(e=>e.ActionType==ke.Closed)};static Views={All:["ID","Title","ServiceType","Step","ActionType","ActionTargetStage","Assignee","WildCardAssignee","RequestOrg","AssignmentFunction","ActionComponentName"]};static ListDef={name:"ConfigPipelines",title:"ConfigPipelines",fields:s.Views.All}},ze=ko.observableArray();var B={Paused:"Paused",Resumed:"Resumed",Assigned:"Assigned",Unassigned:"Unassigned",Created:"Created",Advanced:"Advanced",Approved:"Approved",Completed:"Completed",Rejected:"Rejected",Closed:"Closed"},Je=class{constructor(){}PipelineStage;FieldMap={PipelineStage:{get:()=>this.PipelineStage,set:e=>{this.PipelineStage=Ie.FindInStore(e)}}};static Views={All:["ID","Title","PipelineStage","ActionType","Description","Author","Created"]};static ListDef={name:"Actions",title:"Actions",fields:this.Views.All}};var Be=class{constructor(){}static Views={All:["ID","Title","IsActive","Request","FileLeafRef","FileRef","Author","Created"]};static ListDef={name:"Attachments",title:"Attachments",fields:this.Views.All,isLib:!0}};var Ke=class{constructor(){}static Views={All:["ID","Title","Comment","NotificationSent","Author","IsActive","Created"]};static ListDef={name:"Comments",title:"Comments",fields:this.Views.All}};var xt=ko.observable(),Tt=class s{static Views={All:["ID","Title","Date","Repeating"]};static ListDef={name:"ConfigHolidays",title:"ConfigHolidays",fields:s.Views.All}};var kt=class{constructor(){}static Views={All:["ID","Title","To","ToString","CC","CCString","BCC","Body","Sent","DateSent","Request","DateToSend"]};static ListDef={name:"Notifications",title:"Notifications",fields:this.Views.All}};var F={draft:"Draft",open:"Open",paused:"Paused",fulfilled:"Completed",cancelled:"Cancelled",rejected:"Rejected"},Ue={inProgress:"In Progress",waitingOnCustomer:"Waiting on Customer",researching:"Researching"};var Pe={MyRequests:"my-requests-tab",NewRequest:"new-request-tab",RequestDetail:"request-detail-tab"},st="/sites/CGFS/Style Library/apps/wo/src",Ui=_spPageContextInfo.webTitle;var ht={};Ri(ht,{Access:()=>es,AccessFletc:()=>is,BaseServiceDetail:()=>y,CH_Access:()=>ts,CH_Conference:()=>os,CH_Equip_Repair:()=>rs,CH_Furniture:()=>ns,CH_HR_Training:()=>ls,CH_Mobile:()=>ds,CH_Notice:()=>cs,CH_Overtime:()=>mt,CH_Reconfig:()=>us,CH_Supplies:()=>ps,CH_Telework:()=>ms,CH_Transport:()=>hs,CH_Voicemail:()=>fs,CashMgmtRequest:()=>bs,CashierOperationsRequest:()=>ys,CollectionsRequest:()=>ws,ContractorSupplement:()=>Ee,DVCSetup:()=>gs,DiplomaticPassportVisa:()=>Us,FPCodesRequest:()=>vs,FPTravelRequest:()=>Ss,FiscalIrregularities:()=>js,ITHardware:()=>As,ITSoftware:()=>Qs,Ironkey:()=>Cs,Locksmith:()=>Rs,Mobile:()=>Ts,MotorPool:()=>xs,Overtime:()=>ks,Presentation:()=>Is,PropertySpace:()=>Js,Requisition:()=>Fs,SDMAdminRequest:()=>Ps,Telework:()=>Os,TemplateRequest:()=>Zs,TierIRequest:()=>Ns,getApmOrg:()=>Nt,getCorOrg:()=>Es,getGtmOrg:()=>Ot});var te=class{constructor({displayName:e,instructions:t=null,isRequired:i=!1,width:o,Visible:a=ko.pureComputed(()=>!0)}){this.displayName=e,this.instructions=t,this.isRequired=i,this.Visible=a,this.width=o?"col-md-"+o:"col-md-6",this.addFieldRequirement(wa(this))}Value=ko.observable();get=()=>this.Value();set=e=>this.Value(e);toString=ko.pureComputed(()=>this.Value());toJSON=()=>this.Value();fromJSON=e=>this.Value(e);validate=(e=!0)=>(this.ShowErrors(e),this.Errors());_fieldValidationRequirements=ko.observableArray();Errors=ko.pureComputed(()=>this.Visible()?this._fieldValidationRequirements().filter(t=>t.requirement()).map(t=>t.error):[]);addFieldRequirement=e=>this._fieldValidationRequirements.push(e);IsValid=ko.pureComputed(()=>!this.Errors().length);ShowErrors=ko.observable(!1);ValidationClass=ko.pureComputed(()=>{if(this.ShowErrors())return this.Errors().length?"is-invalid":"is-valid"})};function wa(s){return{requirement:ko.pureComputed(()=>{if(!ko.unwrap(s.isRequired))return!1;let t=ko.unwrap(s.Value);return t?.constructor==Array?!t.length:t==null}),error:new xe("text-field","required-field",`${ko.utils.unwrapObservable(s.displayName)} is required!`)}}var H=String.raw;function se(s){ko.components.register(s.edit,{template:s.editTemplate,viewModel:s}),ko.components.register(s.view,{template:s.viewTemplate,viewModel:s})}var J=class{constructor(e){Object.assign(this,e)}_id;getUniqueId=()=>(this._id||(this._id="field-"+Math.floor(Math.random()*1e4)),this._id);Errors=ko.pureComputed(()=>this.ShowErrors()?this.isRequired?this.Value()?[]:[new ValidationError("text-field","required-field",this.displayName+" is required!")]:[]:[]);ShowErrors=ko.observable(!1);ValidationClass=ko.pureComputed(()=>{if(this.ShowErrors())return this.Errors().length?"is-invalid":"is-valid"});static viewTemplate=H`
...
`,Aa=H`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,it=class extends J{constructor(e){super(e)}static viewTemplate=Aa;static editTemplate=Sa;static view="blob-view";static edit="blob-edit";static new="blob-edit"};se(it);var Ca=H`
...
`,ot=class extends J{constructor(e){super(e)}static viewTemplate=Ra;static editTemplate=Ca;static view="checkbox-view";static edit="checkbox-edit";static new="checkbox-edit"};se(ot);var Ta=H`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,at=class extends J{constructor(e){super(e)}static editTemplate=Ta;static view="date-view";static edit="date-edit";static new="date-edit"};se(at);var xa=H`
  <label class="fw-semibold"
    ><span data-bind="text: displayName"></span
    ><span data-bind="if: isRequired" class="fw-bold text-danger">*</span>:
    <!-- ko if: isSearch -->
  ...
  <!-- /ko -->
  <!-- /ko -->
`,rt=class extends J{constructor(e){super(e)}static editTemplate=xa;static view="lookup-view";static edit="lookup-edit";static new="lookup-edit"};se(rt);var ka=H`
...
`,qa=H`
  ...
  <!-- /ko -->
`,nt=class extends J{constructor(e){super(e)}ValueFunc=ko.pureComputed({read:()=>this.Value()?ko.unwrap(this.userOpts).find(t=>t.ID==this.Value().ID):void 0,write:e=>{ko.unwrap(this.userOpts)&&this.Value(e)}});ShowUserSelect=ko.pureComputed(()=>this.spGroupName?ko.unwrap(this.userOpts).length:!1);static viewTemplate=qa;static editTemplate=ka;static view="people-view";static edit="people-edit";static new="people-edit"};se(nt);var Ia=H`
  <label class="fw-semibold"
    ><span data-bind="text: displayName"></span
    ><span data-bind="if: isRequired" class="fw-bold text-danger">*</span>:
  </label>
...
`,Zt=class extends J{constructor(e){super(e),this.Options=e.Options,this.Value=e.Value,this.optionsText=e.optionsText??(t=>t),this.multiple=e.multiple,this.OptionsCaption=e.OptionsCaption??"Select..."}GetSelectedOptions=ko.pureComputed(()=>this.multiple?this.Value():this.Value()?[this.Value()]:[]);InputGroupFocused=ko.observable();setFocus=()=>this.InputGroupFocused(!0);FilterText=ko.observable();FilteredOptions=ko.pureComputed(()=>this.Options().filter(e=>this.GetSelectedOptions().indexOf(e)>=0?!1:this.FilterText()?this.optionsText(e).toLowerCase().includes(this.FilterText().toLowerCase()):!0));addSelection=(e,t)=>{console.log("selected",e),t.target.nextElementSibling&&t.target.nextElementSibling.focus(),this.multiple?this.Value.push(e):this.Value(e)};removeSelection=e=>this.multiple?this.Value.remove(e):this.Value(null);setInputGroupFocus=()=>{this.InputGroupFocused(!0),clearTimeout(this.focusOutTimeout)};removeInputGroupFocus=(e,t)=>{this.focusOutTimeout=window.setTimeout(()=>{this.InputGroupFocused(!1)},0)};static editTemplate=Ia;static view="search-select-view";static edit="search-select-edit";static new="search-select-new"};se(Zt);var Fa=H`
  ...
  <!-- /ko -->
  <!-- /ko -->
`,lt=class extends J{constructor(e){super(e)}static editTemplate=Fa;static view="select-view";static edit="select-edit";static new="select-edit"};se(lt);var Da=H`
...
`,Pa=H`
  ...
  <div class="fst-italic">Not provided.</div>
  <!-- /ko -->
`,dt=class extends J{constructor(e){super(e)}childrenHaveLoaded=e=>{this.initializeEditor()};getToolbarId=()=>"toolbar-"+this.getUniqueId();initializeEditor(){let e=[["bold","italic","underline","strike"],["link"],["blockquote","code-block"],[{header:1},{header:2}],[{list:"ordered"},{list:"bullet"}],[{script:"sub"},{script:"super"}],[{indent:"-1"},{indent:"+1"}],[{direction:"rtl"}],[{size:["small",!1,"large","huge"]}],[{header:[1,2,3,4,5,6,!1]}],[{color:[]},{background:[]}],[{font:[]}],[{align:[]}],["clean"]];var t=new Quill("#"+this.getUniqueId(),{modules:{toolbar:e},theme:"snow"});let i=this.Value;i.subscribe(o=>{o==""&&t.setText("")}),t.on("text-change",function(o,a,d){i(t.root.textContent?t.root.innerHTML:"")})}static viewTemplate=Pa;static editTemplate=Da;static view="text-area-view";static edit="text-area-edit";static new="text-area-edit"};se(dt);var Na=H`
  <label class="fw-semibold"
    ><span data-bind="text: displayName"></span
    ><span data-bind="if: isRequired" class="fw-bold text-danger">*</span>:
    <input
...
`;var Pt=class extends $e{constructor(e){super(e),this._context=Q(),this.ServiceType=e.request.RequestBodyBlob?.Value(),this.Errors=e.errors,this.Request=e.request,this.apmWatcher(this.ServiceType?.APM.get()),this.gtmWatcher(this.ServiceType?.GTM.get());let t=this.validate(!1);this.assignment.Status!=O.InProgress&&this.Editing(!1)}Editing=ko.observable(!0);APM=new q({displayName:"APM",isRequired:!0,spGroupName:ko.pureComputed(()=>ko.unwrap(Nt)?.UserGroup?.Title)});GTM=new q({displayName:"GTM",isRequired:!1,spGroupName:ko.pureComputed(()=>ko.unwrap(Ot)?.UserGroup?.Title)});hasBeenValidated=ko.observable(!1);hasBeenSaved=ko.observable(!1);validate=(e=!0)=>{if(!this.ServiceType)return[];let t=[];return this.APM.validate(e).length&&t.push(new xe(Ji,"gov-manager-actions","Please provide a valid APM.")),this.Errors(this.Errors().filter(i=>i.source!=Ji).concat(t)),t};apmWatcher=e=>{this.APM.get()||this.APM.set(e)};gtmWatcher=e=>{this.GTM.get()||this.GTM.set(e)};submit=async()=>{this.hasBeenValidated(!0),!this.validate().length&&(console.log(this),this.ServiceType.APM.set(this.APM.get()),this.GTM.get()?this.ServiceType.GTM.set(this.GTM.get()):this.ServiceType.GTM.get()&&this.ServiceType.GTM.set(null),await this._context.Requests.UpdateEntity(this.Request,["RequestBodyBlob"]),this.assignment.Status!=O.Approved&&await this.completeAssignment(this.assignment,O.Approved),this.Editing(!1),this.hasBeenSaved(!0))};static name="GovManagerActions";static template=zi},Ji="gov-manager-actions";var Ms={view:"svc-ch_overtime-view",edit:"svc-ch_overtime-edit",new:"svc-ch_overtime-edit"};Z(Dt);Z(Pt);var Nt=ko.pureComputed(()=>ne().find(s=>s.Title.toUpperCase()=="CGFS/APMS")),Ot=ko.pureComputed(()=>ne().find(s=>s.Title.toUpperCase()=="CGFS/GTMS")),Es=ko.pureComputed(()=>ne().find(s=>s.Title.toUpperCase()=="CGFS/CORS")),Ls=class extends Ce{constructor(e){super(e)}static name=Ms.view;static template=Hi},Vs=class extends Re{constructor(e){super(e)}static name=Ms.edit;static template=Qi};Z(Vs);Z(Ls);var mt=class s extends y{constructor(e){super(e)}setRequestContext=async e=>{this.Request=e,await this.ContractorSupplement.findByRequest(this.Request)};RequestSubmitted=ko.pureComputed(()=>this.Request?.Pipeline?.Stage());RequestStage2=ko.pureComputed(()=>this.Request?.Pipeline?.Stage()?.Step==2);Contractor=new q({displayName:"Contractor",isRequired:!0});GovManager=new q({displayName:"Gov Manager",isRequired:!0});GTM=new q({displayName:"GTM",isRequired:this.RequestStage2,Visible:this.RequestSubmitted,spGroupName:ko.pureComputed(()=>ko.unwrap(Ot)?.UserGroup?.Title)});APM=new q({displayName:"APM",isRequired:this.RequestSubmitted,Visible:this.RequestSubmitted,spGroupName:ko.pureComputed(()=>ko.unwrap(Nt)?.UserGroup?.Title)});COR=new q({displayName:"COR",isRequired:this.RequestStage2,Visible:this.RequestSubmitted,spGroupName:ko.pureComputed(()=>ko.unwrap(Es)?.UserGroup?.Title)});ContractorSupplementField=new Me({displayName:"Contractor Supplement",Visible:ko.observable(!1),type:Ee,lookupCol:"LaborCategory",isRequired:!1,multiple:!1});ContractorSupplement={set:Oe.Set(Ee),findByRequest:async e=>{let i=(await this.ContractorSupplement.set.FindByColumnValue([{column:"Title",op:"eq",value:e.Title}],{},{},Ee.Views.All,!1))?.results?.pop();i&&this.ContractorSupplementField.Value(i)},update:async(e=null)=>{await this.ContractorSupplement.set.UpdateEntity(this.ContractorSupplementField.Value(),e)},VisibleOnForm:ko.pureComputed(()=>{}),create:async(e=this.ContractorSupplementField.Value())=>{let t=this.Request.getRelativeFolderPath(),i=this.ContractorSupplement.getPermissions(),o=await this.ContractorSupplement.set.UpsertFolderPath(t);await this.ContractorSupplement.set.SetFolderPermissions(t,i),e.Contractor.set(this.Contractor.get()),await this.ContractorSupplement.set.AddEntity(e,t,this.Request),this.ContractorSupplementField.Value(e)},getPermissions:()=>{let e=ne().find(a=>a.Title.toUpperCase()=="CGFS/EX/BUDGET")?.UserGroup,t=ne().find(a=>a.Title.toUpperCase()=="CGFS/EX")?.UserGroup,i=Es()?.UserGroup;return[[I(),Y.RestrictedContribute],[this.APM.get(),Y.RestrictedContribute],[this.GTM.get(),Y.RestrictedContribute],[this.COR.get(),Y.RestrictedContribute],[e,Y.RestrictedContribute],[t,Y.RestrictedContribute],[i,Y.RestrictedContribute]]}};supplementComponents=De;FieldMap={FullName:this.Contractor,GovManager:this.GovManager,GTM:this.GTM,APM:this.APM,COR:this.COR,DateStart:new P({displayName:"Start Date",type:V.date,isRequired:!0}),DateEnd:new P({displayName:"End Date (Within Month Range)",type:V.date,isRequired:!0}),Hours:new l({displayName:"Overtime Hours (Not to Exceed)",isRequired:!0,attr:{type:"number"}})};components=Ms;static Views={All:["ID","Title","FullName","GovManager","GTM","APM","COR","DateStart","DateEnd","Hours","ContractorSupplement","Request"],APMUpdate:["COR","GTM"]};static ListDef={name:"st_ch_overtime",title:"st_ch_overtime",isServiceType:!0,fields:s.Views.All};static uid="ch_overtime"};var Ki=T`
  <div>
...
`;var to={...De,edit:"svc-fiscal-irreg-edit",new:"svc-fiscal-irreg-edit"},$s=class extends Re{constructor(e){super(e)}static name=to.edit;static template=eo};Z($s);var js=class extends y{constructor(e){super(e)}CaseNumber=new l({displayName:"Case Number",isRequired:!1});PostLocation=new l({displayName:"Post Location",isRequired:!0});PointOfContact=new q({displayName:"Point(s) of Contact",isRequired:!0,multiple:!0});CableMRN=new l({displayName:"Cable MRN",isRequired:!1});CableDate=new P({displayName:"Cable Date",type:V.date,isRequired:!1});USDValue=new l({displayName:"US Dollar Value",isRequired:!0,attr:{type:"number",min:"0"}});FIType=new h({displayName:"Type of Irregularity",options:["Shortage","Overage"],isRequired:!0});ShowShortageDocs=ko.pureComputed(()=>this.USDValue.Value()&&this.FIType.Value()=="Shortage");FieldMap={...this.FieldMap,CaseNumber:this.CaseNumber,PostLocation:this.PostLocation,PointOfContact:this.PointOfContact,CableMRN:this.CableMRN,CableDate:this.CableDate,USDValue:this.USDValue,FIType:this.FIType};components=to;static uid="fp_fiscal_irreg"};var so=T`
  <div>
...
`;var io={...De,view:"svc-it_software-view"},Hs=class extends Ce{constructor(e){super(e)}static name=io.view;static template=so};Z(Hs);var Qs=class s extends y{constructor(e){super(e)}ShowCreateProcurementButton=ko.pureComputed(()=>{let e=ne().find(t=>t.Title=="CGFS/EX/IT");return e&&I()?.isInRequestOrg(e)});createProcurement=async()=>{let e="<ul>";Object.values(this.FieldMap).forEach(m=>{m&&(e+=`<li>${m.displayName}: ${m.toString()}</li>`)}),e+="</ul>";let t=pe().find(m=>m.UID=="procurement"),i=new le({ServiceType:t});i.FieldMap.RequestDescription.set(e),i.FieldMap.RequestingOffice.set(this.Request.FieldMap.RequestingOffice.get());let o=this.Request.getRelativeFolderPath(),a=await i.Attachments.createFolder(),d=Q();try{await d.Attachments.CopyFolderContents(o,a),i.Attachments.refresh()}catch(m){console.error("Error copying files: ",m)}window.WorkOrder.App.NewRequest({request:i})};CostThreshold=ko.pureComputed(()=>parseInt(this.FieldMap.Cost.Value())>500);FieldMap={...this.FieldMap,Name:new l({displayName:"Software Name",isRequired:!0}),Quantity:new l({displayName:"Quantity",isRequired:!0}),POCName:new l({displayName:"POC",isRequired:!0}),Cost:new l({displayName:"Cost (USD)",isRequired:!0}),RequestType:new h({displayName:"Request Type",options:["New","Maintenance Renewal"],isRequired:!0}),PurchaseFrequency:new h({displayName:"Purchase Frequency",options:["One Time","Recurring"],isRequired:this.CostThreshold}),ApprovedPurchase:new h({displayName:"Approved Purchase",options:["Yes","No"],isRequired:this.CostThreshold}),FundingSource:new h({displayName:"Funding Source",options:["Project","Contract","Other"],isRequired:this.CostThreshold})};components=io;static Views={All:["ID","Title","Request"]};static ListDef={name:"st_it_software",title:"st_it_software",fields:s.Views.All};static uid="it_software"};var oo=T`
  <div>
    <div class="row row-cols-2" data-bind="foreach: FormFields">
      <div
        class="col pb-2"
...
`;var ei={view:"svc-template-view",edit:"svc-template-edit",new:"svc-template-edit"},Dp=ko.pureComputed(()=>ne().find(s=>s.Title.toUpperCase()=="CGFS/APMS")),Xs=class extends Ce{constructor(e){super(e)}static name=ei.view;static template=ro},Ys=class extends Re{constructor(e){super(e)}static name=ei.edit;static template=no};Z(Ys);Z(Xs);var Zs=class s extends y{constructor(e){super(e)}FieldMap={...this.FieldMap,SamplePeople:new q({displayName:"Supervisor",isRequired:!1}),SampleMultiPeople:new q({displayName:"Multiple People",isRequired:!1,multiple:!0}),SampleGroupPeople:new q({displayName:"Group People",isRequired:!1}),SampleSelect:new h({displayName:" Type",options:["FTE","Contractor"],isRequired:!1}),SampleText:new l({displayName:"FullName",isRequired:!1}),SampleTextArea:new W({displayName:"NotificationDates",isRequired:!1}),SampleDate:new P({displayName:"ExpirationDate",type:V.date,isRequired:!1}),SampleCheckbox:new ve({displayName:"SpecialOrder"}),SampleLookup:new Me({displayName:"Request Org",type:ee,lookupCol:"Title",Options:ne,isRequired:!1,multiple:!1}),SampleMultiLookup:new Me({displayName:"Service Types",type:_e,lookupCol:"Title",Options:pe,isRequired:!1,multiple:!0})};components=ei;static Views={All:["ID","Title"]};static ListDef={name:"st_template",title:"st_template",fields:s.Views.All};static uid="template"};var Ea=s=>{let e=null;for(let t in ht)if(ht[t].uid==s){e=ht[t];break}return e};var pe=ko.observableArray(),_e=class s{constructor(e){this.ID=e.ID,this.Title=e.Title,this.LookupValue=e.Title,this.Loaded=!1,Object.assign(this,e)}getRepositoryListName=()=>`st_${this.UID}`;getListDef=()=>{if(!this.HasTemplate)return null;let e=this.getRepositoryListName();return{title:e,name:e}};_listRef=null;getListRef=()=>{if(!this.HasTemplate)return null;if(!this._initialized)throw new Error("Accessing constructor before initialization");return this._listRef||(this._listRef=Oe.Set(this._constructor)),this._listRef};_constructor=null;instantiateEntity=async e=>!this.HasTemplate||!this.UID?null:(this._initialized||await this.initializeEntity(),this._constructor?new this._constructor(e):null);_initialized=!1;initializeEntity=async()=>{if(this._initialized||!this.HasTemplate||!this.UID)return;if(this._constructor){console.warn("Service type was already initialized"),this._initialized=!0;return}let e=null;try{e=Ea(this.UID),e||console.error("Could not find service module",this),this._constructor=e}catch(t){console.error("Cannot import service type module",t,this)}finally{this._initialized=!0}};userCanInitiate=e=>this.Active?e.hasSystemRole(Qe.Admin)?!0:this.RequestingOrgs.length>0?this.RequestingOrgs.find(t=>e.isInRequestOrg(t))!==void 0:!0:!1;attachmentsRequiredCntString=()=>this.AttachmentsRequiredCnt?this.AttachmentsRequiredCnt<0?"multiple":this.AttachmentsRequiredCnt:"no";static FindInStore=function(e){return!e||!e.ID?null:pe().find(t=>t.ID==e.ID)};static Views={All:["ID","Title","Active","HasTemplate","DescriptionTitle","DescriptionRequired","DescriptionFieldInstructions","Description","Icon","AttachmentsRequiredCnt","AttachmentDescription","DaysToCloseBusiness","UID","ReportingOrgs","RequestingOrgs"]};static ListDef={name:"ConfigServiceTypes",title:"ConfigServiceTypes",fields:s.Views.All}};var Et=class s extends ye{constructor({ID:e,Title:t}){super(),this.ID=e,this.Title=t,this.LookupValue=t}From=new l({displayName:"From"});To=new l({displayName:"To"});CC=new l({displayName:"CC"});Title=new l({displayName:"Subject"});Body=new W({displayName:"Body",isRichText:!0});FieldMap={To:this.To,From:this.From,CC:this.CC,Title:this.Title,Body:this.Body};getStagedAttachmentsFolderPath=()=>"Staged/"+this.ID;static Views={All:["ID","Title","From","To","CC","Body"]};static ListDef={name:"RequestIngest",title:"RequestIngest",fields:s.Views.All}};var lo=!1,si=null;function po(){si||(si=new Oe)}function Q(){return si}var ti=new Map,Oe=class{constructor(){}Actions=new we(Je);Assignments=new we(ce);Attachments=new we(Be);Comments=new we(Ke);Notifications=new we(kt);Requests=new we(le);RequestIngests=new we(Et);ConfigHolidays=new we(Tt);ConfigRequestOrgs=new we(ee);ConfigPipelines=new we(Ie);ConfigServiceTypes=new we(_e);static Set=e=>{let t=e.name;if(!ti.has(t)){let i=new we(e);return ti.set(t,i),i}return ti.get(t)}},we=class{constructor(e){if(!e.ListDef){console.error("Missing entityType listdef for",e);return}this.entityType=e;try{let t=new Set;e.Views?.All?.map(o=>t.add(o));let i=new this.entityType({ID:null,Title:null});i.FieldMap&&Object.keys(i.FieldMap).map(o=>t.add(o)),this.AllDeclaredFields=[...t]}catch(t){console.warn("Could not instantiate",e),console.warn(t),this.AllDeclaredFields=e.Views?.All??[]}this.ListDef=e.ListDef,this.Views=e.Views,this.Title=e.ListDef.title,this.Name=e.ListDef.name,this.ListRef=new Pi(e.ListDef),this.entityConstructor=this.entityType.FindInStore||this.entityType.Create||this.entityType}FindById=async(e,t=this.AllDeclaredFields)=>{let i=await this.ListRef.findByIdAsync(e,t);if(!i)return null;let o=new this.entityType(i);return Fe(i,o),o};FindByColumnValue=async(e,{orderByColumn:t,sortAsc:i},{count:o=null},a=this.AllDeclaredFields,d=!1)=>{let m=o!=null;o=o??5e3;let b=await this.ListRef.findByColumnValueAsync(e,{orderByColumn:t,sortAsc:i},{count:o},a,d),x={_next:b._next,results:b.results.map(_=>{let z=new this.entityConstructor(_);return Fe(_,z),z})};if(m)return x;let L={results:x.results};for(;x._next;)x=await this.LoadNextPage(x),L.results.concat(x.results);return L};LoadNextPage=async e=>{let t=await this.ListRef.loadNextPage(e);return{_next:t._next,results:t.results.map(i=>{let o=new this.entityType(i);return Fe(i,o),o})}};ToList=async(e=this.Views.All)=>(await this.ListRef.getListItemsAsync({fields:e})).map(i=>{let o=new this.entityType(i);return Fe(i,o),o});LoadEntity=async function(e){if(!e.ID)return console.error("entity missing Id",e),!1;let t=await this.ListRef.findByIdAsync(e.ID,this.ListDef.fields);return t?(Fe(t,e),!0):(console.warn("ApplicationDbContext Could not find entity",e),!1)};AddEntity=async function(e,t,i=null){let a=uo.bind(this)(e);i&&(a.Title=i.Title,a.Request=i),lo&&console.log(a);let d=await this.ListRef.createListItemAsync(a,t);Fe({ID:d},e)};UpdateEntity=async function(e,t=null){let i=uo.bind(this)(e,t);return i.ID=typeof e.ID=="function"?e.ID():e.ID,lo&&console.log(i),this.ListRef.updateListItemAsync(i)};RemoveEntity=async function(e){return e.ID?(await this.ListRef.deleteListItemAsync(e.ID),!0):!1};SetItemPermissions=async function(e,t,i=!1){let o=t.filter(a=>a[0]&&a[1]).map(a=>[a[0].getKey(),a[1]]);return this.ListRef.setItemPermissionsAsync(e,o,i)};GetItemPermissions=function(e){return this.ListRef.getItemPermissionsAsync(e)};GetFolderUrl=function(e=""){return this.ListRef.getServerRelativeFolderPath(e)};GetItemsByFolderPath=async function(e,t=this.AllDeclaredFields){return(await this.ListRef.getFolderContentsAsync(e,t)).map(o=>{let a=new this.entityType(o);return Fe(o,a),a})};UpsertFolderPath=async function(e){return this.ListRef.upsertFolderPathAsync(e)};DeleteFolderByPath=function(e){return this.ListRef.deleteFolderByPathAsync(e)};SetFolderReadOnly=async function(e){return this.ListRef.setFolderReadonlyAsync(e)};SetFolderPermissions=async function(e,t,i=!0){let o=t.filter(a=>a[0]&&a[1]).map(a=>[a[0].getKey(),a[1]]);return this.ListRef.setFolderPermissionsAsync(e,o,i)};EnsureFolderPermissions=async function(e,t){let i=t.filter(o=>o[0]&&o[1]).map(o=>[o[0].LoginName??o[0].Title,o[1]]);return this.ListRef.ensureFolderPermissionsAsync(e,i)};UploadFileToFolderAndUpdateMetadata=async function(e,t,i,o,a){let d=await this.ListRef.uploadFileToFolderAndUpdateMetadata(e,t,i,o,a),m=await this.ListRef.getById(d,this.AllDeclaredFields),b=new this.entityConstructor(m);return Fe(m,b),b};UploadNewDocument=async function(e,t){return this.ListRef.uploadNewDocumentAsync(e,"Attach a New Document",t)};CopyFolderContents=async function(e,t){return this.ListRef.copyFilesAsync(e,t)};ShowForm=async function(e,t,i){return new Promise((o,a)=>this.ListRef.showModal(e,t,i,o))};EnsureList=async function(){}};function Fe(s,e){!s||!e||Object.keys(s).forEach(t=>{La(t,s[t],e)})}function La(s,e,t){if(t.FieldMap&&t.FieldMap[s]){Va(e,t.FieldMap[s]);return}if(t[s]&&typeof t[s]=="function"){t[s](e);return}t[s]=e}function Va(s,e){if(typeof e=="function"){e(s);return}if(typeof e!="object"){e=s;return}if(e.set&&typeof e.set=="function"){e.set(s);return}if(e.obs){if(!s){e.obs(null);return}let t=Array.isArray(s)?s.map(i=>co(i,e)):co(s,e);e.obs(t);return}e=s}function co(s,e){return e.factory?e.factory(s):s}function uo(s,e=null){let t={},i=new Set([]);this?.ListDef?.fields&&this.ListDef.fields.forEach(d=>i.add(d)),s.FieldMap&&Object.keys(s.FieldMap).forEach(d=>i.add(d));let o=[...i];return(e??(s.FieldMap?Object.keys(s.FieldMap):null)??Object.keys(s)).filter(d=>o.includes(d)).map(d=>{if(s.FieldMap&&s.FieldMap[d]){t[d]=Ma(s.FieldMap[d]);return}t[d]=s[d]}),t}function Ma(s){return typeof s=="function"?s():s.get&&typeof s.get=="function"?s.get():s.obs?s.obs():s}var Lt=class{constructor({addNew:e,refresh:t,list:i,AreLoading:o},a){a.subscribeAdded(this.activityQueueWatcher),this.addNew=e,this.refresh=t,this.Actions=i.All,this.AreLoading=o}activityQueueWatcher=e=>{e.map(({activity:t,data:i})=>{this.actionTypeFunctionMap[t]&&this.actionTypeFunctionMap[t](i)})};actionTypeFunctionMap={Assigned:this.assignmentAdded.bind(this),Unassigned:this.assignmentRemoved.bind(this),Created:this.requestCreated.bind(this),Advanced:this.requestAdvanced.bind(this),Approved:this.requestApproved.bind(this),Rejected:this.requestRejected.bind(this),Paused:this.requestPaused.bind(this),Resumed:this.requestResumed.bind(this),Closed:this.requestClosed.bind(this)};async requestCreated(e){this.addNew({ActionType:B.Created,Description:`The request was submitted with an effective submission date of ${e.Dates.Submitted.toLocaleDateString()}.`})}async requestAdvanced(e){this.addNew({ActionType:B.Advanced,Description:`The request was advanced to stage ${e.Step}: ${e.Title}.`})}requestPaused(e){this.addNew({ActionType:B.Paused,Description:e})}requestResumed(){this.addNew({ActionType:B.Resumed,Description:"Request clock has been resumed"})}async requestClosed(e){this.addNew({ActionType:B.Closed,Description:`The request was closed with a status of ${e.State.Status()}.`})}async assignmentCompleted(e){let t=`${e.ActionTaker.Title} has ${e.Status} an assignment.`;this.addNew({ActionType:e.Status,Description:t})}async requestApproved(e){let t=`${e.ActionTaker.Title} has ${e.Status} an assignment.`;this.addNew({ActionType:B.Approved,Description:t})}async requestRejected(e){let t=`${e.ActionTaker.Title} has rejected the request and provided the following reason:<br/>`+e.Comment;this.addNew({ActionType:B.Rejected,Description:t})}async assignmentAdded(e){let t=`The following ${e.Role.LookupValue}s have been assigned to this request:<br>`;e.Assignee?.Title&&(t+=`${e.Assignee.Title} - `),t+=e.RequestOrg?.Title,this.addNew({ActionType:B.Assigned,Description:t})}async assignmentRemoved(e){let t=`The following ${e.Role.LookupValue??e.Role}s have been removed from this request:<br>`;e.Assignee?.Title&&(t+=`${e.Assignee.Title} - `),t+=e.RequestOrg?.Title,this.addNew({ActionType:B.Unassigned,Description:t})}};function Vt(s,e){for(var t=0,i=new Date(s),o=Math.abs(e),a=Math.sign(e);o>=0;)i.setTime(s.getTime()+a*t*864e5),fo(i)&&!ho(i)&&--o,++t;return i}function mo(s,e){for(var t=0,i=new Date(s),o=Math.sign(e-s);i.format("yyyy-MM-dd")!=e.format("yyyy-MM-dd");)fo(i)&&!ho(i)&&t++,i.setDate(i.getDate()+1*o);return t*o}function ho(s){var e=xt().find(function(t){var i=t.Date.getUTCDate()==s.getUTCDate(),o=t.Date.getUTCMonth()==s.getUTCMonth(),a=t.Date.getUTCFullYear()==s.getUTCFullYear();return t.Repeating&&(a=!0),i&&o&&a});return e}function fo(s){var e=s.getDay();if(e===0||e===6)return!1;let t=["12/31+5","1/1","1/2+1","1-3/1","2-3/1","5~1/1","7/3+5","7/4","7/5+1","9-1/1","10-2/1","11/10+5","11/11","11/12+1","11-4/4","12/24+5","12/25","12/26+1"];var i=s.getDate(),o=s.getMonth()+1,a=o+"/"+i;if(t.indexOf(a)>-1)return!1;var d=a+"+"+e;if(t.indexOf(d)>-1)return!1;var m=Math.floor((i-1)/7)+1,b=o+"-"+m+"/"+e;if(t.indexOf(b)>-1)return!1;var x=new Date(s);x.setMonth(x.getMonth()+1),x.setDate(0);var L=Math.floor((x.getDate()-i-1)/7)+1,_=o+"~"+L+"/"+e;return!(t.indexOf(_)>-1)}var bo=Ii,go={};window.history.replaceState({},"",document.location.href);function Xe(s,e){if(Mt(s)==e)return;let t=window.location.search,i=new RegExp("([?;&])"+s+"[^&;]*[;&]?"),o=t.replace(i,"$1").replace(/&$/,""),a=(o.length>2?o+"&":"?")+(e?s+"="+e:"");go[s]=e,window.history.pushState(go,"",a.toString())}function Mt(s){let e=new RegExp("[?&]"+s+"=([^&#]*)").exec(window.location.href);return e==null?null:decodeURI(e[1])||0}var vo={Created:_a,Advanced:Ba,Assigned:Ua,Closed:Ga};async function wo(s,e){let t=[e.RequestorInfo.Requestor(),I()],i=[];e.Assignments.list.All().filter(a=>a.PipelineStage?.ID==e.Pipeline.Stage()?.ID).map(a=>{a.Assignee?.LoginName&&t.push(a.Assignee),i.push(a.RequestOrg)});let o={To:t,CC:i,Request:e,Title:gt(e,"New Comment"),Body:`${I().Title} has left a new comment on ${e.getAppLinkElement()}:<br/><br/>`};await ft(o,e.getRelativeFolderPath())}function So(s,e){window.DEBUG&&(console.log("Sending Notification: ",e),console.log("for request: ",s)),vo[e.activity]&&vo[e.activity](s,e)}async function _a(s){window.DEBUG&&console.log("Sending Request Created Notification for: ",s);let e=[...new Set(s.Pipeline.RequestOrgs()?.map(a=>a.Title))],t="";e.forEach(a=>{t+=`<li>${a}</li>`});let i={To:[s.RequestorInfo.Requestor(),I()],Title:gt(s,"New"),Body:`<p>Your ${s.RequestType.Title} request has been successfully submitted.</p><p>${s.getAppLinkElement()}</p><p>Estimated days to close this request type: `+s.RequestType.DaysToCloseBusiness+"</p><p>This request will be serviced by:</br><ul>"+t+"</ul></p><p>To view the request, please click the link above, or copy and paste the below URL into your browser:</br>"+s.getAppLink(),Request:s};await ft(i,s.getRelativeFolderPath());let o={To:s.Pipeline.RequestOrgs()?.map(a=>ee.FindInStore(a)),Title:gt(s,"New"),Body:"<p>Greetings Colleagues,<br><br> A new service request has been opened requiring your attention:<br>"+s.getAppLinkElement()+"</p><p>Estimated days to close this request type: "+s.RequestType.DaysToCloseBusiness+"</p><p>This request will be serviced by:</br><ul>"+t+"</ul></p><p>To view the request, please click the link above, or copy and paste the below URL into your browser:</br>"+s.getAppLink(),Request:s};await ft(o,s.getRelativeFolderPath())}function Ba(s){window.DEBUG&&console.log("Sending Request Advanced Notification for: ",s)}async function Ua(s,e){window.DEBUG&&console.log("Sending Request Assigned Notification for: ",s),window.DEBUG&&console.log(e);let t=e.data?.Role?.LookupValue,i="";switch(t){case Ve.Subscriber:case Ve.Viewer:i="<p>This notification was generated for information purposes only. You have no pending actions on this request.</p>";break;default:}let o={Title:gt(s,"Assigned"),Body:`<p>Greetings Colleagues,<br><br>You have been assigned the role of       <strong>${t}</strong> on the following       request:<br>`+s.getAppLinkElement()+"</p>"+i+"<p>To view the request, please click the link above,       or copy and paste the below URL into your browser: <br> "+s.getAppLink()+"</p>",Request:s},a=e.data?.Assignee,d=ee.FindInStore(e.data?.RequestOrg);a?.ID!=d?.UserGroup.ID?(o.To=[a],o.CC=[d]):o.To=[d],await ft(o,s.getRelativeFolderPath())}async function Ga(s,e){window.DEBUG&&console.log("Sending Request Closed Notification for: ",s);let t={To:[s.RequestorInfo.Requestor()],Title:gt(s,"Closed "+s.State.Status()),Body:`<p>Greetings Colleagues,<br><br>The following request has been ${s.State.Status()}:<br>`+s.getAppLinkElement()+"</p><p>This request cannot be re-opened.</p>",Request:s};await ft(t,s.getRelativeFolderPath())}async function ft(s,e){let t=Q();s.ToString=oi(s.To),s.To=ii(s.To),s.CCString=oi(s.CC),s.CC=ii(s.CC),s.BCCString=oi(s.BCC),s.BCC=ii(s.BCC),await t.Notifications.AddEntity(s,e)}function ii(s){return s?.filter(e=>!e.PreferredEmail)?.map(e=>{if(e.UserGroup)return e.UserGroup;if(e.OrgType){console.warn("Trying to email RequestOrg!");return}return e})}function oi(s){return s?.filter(e=>e.PreferredEmail)?.map(e=>e.PreferredEmail).join(";")}function gt(s,e){return`${Ui} -${e}- ${s.RequestType.Title} - ${s.Title}`}var bt=ko.observableArray(),Ao=ko.pureComputed(()=>bt().filter(s=>s.IsBlocking())??[]),me={init:{msg:"Initializing the Application",blocking:!0},save:{msg:"Saving Request",blocking:!0},cancelAction:{msg:"Cancelling Action",blocking:!0},view:{msg:"Viewing Request",blocking:!1},refresh:{msg:"Refreshing Request",blocking:!1},permissions:{msg:"Updating Request Item Permissions",blocking:!0},lock:{msg:"Locking Request",blocking:!0},closing:{msg:"Closing Request",blocking:!0},pipeline:{msg:"Progressing to Next Stage",blocking:!0},newComment:{msg:"Submitting Comment",blocking:!1},refreshComments:{msg:"Refreshing Comments",blocking:!1},notifyComment:{msg:"Sending Comment Email",blocking:!1},removeComment:{msg:"Removing Comment",blocking:!1},newAction:{msg:"Submitting Action",blocking:!1},refreshActions:{msg:"Refreshing Actions",blocking:!1},newAttachment:{msg:"Submitting Attachment",blocking:!1},uploadAttachment:s=>({msg:"Uploading Attachment: "+s,blocking:!0,type:It}),refreshAttachments:{msg:"Refreshing Attachments",blocking:!1},approve:{msg:"Approving Request",blocking:!0}},he=s=>{let e=s.type?new s.type(s):new pt(s);return bt.push(e),e},de=function(s){s&&(s.markComplete(),window.setTimeout(()=>$a(s),3e3))},$a=function(s){bt.remove(s)};var je=class{constructor(e,t){this.includeAssignments=t,this.filter=e}IsLoading=ko.observable();HasLoaded=ko.observable(!1);List=ko.observableArray();load=async()=>{this.IsLoading(!0);let e=new Date,i=(await Q().Requests.FindByColumnValue([{column:"RequestStatus",value:this.filter}],{orderByColumn:"Title",sortAsc:!1},{},le.Views.ByStatus,!1)).results;this.includeAssignments&&i.map(a=>a.Assignments.refresh()),this.List(i);let o=new Date;window.DEBUG&&console.log(`Request by status Set - ${this.filter}: ${i.length} cnt in ${o-e}`),this.HasLoaded(!0),this.IsLoading(!1)};init=async()=>{if(!this.HasLoaded()){if(this.IsLoading())return new Promise((e,t)=>{this.isLoadingSubscription=this.IsLoading.subscribe(i=>{this.isLoadingSubscription.dispose(),e()})});await this.load()}};dispose(){this.isLoadingSubscription&&this.isLoadingSubscription.dispose()}includeAssignments=async()=>{}};var ie=new Map;ie.set(F.open,new je(F.open,!0));ie.set(F.fulfilled,new je(F.fulfilled));ie.set(F.cancelled,new je(F.cancelled));ie.set(F.rejected,new je(F.rejected));var yt=ko.observableArray();var Se={New:"New",Edit:"Edit",View:"View"},ja={New:"request-header-edit",View:"request-header-view",Edit:"request-header-edit"},Ha={New:"request-body-edit",View:"request-body-view",Edit:"request-body-edit"},_t=class{refreshAll=async()=>{await this.request.refreshAll()};Request=ko.observable();get request(){return this.Request()}DisplayModes=Se;DisplayMode=ko.observable();HeaderComponentName=ko.pureComputed(()=>ja[this.DisplayMode()]);BodyComponentName=ko.pureComputed(()=>Ha[this.DisplayMode()]);ShowActionsArea=ko.pureComputed(()=>this.request.State.IsActive()&&!this.request.IsLoading()&&!this.request.Assignments.AreLoading()&&this.request.Assignments.CurrentStage.list.UserActionAssignments().length);ShowCloseArea=ko.pureComputed(()=>!this.request.IsLoading()&&!this.request.Assignments.AreLoading()&&this.request.Authorization.currentUserCanClose());newComment={input:new W({displayName:"Please provide additional comments/instructions here",instructions:null,isRichText:!0}),submit:async()=>{let e={Comment:this.newComment.input.Value()};await this.request.Comments.addNew(e),this.newComment.input.Value("")}};submitNewRequest=async()=>{if(!this.request.Validation.validate())return;let e=this.request.RequestType;if(!e)throw"no service type provided";let t=he(me.save);this.DisplayMode(Se.View),this.request.DisplayMode(Se.View),this.request.State.Status(F.open);let i=this.request.getRelativeFolderPath();{let d=he(me.permissions),m=this.request.getFolderPermissions(),b=this.request.getInitialListRefs(),x=this.request.Attachments.list.All().length;if(x&&b.push(this._context.Attachments),await Promise.all(b.map(async L=>{if(!await L.UpsertFolderPath(i)){alert(`Could not create ${L.Title} folder `+i);return}let z=await L.SetFolderPermissions(i,m)})),de(d),x){let L=this.request.getRelativeFolderPathStaging();await this._context.Attachments.CopyFolderContents(L,i),await this._context.Attachments.DeleteFolderByPath(L)}}let o=this.request.calculateEffectiveSubmissionDate();this.request.Dates.Submitted.set(o),this.request.Dates.EstClosed.set(Vt(o,e.DaysToCloseBusiness)),this.request.RequestOrgs(this.request.Pipeline.Stages().filter(d=>d.RequestOrg!=null).map(d=>d.RequestOrg)),this.request.State.InternalStatus(Ue.inProgress),this.request.State.IsActive(!0),await this._context.Requests.AddEntity(this.request,i),Xe("reqId",this.request.Title),this.request.ActivityQueue.push({activity:B.Created,data:this.request}),this.request.Pipeline.advance(),this.request.Validation.reset(),this.request.LoadedAt(new Date),ie.get(F.open).List.push(this.request),de(t)};editRequestHandler=async()=>{this.DisplayMode(Se.Edit)};updateRequestHandler=async()=>{this.DisplayMode(Se.View)};cancelChangesHandler=async()=>{this.refreshAll(),this.DisplayMode(Se.View)};promptClose=()=>{confirm("Close and finalize request? This action cannot be undone!")&&this.request.closeAndFinalize(F.fulfilled)};promptFulfill=()=>{if(this.request.Pipeline.Stage().ActionType==ke.Closed&&confirm("Close and finalize request? This action cannot be undone!")){this.request.closeAndFinalize(F.fulfilled);return}let e=this.request.Pipeline.Stages().length-this.request.Pipeline.Stage()?.Step;if(e&&confirm(`This request still has ${e} open steps! Are you sure you want to close and finalize it? This action cannot be undone!`)){this.request.closeAndFinalize(F.fulfilled);return}};promptCancel=()=>{confirm("Cancel request? This action cannot be undone!")&&this.request.closeAndFinalize(F.cancelled)};pauseOptions=Object.entries(Ue).filter(([e,t])=>t!=Ue.inProgress).map(([e,t])=>({key:e,value:t}));pauseReason=ko.observable();showPause=ko.pureComputed(()=>this.request.State.Status()==F.open&&this.request.State.InternalStatus()==Ue.inProgress);clickPause=()=>{let e=this.pauseReason();this.pauseReason(null),this.request.pauseRequest(e)};showResume=ko.pureComputed(()=>this.request.State.IsPaused());clickResume=()=>{this.request.resumeRequest()};validationWatcher=e=>{e&&this.request.Authorization.currentUserCanAdvance()&&!this.request.Assignments.CurrentStage.list.InProgress().length&&this.promptAdvance()};nextStageHandler=()=>{if(!this.request.Assignments.CurrentStage.list.InProgress().length){this.request.Pipeline.advance();return}this.promptAdvance()};promptAdvanceModal;promptAdvance=()=>{this.promptAdvanceModal||(this.promptAdvanceModal=new bootstrap.Modal(document.getElementById("modal-advance-request"),{})),this.promptAdvanceModal.show()};confirmAdvanceHandler=()=>{if(!this.request.Pipeline.getNextStage()){this.promptClose(),this.promptAdvanceModal.hide();return}this.request.Pipeline.advance(),this.promptAdvanceModal.hide()};approveRequestHandler=()=>{this.approveRequest()};async approveRequest(){this.promptAdvance()}serviceTypeDefinitionWatcher=e=>{};createNewRequest=async({request:e})=>{let{Requestor:t,Phone:i,Email:o,OfficeSymbol:a}=e.RequestorInfo;t()||t(new X(I())),i()||i(I().WorkPhone),o()||o(I().EMail),a.get()||a.set(I().OfficeSymbol);let{Status:d,InternalStatus:m,IsActive:b}=e.State;d()||d(F.draft),m()||m(F.draft),b()||b(!0),e.LoadedAt(new Date),e.Validation.IsValid.subscribe(this.validationWatcher),this.Request(e),this.DisplayMode(Se.New)};viewRequest=({request:e})=>{e.Validation.IsValid.subscribe(this.validationWatcher),this.Request(e),this.DisplayMode(Se.View),this.refreshAll()};constructor(){this._context=Q()}};var ai={Draft:"text-bg-info",Open:"text-bg-primary",Paused:"text-bg-warning","In Progress":"text-bg-primary",Completed:"text-bg-success",Cancelled:"text-bg-warning",Rejected:"text-bg-danger"},le=class s{constructor({ID:e=null,Title:t=null,ServiceType:i=null}){this.ID=e,this.Title=t??ji(),this.LookupValue=t,this._context=Q(),e||(this.DisplayMode(Se.New),this.State.Status(F.draft)),i&&(this.RequestType=_e.FindInStore(i),this.RequestType._constructor&&(this.RequestBodyBlob=new Ne({displayName:"Service Type Details",isRequired:!1,width:12,entityType:ko.observable(this.RequestType._constructor)}))),this.ActivityQueue.subscribe(this.activityQueueWatcher,this,"arrayChange")}DisplayMode=ko.observable(Se.View);Displaymodes=Se;get ID(){return this.ObservableID()}set ID(e){this.ObservableID(e)}get Title(){return this.ObservableTitle()}set Title(e){this.ObservableTitle(e)}ObservableID=ko.observable();ObservableTitle=ko.observable();RequestSubject=ko.observable();RequestDescription=new W({displayName:ko.pureComputed(()=>this.RequestType?.DescriptionTitle??"Description"),instructions:ko.pureComputed(()=>this.RequestType?.DescriptionFieldInstructions),isRichText:!0,isRequired:ko.pureComputed(()=>this.RequestType?.DescriptionRequired??!1),width:"12"});RequestorInfo={Requestor:ko.observable(),Phone:ko.observable(),Email:ko.observable(),Office:ko.observable(),OfficeSymbol:new l({displayName:"Office Symbol"})};State={IsActive:ko.observable(),Status:ko.observable(),StatusClass:ko.pureComputed(()=>ai[this.State.Status()]),InternalStatus:ko.observable(),InternalStatusClass:ko.pureComputed(()=>ai[this.State.InternalStatus()]??ai.Paused),IsPaused:ko.pureComputed(()=>this.State.Status()==F.open&&this.State.InternalStatus()!=Ue.inProgress)};Reporting={MeetingStandard:ko.pureComputed(()=>this.Reporting.AgingDays()<=0),AgingDays:ko.pureComputed(()=>this.Reporting.OpenDays()-this.RequestType.DaysToCloseBusiness),OpenDays:ko.pureComputed(()=>{let e=this.Dates.Closed.Value()??new Date;return mo(this.Dates.Submitted.Value(),e)})};Dates={Submitted:new P({displayName:"Submitted Date"}),EstClosed:new P({displayName:"Est. Closed Date"}),Closed:new P({displayName:"Closed Date"})};RequestOrgs=ko.observable();RequestType;RequestBodyBlob;Pipeline={Stage:ko.observable(),PreviousStage:ko.observable(),Icon:ko.pureComputed(()=>this.RequestType?.Icon),Stages:ko.pureComputed(()=>{if(!this.RequestType)return[];let e=ze().filter(i=>i.ServiceType?.ID==this.RequestType?.ID).sort($i("Step")),t=Ie.GetCompletedStage();return t.Step=e.length+1,e.push(t),e}),RequestOrgs:ko.pureComputed(()=>this.Pipeline.Stages().filter(e=>e.RequestOrg).map(e=>e.RequestOrg)),getNextStage:ko.pureComputed(()=>{let t=(this.Pipeline.Stage()?.Step??0)+1;return this.Pipeline.Stages()?.find(i=>i.Step==t)}),advance:async()=>{let e=he(me.pipeline);this.promptAdvanceModal&&this.promptAdvanceModal.hide(),await this.resumeRequest();let t=this.Pipeline.getNextStage();if(t.ActionType==ke.Closed)return console.log("Closing Request"),this.closeAndFinalize(F.fulfilled),de(e),null;let i=this.Pipeline.Stage();this.Pipeline.PreviousStage(i),this.Pipeline.Stage(t),await this._context.Requests.UpdateEntity(this,["PipelineStage","PipelineStagePrev"]),this.ActivityQueue.push({activity:B.Advanced,data:t}),await this.Assignments.createStageAssignments(t),t.ActionType==ke.Notification&&this.Pipeline.advance(),t.ActionType==ke.Closed&&this.closeAndFinalize(F.fulfilled),de(e)}};Attachments={AreLoading:ko.observable(),list:{All:ko.observableArray(),Active:ko.pureComputed(()=>this.Attachments.list.All().filter(e=>e.IsActive))},Validation:{Errors:ko.pureComputed(()=>{let e=[],t=this.RequestType?.AttachmentsRequiredCnt??0;return t<0&&(t=1),this.Attachments.list.Active().length<t&&e.push(new xe("attachment-count-mismatch","request-header",`This request has ${this.RequestType.attachmentsRequiredCntString()} required attachment(s)!`)),e})},userCanAttach:ko.pureComputed(()=>this.Authorization.currentUserCanSupplement()),createFolder:async()=>{let e=he(me.newAttachment),t=this.getRelativeFolderPath(),i=this.getFolderPermissions();try{await this._context.Attachments.UpsertFolderPath(t),await this._context.Attachments.SetFolderPermissions(t,i),this.Attachments.refresh()}catch(o){console.error("Error creating folder: ",o),t=null}finally{de(e)}return t},newAttachmentFiles:ko.observableArray(),removeFile:e=>{this.Attachments.newAttachmentFiles.remove(e)},addNew:async()=>{let e=await this.Attachments.createFolder();e||alert("Unable to create folder"),await Promise.all(this.Attachments.newAttachmentFiles().map(async t=>{let i=he(me.uploadAttachment(t.name)),o=t.name.split(".").slice(0,-1).join(".")??t.name;await this._context.Attachments.UploadFileToFolderAndUpdateMetadata(t,t.name,e,{Title:o,RequestId:this.ID,IsActive:!0},({currentBlock:a,totalBlocks:d})=>{i.updateProgress({percentDone:a/d})}),de(i)})),this.Attachments.newAttachmentFiles([]),this.Attachments.refresh()},refresh:async()=>{if(!this.Title)return;let e=he(me.refreshAttachments);this.Attachments.AreLoading(!0);try{let t=await this._context.Attachments.GetItemsByFolderPath(this.getRelativeFolderPath(),Be.Views.All);this.Attachments.list.All(t)}catch(t){console.warn("Looks like there are no attachments",t)}this.Attachments.AreLoading(!1),de(e)},view:e=>{this._context.Attachments.ShowForm("DispForm.aspx","View "+e.Title,{id:e.ID})},userCanRemove:e=>ko.pureComputed(()=>!!this.Authorization.currentUserCanSupplement()),remove:async e=>{console.log("removing",e),e.IsActive=!1,await this._context.Attachments.UpdateEntity(e,["IsActive"]),this.Attachments.refresh()}};Comments={AreLoading:ko.observable(),list:{All:ko.observableArray(),Active:ko.pureComputed(()=>this.Comments.list.All().filter(e=>e.IsActive))},userCanComment:ko.pureComputed(()=>this.Authorization.currentUserCanSupplement()),addNew:async e=>{let t=he(me.newComment),i=this.getRelativeFolderPath(),o=this.getFolderPermissions();try{let a=await this._context.Comments.UpsertFolderPath(i);await this._context.Comments.SetFolderPermissions(i,o),await this._context.Comments.AddEntity(e,i),this.Comments.refresh()}catch{console.error("Error creating folder: ")}finally{de(t)}},update:async e=>{},refresh:async()=>{let e=he(me.refreshComments);this.Comments.AreLoading(!0);let t=this.getRelativeFolderPath(),i=await this._context.Comments.GetItemsByFolderPath(t,Ke.Views.All);this.Comments.list.All(i),this.Comments.AreLoading(!1),de(e)},sendNotification:async e=>{let t=he(me.newComment);await wo(e,this),e.NotificationSent=!0,await this._context.Comments.UpdateEntity(e,["NotificationSent"]),this.Comments.refresh(),de(t)},remove:async e=>{let t=he(me.removeComment);e.IsActive=!1,await this._context.Comments.UpdateEntity(e,["IsActive"]),this.Comments.refresh(),de(t)}};Assignments={HaveLoaded:ko.observable(!1),AreLoading:ko.observable(),list:{All:ko.observableArray(),InProgress:ko.pureComputed(()=>this.Assignments.list.All().filter(e=>e.Status==O.InProgress)),Dashboard:ko.pureComputed(()=>this.Assignments.list.All()),CurrentUserAssignments:ko.pureComputed(()=>{if(!this.Assignments.list.All().length)return[];let e=I().getGroupIds(),t=I().ActionOffices().map(o=>o.ID);return this.Assignments.list.All().filter(o=>o.Assignee?.ID==I()?.ID||e.includes(o.Assignee?.ID)||t.includes(o.RequestOrg?.ID))})},getFolderUrl:()=>this._context.Assignments.GetFolderUrl(this.getRelativeFolderPath()),CurrentStage:{list:{ActionAssignments:ko.pureComputed(()=>this.Assignments.list.All().filter(e=>e.PipelineStage?.ID==this.Pipeline.Stage()?.ID&&e.isActionable())),InProgress:ko.pureComputed(()=>this.Assignments.list.InProgress().filter(e=>e.PipelineStage?.ID==this.Pipeline.Stage()?.ID)),UserActionAssignments:ko.pureComputed(()=>this.Assignments.list.CurrentUserAssignments().filter(e=>e.PipelineStage?.ID==this.Pipeline.Stage()?.ID&&e.isActionable()))},Validation:{IsValid:ko.pureComputed(()=>!this.Assignments.CurrentStage.Validation.ActiveAssignmentsError()&&!this.Assignments.CurrentStage.Validation.Errors().length),Errors:ko.observableArray(),ActiveAssignmentsError:ko.pureComputed(()=>this.Assignments.CurrentStage.list.UserActionAssignments().find(t=>t.Status==O.InProgress)?(this.Assignments.CurrentStage.Validation.Errors.indexOf(St)<0&&this.Assignments.CurrentStage.Validation.Errors.push(St),!0):(this.Assignments.CurrentStage.Validation.Errors.remove(St),!1))},UserCanAdvance:ko.pureComputed(()=>this.Assignments.CurrentStage.list.UserActionAssignments().length),AssignmentComponents:ko.pureComputed(()=>this.Assignments.CurrentStage.list.UserActionAssignments().map(e=>({request:this,assignment:e,addAssignment:this.Assignments.addNew,completeAssignment:this.Assignments.complete,errors:this.Assignments.CurrentStage.Validation.Errors,actionComponentName:e.getComponentName()})))},refresh:async()=>{this.Assignments.AreLoading(!0);let e=await this._context.Assignments.GetItemsByFolderPath(this.getRelativeFolderPath(),ce.Views.All);e.map(t=>t.RequestOrg=ee.FindInStore(t.RequestOrg)??t.RequestOrg),this.Assignments.list.All(e),this.Assignments.HaveLoaded(!0),this.Assignments.AreLoading(!1)},userCanAssign:ko.pureComputed(()=>{if(!this.State.IsActive())return!1;let e=this.Pipeline.Stage()?.RequestOrg;return e?!!I().isInRequestOrg(e):!1}),addNew:async(e=null)=>{if(!this.ID||!e)return;e.Title=this.Title,e.RequestOrg||(e.RequestOrg=this.Pipeline.Stage()?.RequestOrg),e.PipelineStage||(e.PipelineStage=this.Pipeline.Stage()),e.Status=e.Role.initialStatus;let t=this.getRelativeFolderPath();await this._context.Assignments.AddEntity(e,t,this),await this.Assignments.refresh(),this.RequestOrgs().find(i=>i.ID==e.RequestOrg.ID)||(this.RequestOrgs.push(e.RequestOrg),await this._context.Requests.UpdateEntity(this,["RequestOrgs"])),this.ActivityQueue.push({activity:B.Assigned,data:e}),e.Role?.permissions&&this.Authorization.ensureAccess([[e.Assignee,e.Role.permissions]])},view:e=>{this._context.Assignments.ShowForm("DispForm.aspx","View "+e.Assignee.Title,{id:e.ID})},remove:async e=>{if(confirm("Are you sure you want to remove this assignment?")){try{await this._context.Assignments.RemoveEntity(e)}catch(t){console.error("Unable to remove assignment",t);return}this.Assignments.refresh(),this.ActivityQueue.push({activity:B.Unassigned,data:e})}},complete:async(e,t,i=!0)=>{let o={ID:e.ID,Status:O[t],Comment:e.Comment,CompletionDate:new Date().toISOString(),ActionTaker:I()};await this._context.Assignments.UpdateEntity(o),await this.resumeRequest(),this.ActivityQueue.push({activity:B[t],data:o}),i&&this.Assignments.refresh()},createStageAssignments:async(e=this.Pipeline.Stage())=>{if(!e?.ActionType||e.ActionType==B.Closed||this.Assignments.list.All().find(i=>i.PipelineStage?.ID==e.ID))return;if(e.AssignmentFunction&&We[e.AssignmentFunction]){try{let i=We[e.AssignmentFunction](this,e);await Promise.all(i.map(o=>this.Assignments.addNew(o)))}catch(i){console.warn("Error creating stage assignments",e),alert(i.message);return}return}if(e.WildCardAssignee){try{let i=We.getWildcard(this,e,e.WildCardAssignee);await Promise.all(i.map(o=>this.Assignments.addNew(o)))}catch(i){console.warn("Error creating stage assignments",e),alert(i.message);return}return}let t=new ce({Assignee:e.Assignee??ee.FindInStore(e.RequestOrg)?.UserGroup,RequestOrg:e.RequestOrg,PipelineStage:e,IsActive:!0,Role:Ct[e.ActionType]});await this.Assignments.addNew(t)}};Actions={AreLoading:ko.observable(),list:{All:ko.observableArray()},refresh:async()=>{let e=he(me.refreshActions);if(!this.ID)return;this.Actions.AreLoading(!0);let t=await this._context.Actions.GetItemsByFolderPath(this.getRelativeFolderPath(),Je.Views.All);this.Actions.list.All(t),this.Actions.AreLoading(!1),de(e)},addNew:async e=>{if(!this.ID||!e)return;let t=he(me.newAction),i=this.getRelativeFolderPath();e.PipelineStage=e.PipelineStage??this.Pipeline.Stage(),await this._context.Actions.AddEntity(e,i,this.request),this.Actions.refresh(),de(t)},showDialog:()=>{document.getElementById("dialog-action-log").showModal()},closeDialog:()=>{document.getElementById("dialog-action-log").close()}};ActivityQueue=ko.observableArray();ActivityLogger=new Lt(this.Actions,this.ActivityQueue);IsLoading=ko.observable();LoadedAt=ko.observable();activityQueueWatcher=e=>{e.filter(i=>i.status=="added").map(i=>i.value).map(async i=>{switch(So(this,i),i.activity){case B.Assigned:case B.Unassigned:break;case B.Rejected:console.warn("Closing request"),await this.closeAndFinalize(F.rejected);break;case B.Advanced:break}})};Validation={validate:()=>(this.Validation.WasValidated(!0),this.Validation.validateHeader(),this.Validation.validateBody(),this.Validation.IsValid()),validateHeader:()=>{this.FieldMap.RequestDescription.validate()},validateBody:()=>this.RequestBodyBlob?.Value()?.validate(),reset:()=>this.Validation.WasValidated(!1),Errors:{Request:ko.pureComputed(()=>{let e=[];return e=e.concat(this.Attachments.Validation.Errors()),e=e.concat(this.FieldMap.RequestDescription.Errors()),e}),ServiceType:ko.pureComputed(()=>this.RequestBodyBlob?.Value()?.Errors()??[]),All:ko.pureComputed(()=>[...this.Validation.Errors.Request(),...this.Validation.Errors.ServiceType(),...this.Validation.CurrentStage.Errors()])},IsValid:ko.pureComputed(()=>!this.Validation.Errors.All().length),WasValidated:ko.observable(!1),CurrentStage:{IsValid:()=>this.Assignments.CurrentStage.Validation.IsValid(),Errors:ko.pureComputed(()=>this.Assignments.CurrentStage.Validation.Errors())}};Authorization={currentUserIsActionOffice:ko.pureComputed(()=>this.Assignments.list.CurrentUserAssignments().find(e=>[Ve.ActionResolver,Ve.Approver].includes(e.ActionType))),currentUserCanAdvance:ko.pureComputed(()=>this.State.IsActive()&&this.Assignments.CurrentStage.list.UserActionAssignments().length),currentUserCanSupplement:ko.pureComputed(()=>{let e=I();if(!e)return console.warn("Current user not set!"),!1;if(!this.State.IsActive())return!1;if(this.Assignments.list.CurrentUserAssignments().length||this.RequestorInfo.Requestor()?.ID==e.ID)return!0}),currentUserCanClose:ko.pureComputed(()=>this.State.IsActive()&&this.Assignments.list.CurrentUserAssignments().find(e=>e.isActionable())),ensureAccess:async e=>{let t=this.getRelativeFolderPath(),i=this.getAllListRefs();await Promise.all(i.map(async o=>{await o.EnsureFolderPermissions(t,e)}))},setReadonly:async()=>{let e=this.getRelativeFolderPath(),t=this.getAllListRefs();await Promise.all(t.map(async i=>{await i.SetFolderReadOnly(e)}))}};getAppLink=()=>`${bo}?reqId=${this.Title}&tab=${Pe.RequestDetail}`;getAppLinkElement=()=>`<a href="${this.getAppLink()}" target="blank">${this.Title}</a>`;getRelativeFolderPath=ko.pureComputed(()=>this.State.Status()==F.draft?this.getRelativeFolderPathStaging():`${this.RequestorInfo.Office()?.Title.replace("/","_")}/${this.ObservableTitle()}`);getRelativeFolderPathStaging=()=>`Staged/${this.ObservableTitle()}`;getFolderUrl=ko.pureComputed(()=>this._context.Requests.GetFolderUrl(this.getRelativeFolderPath()));getFolderPermissions=()=>Oi(this);calculateEffectiveSubmissionDate=()=>{let e=this.Dates.Submitted.get()??new Date;if(e.getUTCHours()>=19||e.getUTCHours()<4){console.log("its after 3, this is submitted tomorrow");let t=Vt(e,1);return t.setUTCHours(13),t.setUTCMinutes(0),t}else return e};refreshAll=async()=>{let e=he(me.refresh);this.IsLoading(!0),await this.refreshRequest();let t=[this.Attachments.refresh(),this.Actions.refresh(),this.Comments.refresh(),this.Assignments.refresh()];await Promise.all(t),this.LoadedAt(new Date),this.IsLoading(!1),de(e)};refreshRequest=async()=>{this.ID&&await this._context.Requests.LoadEntity(this)};getAllListRefs(){return this.getInitialListRefs().concat([this._context.Comments,this._context.Attachments])}getInitialListRefs(){return[this._context.Requests,this._context.Actions,this._context.Assignments,this._context.Notifications]}pauseRequest=async(e="Not Provided")=>{this.State.InternalStatus(e),await this._context.Requests.UpdateEntity(this,["InternalStatus"]),this.ActivityQueue.push({activity:B.Paused,data:e})};resumeRequest=async()=>{this.State.IsPaused()&&(this.State.InternalStatus(Ue.inProgress),await this._context.Requests.UpdateEntity(this,["InternalStatus"]),this.ActivityQueue.push({activity:B.Resumed,data:this}))};closeAndFinalize=async e=>{let t=he(me.closing);this.Assignments.list.InProgress().map(a=>{this.Assignments.complete(a,O.Cancelled,!1)});let i=Ie.GetCompletedStage(),o=this.Pipeline.Stage();this.Pipeline.PreviousStage(o),this.Pipeline.Stage(i),this.State.Status(e),this.State.InternalStatus(e),this.State.IsActive(!1),this.Dates.Closed.set(new Date),await this._context.Requests.UpdateEntity(this,["PipelineStage","PipelineStagePrev","RequestStatus","InternalStatus","IsActive","ClosedDate"]),this.ActivityQueue.push({activity:B.Closed,data:this}),await this.Authorization.setReadonly(),this.refreshAll(),de(t)};FieldMap={ID:this.ObservableID,Title:this.ObservableTitle,RequestSubject:this.RequestSubject,RequestDescription:this.RequestDescription,Requestor:{set:e=>this.RequestorInfo.Requestor(X.Create(e)),get:this.RequestorInfo.Requestor},RequestorPhone:this.RequestorInfo.Phone,RequestorEmail:this.RequestorInfo.Email,RequestorOfficeSymbol:this.RequestorInfo.OfficeSymbol,RequestingOffice:{set:e=>this.RequestorInfo.Office(ee.Create(e)),get:this.RequestorInfo.Office},IsActive:this.State.IsActive,PipelineStage:{factory:Ie.FindInStore,obs:this.Pipeline.Stage},PipelineStagePrev:{factory:Ie.FindInStore,obs:this.Pipeline.PreviousStage},RequestStatus:this.State.Status,InternalStatus:this.State.InternalStatus,RequestSubmitted:this.Dates.Submitted,EstClosedDate:this.Dates.EstClosed,ClosedDate:this.Dates.Closed,RequestOrgs:{set:e=>this.RequestOrgs((e.results??e).map(t=>ee.Create(t))),get:this.RequestOrgs},ServiceType:{set:e=>{let t=_e.FindInStore(e);this.RequestType=t},get:()=>this.RequestType},RequestBodyBlob:{get:()=>this.RequestBodyBlob?.get(),set:e=>{if(!this.RequestBodyBlob)return;this.RequestBodyBlob.set(e);let t=this.RequestBodyBlob.Value();t?.setRequestContext&&t.setRequestContext(this)}}};static Views={All:["ID","Title","RequestDescription","Requestor","RequestorPhone","RequestorEmail","RequestorOfficeSymbol","RequestingOffice","IsActive","PipelineStage","PipelineStagePrev","RequestStatus","InternalStatus","RequestSubmitted","EstClosedDate","ClosedDate","RequestOrgs","ServiceType","RequestBodyBlob"],ByStatus:["ID","Title","ServiceType","RequestorOfficeSymbol","RequestingOffice","RequestOrgs","Requestor","RequestSubmitted","PipelineStage","EstClosedDate","ClosedDate","RequestStatus","InternalStatus","RequestOrgs"],ByServiceType:["ID","Title","ServiceType","RequestorOfficeSymbol","RequestingOffice","Requestor","RequestStatus","RequestBodyBlob"]};static ListDef={name:"Requests",title:"Requests",fields:s.Views.All}};var Co=T`
  ...
  <!-- /ko -->
`;var ri=class extends M{PendingRows=ko.pureComputed(()=>yt().map(e=>new ni(e)));ConvertToOptions=ko.pureComputed(()=>pe().filter(e=>e.userCanInitiate(I())));deleteItem=async({requestIngest:e})=>{let t=Q(),i=e.getStagedAttachmentsFolderPath();await t.Attachments.DeleteFolderByPath(i),await t.RequestIngests.RemoveEntity(e),yt(await t.RequestIngests.ToList())};static name="pending-request-ingests";static template=Co},ni=class{constructor(e){this.requestIngest=e,this.ConvertTo.subscribe(this.onConvertToChangeHandler)}ShowBody=ko.observable(!1);ConvertTo=ko.observable();onConvertToChangeHandler=e=>{if(!e)return null;this.ConvertTo(null),this.ShowBody(!1),console.log("converting to...",e),Qa(e,this.requestIngest)}};async function Qa(s,e){await s.initializeEntity();let t=new le({ServiceType:s}),i=e.Body.Value();t.RequestBodyBlob?.Value()?.fromEmail&&t.RequestBodyBlob?.Value()?.fromEmail(i),t.RequestDescription.Value(i);let o=Q(),a=e.getStagedAttachmentsFolderPath();if((await o.Attachments.GetItemsByFolderPath(a,Be.Views.All)).length){console.log("Copying attachments");let m=await t.Attachments.createFolder();await o.Attachments.CopyFolderContents(a,m),await t.Attachments.refresh()}window.WorkOrder.App.NewRequest({request:t})}function He(s){return s=s.startsWith("#")?s:"#"+s,new DataTable(s,{dom:"<'ui stackable grid'<'row'<'eight wide column'l><'right aligned eight wide column'f>><'row dt-table'<'sixteen wide column'tr>><'row'<'six wide column'i><'d-flex justify-content-center'B><'right aligned six wide column'p>>>",buttons:["copy","csv","excel","pdf","print"],order:[[0,"desc"]],iDisplayLength:25,deferRender:!0,bDestroy:!0,initComplete:function(){this.api().columns().every(function(){var e=this,t=$(e.header()).closest("table"),i=$(e.footer()),o=$('<search-select class=""><option value=""></option></search-select>');switch(i.attr("data-filter")){case"select-filter":o.attr("multiple","true");case"single-select-filter":o.appendTo(i.empty()).on("change",function(){var m=this.selectedOptions.map(x=>x.value);m?m=m.map(function(x){return x?"^"+$.fn.dataTable.util.escapeRegex(x)+"$":null}):m=[];var b=m.join("|");e.search(b,!0,!1).draw()});let d="";e.data().unique().sort().each(function(m,b){try{let x=$(m);x.is("a")&&(m=x.text())}catch{}d+=`<option value="${m}" title="${m}">${m}</option>`}),o.append(d);break;case"search-filter":$('<div class=""><input class="form-control" type="text" placeholder="Search..." style="width: 100%"/></div>').appendTo(i.empty()).on("keyup change clear",function(){let m=this.getElementsByTagName("input")[0].value;e.search()!==m&&e.search(m).draw()});break;case"bool-filter":var a=$('<input type="checkbox"></input>').appendTo(i.empty()).change(function(){this.checked?e.search("true").draw():e.search("").draw()});break;default:}i.attr("clear-width")&&t.find("thead tr:eq(0) th").eq(e.index()).width("")})}})}var li=class{constructor(){}IsLoading=ko.observable();HasLoaded=ko.observable(!1);AllOpenRequests=ie.get(F.open).List;MyAssignedRequests=ko.pureComputed(()=>this.AllOpenRequests().filter(e=>e.Assignments.CurrentStage.list.UserActionAssignments().length));MyActiveAssignments=ko.pureComputed(()=>this.MyAssignedRequests().flatMap(e=>e.Assignments.CurrentStage.list.UserActionAssignments()).filter(e=>e.Status==O.InProgress&&e.userIsDirectlyAssigned(I())));List=ko.observableArray();getByRequest=e=>this.List().filter(t=>t.Request.ID==e.ID);getOpenByRequest=ko.pureComputed(()=>{let e=[],t=ie.get(F.open)?.List()??[],i=this.List().filter(o=>o.Status==O.InProgress);return t.map(o=>{e.push(...qe.getByRequest(o).filter(a=>a.Status==O.InProgress&&a.userIsDirectlyAssigned(I())))}),e});getOpenByUser=e=>ko.pureComputed(()=>this.List().filter(t=>t.Status==O.InProgress&&t.userIsDirectlyAssigned(e)));remove=e=>{this.List.remove(t=>t.ID==e)};load=async()=>{this.IsLoading(!0);let e=new Date,t=await Q().Assignments.FindByColumnValue([{column:"Status",op:"eq",value:O.InProgress}],{orderByColumn:"Title",sortAsc:!1},{},ce.Views.Dashboard,!1);this.List(t.results);let i=new Date;window.DEBUG&&console.log(`All Assignments loaded: ${t.results.length} cnt in ${i-e}`),this.HasLoaded(!0),this.IsLoading(!1)};init=async()=>{if(!this.HasLoaded()){if(this.IsLoading())return new Promise((e,t)=>{this.isLoadingSubscription=this.IsLoading.subscribe(i=>{this.isLoadingSubscription.dispose(),e()})});await this.load()}};dispose=()=>{this.isLoadingSubscription&&this.isLoadingSubscription.dispose()}},qe=new li;var Ro=T`
  <div data-bind="">
    <div class="d-flex justify-content-between">
...
`;var vt=class extends M{constructor({activeRequestSet:e,filteredRequests:t=null,key:i="office"}){super(),this.key=i,this.ActiveSet=e,this.filter=this.ActiveSet.filter,this.FilteredRequests=t??this.ActiveSet.List,this.IsLoading=this.ActiveSet.IsLoading,this.HasLoaded=this.ActiveSet.HasLoaded,this.init()}hasInitialized=!1;requestDateBackground=e=>{if(new Date>e.Dates.EstClosed.Value())return"table-danger"};getTableElementId=()=>"tbl-requests-status-"+this.key+this.filter?.toLowerCase();refresh=async()=>{await this.ActiveSet.load()};tableBodyComplete=e=>{this.Table&&this.Table.clear().destroy(),this.Table=He(this.getTableElementId())};init=async()=>{await this.ActiveSet.init(),this.hasInitialized=!0};dispose=()=>{}},di=class extends vt{constructor(e){super(e)}static name="open-requests-table";static template=xo},ci=class extends vt{constructor(e){super(e)}static name="open-office-requests-table";static template=To},ui=class extends vt{constructor(e){super(e)}static name="closed-requests-table";static template=Ro};var qo=T`
  <select
    class="form-select"
...
optionsText: 'Title'"
  ...
  ></div>
  <!-- /ko -->
`;var pi=class extends M{constructor(e){super(),this.key=e.key}ServiceTypes=ko.pureComputed(()=>pe().filter(e=>e.userCanInitiate(I())));SelectedService=ko.observable();static name="requests-by-service-type";static template=qo};var Io=T`
  ...
  <!-- /ko -->
`;var mi=class extends M{constructor({service:e,key:t}){super(),window.DEBUG&&console.log("New Service Type Table",e.Title),this.ServiceType=e,this.key=t,this._context=Q(),this.init()}HasInitialized=ko.observable();AllRequests=ko.observableArray();Supplements=ko.observableArray();requestMap={};_context;requestCols=["Title","RequestingOffice","Requestor","RequestStatus","RequestDescription"];SupplementCols=ko.observableArray();getSupplementByRequestId=e=>{let t=this.Supplements().find(i=>i.Request?.ID==e.ID);return t||null};getTableElementId=()=>`tbl-requests-type-${this.key}-${this.ServiceType.UID}`;async init(){let e=this.requestMap,t=await this._context.Requests.FindByColumnValue([{column:"ServiceType",value:this.ServiceType.ID}],{orderByColumn:"Title",sortAsc:!1},{},le.Views.ByServiceType).then(o=>{this.AllRequests(o.results),o.results.map(a=>{e[a.Title]?e[a.Title].request=a:e[a.Title]={request:a}})});if(!this.ServiceType._constructor){await t,this.HasInitialized(!0);return}let i=await this.ServiceType.instantiateEntity();Object.keys(i.FieldMap).map(o=>this.SupplementCols.push({key:o,displayName:i.FieldMap[o]?.displayName??o})),this.HasInitialized(!0)}tableHasRendered=()=>{this.Table=He(this.getTableElementId())};static name="requests-by-service-type-table";static template=Io};var Fo=T`
  <table
...
`;var Bt=class extends M{constructor(e){super(),Object.assign(this,e)}AvailableRequestorOffices=ko.pureComputed(()=>I()?.RequestingOffices());AvailableServiceTypes=ko.pureComputed(()=>pe().filter(e=>e.userCanInitiate(I())))},fi=class extends Bt{constructor(e){super(e)}static name="request-header-view";static template=Po},gi=class extends Bt{constructor(e){super(e)}static name="request-header-edit";static template=Do};var No=T`
...
`;var vi=class extends M{constructor({ShowActionOfficeFeatures:e,ToggleActionOfficeFeatures:t}){super(),this.ShowActionOfficeFeatures=e,this.ToggleActionOfficeFeatures=t}ShowActionOfficeToggle=ko.pureComputed(()=>I()?.IsActionOffice()&&!1);MyOpenAssignments=qe.MyActiveAssignments;LateRequests=ko.pureComputed(()=>ie.get(F.open)?.List()?.filter(e=>e.Dates.EstClosed.Value()<=new Date)??[]);toggleInfoContainer=(e,t)=>{t.target.closest(".status-info").classList.toggle("active")};static name="quick-info";static template=Oo};var Eo=T`
